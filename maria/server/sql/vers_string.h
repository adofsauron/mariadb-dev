...
struct Compare_table_names
{
  int operator()(const LEX_CSTRING &a, const LEX_CSTRING &b) const
  {
    ...
    return table_alias_charset->strnncoll(a.str, a.length, b.str, b.length);
  }
};
...
struct Lex_cstring_with_compare : public Lex_cstring
{
 public:
  ...
  Lex_cstring_with_compare(const char *_str, size_t _len) : Lex_cstring(_str, _len) {}
  Lex_cstring_with_compare(const LEX_STRING src) : Lex_cstring(src.str, src.length) {}
  ...
  operator bool() const { return str != NULL; }
};
