...
class Item_sum : public Item_func_or_sum
{
 ...
 public:
  ...
  Item_sum(THD *thd, Item *a) : Item_func_or_sum(thd, a), quick_group(1), orig_args(tmp_orig_args)
  {
    mark_as_sum_func();
    init_aggregator();
  }
  Item_sum(THD *thd, Item *a, Item *b) : Item_func_or_sum(thd, a, b), quick_group(1), orig_args(tmp_orig_args)
  {
    mark_as_sum_func();
    init_aggregator();
  }
  ...
  */
  ...
  COND *build_equal_items(THD *thd, COND_EQUAL *inherited, bool link_item_fields, COND_EQUAL **cond_equal_ref) override
  {
    ...
    */
    DBUG_ASSERT(0);
    return Item::build_equal_items(thd, inherited, link_item_fields, cond_equal_ref);
  }
  ...
  */
  ...
  {
    set_aggregator(current_thd, with_distinct ? Aggregator::DISTINCT_AGGREGATOR : Aggregator::SIMPLE_AGGREGATOR);
    aggregator_clear();
  }
  ...
  st_select_lex *depended_from() { return (nest_level == aggr_level ? 0 : aggr_sel); }
...
class Aggregator_distinct : public Aggregator
{
 ...
 public:
  Aggregator_distinct(Item_sum *sum)
      : Aggregator(sum), table(NULL), tmp_table_param(NULL), tree(NULL), always_null(false), use_distinct_values(false)
  {
  }
...
class Item_sum_num : public Item_sum
{
 public:
  ...
  Item_sum_num(THD *thd, Item *item_par) : Item_sum(thd, item_par) {}
  Item_sum_num(THD *thd, Item *a, Item *b) : Item_sum(thd, a, b) {}
  Item_sum_num(THD *thd, List<Item> &list) : Item_sum(thd, list) {}
...
class Item_sum_double : public Item_sum_num
{
 public:
  ...
  my_decimal *val_decimal(my_decimal *to) override { return val_decimal_from_real(to); }
...
class Item_sum_sum : public Item_sum_num, public Type_handler_hybrid_field_type
{
 protected:
  bool direct_added;
 ...
 public:
  Item_sum_sum(THD *thd, Item *item_par, bool distinct)
      : Item_sum_num(thd, item_par), direct_added(FALSE), direct_reseted_field(FALSE)
  {
    set_distinct(distinct);
  }
  Item_sum_sum(THD *thd, Item_sum_sum *item);
  enum Sumfunctype sum_func() const override { return has_with_distinct() ? SUM_DISTINCT_FUNC : SUM_FUNC; }
  void cleanup() override;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_sum>(thd, this); }
...
class Item_sum_count : public Item_sum_int
{
 ...
 public:
  Item_sum_count(THD *thd, Item *item_par)
      : Item_sum_int(thd, item_par), direct_counted(FALSE), direct_reseted_field(FALSE), count(0)
  {
  }
  ...
  */
  ...
  Item_sum_count(THD *thd, List<Item> &list)
      : Item_sum_int(thd, list), direct_counted(FALSE), direct_reseted_field(FALSE), count(0)
  {
    set_distinct(TRUE);
  }
  Item_sum_count(THD *thd, Item_sum_count *item)
      : Item_sum_int(thd, item), direct_counted(FALSE), direct_reseted_field(FALSE), count(item->count)
  {
  }
  enum Sumfunctype sum_func() const override { return has_with_distinct() ? COUNT_DISTINCT_FUNC : COUNT_FUNC; }
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_count>(thd, this); }
...
class Item_sum_avg : public Item_sum_sum
{
 public:
  ...
  Item_sum_avg(THD *thd, Item *item_par, bool distinct) : Item_sum_sum(thd, item_par, distinct), count(0) {}
  ...
  void fix_length_and_dec_decimal();
  bool fix_length_and_dec(THD *thd) override;
  enum Sumfunctype sum_func() const override { return has_with_distinct() ? AVG_DISTINCT_FUNC : AVG_FUNC; }
  void clear() override;
  bool add() override;
  void remove() override;
  double val_real() override;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_avg>(thd, this); }
...
class Stddev
{
 ...
 public:
  ...
  static uint32 binary_size() { return (uint32)(sizeof(double) * 2 + sizeof(ulonglong)); };
};
...
class Item_sum_variance : public Item_sum_double
{
 ...
 public:
  ...
  Item_sum_variance(THD *thd, Item *item_par, uint sample_arg) : Item_sum_double(thd, item_par), sample(sample_arg) {}
  ...
  Item *copy_or_same(THD *thd) override;
  Field *create_tmp_field(MEM_ROOT *root, bool group, TABLE *table) override final;
  void cleanup() override final
  {
    m_stddev = Stddev();
    Item_sum_double::cleanup();
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_variance>(thd, this); }
};
...
{
 public:
  Item_sum_std(THD *thd, Item *item_par, uint sample_arg) : Item_sum_variance(thd, item_par, sample_arg) {}
  ...
  Item *get_copy(THD *thd) override final { return get_item_copy<Item_sum_std>(thd, this); }
};
...
class Item_sum_hybrid : public Item_sum, public Type_handler_hybrid_field_type
{
 public:
  Item_sum_hybrid(THD *thd, Item *item_par)
      : Item_sum(thd, item_par), Type_handler_hybrid_field_type(&type_handler_slonglong)
  {
    collation.set(&my_charset_bin);
  }
  Item_sum_hybrid(THD *thd, Item *a, Item *b)
      : Item_sum(thd, a, b), Type_handler_hybrid_field_type(&type_handler_slonglong)
  {
    collation.set(&my_charset_bin);
  }
  Item_sum_hybrid(THD *thd, Item_sum_hybrid *item) : Item_sum(thd, item), Type_handler_hybrid_field_type(item) {}
  const Type_handler *type_handler() const override { return Type_handler_hybrid_field_type::type_handler(); }
...
class Item_sum_min_max : public Item_sum_hybrid
{
 ...
 public:
  ...
  const Type_handler *real_type_handler() const override { return get_arg(0)->real_type_handler(); }
...
class Item_sum_min final : public Item_sum_min_max
{
 public:
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_min>(thd, this); }
};
...
class Item_sum_max final : public Item_sum_min_max
{
 public:
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_max>(thd, this); }
};
...
class Item_sum_bit : public Item_sum_int
{
 public:
  ...
  void setup_window_func(THD *thd __attribute__((unused)), Window_spec *window_spec __attribute__((unused))) override
  {
...
class Item_sum_or final : public Item_sum_bit
{
 public:
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_or>(thd, this); }
...
{
 public:
  Item_sum_and(THD *thd, Item *item_par) : Item_sum_bit(thd, item_par, ULONGLONG_MAX) {}
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_and>(thd, this); }
...
class Item_sum_xor final : public Item_sum_bit
{
 public:
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_xor>(thd, this); }
...
*/
class Item_sum_sp : public Item_sum, public Item_sp
{
 private:
  bool execute();

 public:
  Item_sum_sp(THD *thd, Name_resolution_context *context_arg, sp_name *name, sp_head *sp);

  Item_sum_sp(THD *thd, Name_resolution_context *context_arg, sp_name *name, sp_head *sp, List<Item> &list);
  Item_sum_sp(THD *thd, Item_sum_sp *item);

  enum Sumfunctype sum_func() const override { return SP_AGGREGATE_FUNC; }
  ...
  bool val_native(THD *thd, Native *to) override { return (null_value = execute()) || sp_result_field->val_native(to); }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_sp>(thd, this); }
  Item *copy_or_same(THD *thd) override;
};
...
class Item_sum_field : public Item
{
 ...
 public:
  Item_sum_field(THD *thd, Item_sum *item) : Item(thd), field(item->result_field)
  {
    name = item->name;
    set_maybe_null();
...
class Item_avg_field : public Item_sum_field
{
 ...
 public:
  Item_avg_field(THD *thd, Item_sum_avg *item) : Item_sum_field(thd, item), prec_increment(item->prec_increment) {}
...
{
 public:
  Item_avg_field_double(THD *thd, Item_sum_avg *item) : Item_avg_field(thd, item) {}
  const Type_handler *type_handler() const override { return &type_handler_double; }
  longlong val_int() override { return val_int_from_real(); }
  my_decimal *val_decimal(my_decimal *dec) override { return val_decimal_from_real(dec); }
  String *val_str(String *str) override { return val_string_from_real(str); }
  double val_real() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_avg_field_double>(thd, this); }
};
...
class Item_avg_field_decimal : public Item_avg_field
{
 ...
 public:
  ...
  String *val_str(String *str) override { return VDec(this).to_string_round(str, decimals); }
  my_decimal *val_decimal(my_decimal *) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_avg_field_decimal>(thd, this); }
};
...
class Item_variance_field : public Item_sum_field
{
 ...
 public:
  Item_variance_field(THD *thd, Item_sum_variance *item) : Item_sum_field(thd, item), sample(item->sample) {}
  ...
  const Type_handler *type_handler() const override { return &type_handler_double; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_variance_field>(thd, this); }
};

class Item_std_field : public Item_variance_field
{
 public:
  Item_std_field(THD *thd, Item_sum_std *item) : Item_variance_field(thd, item) {}
  enum Type type() const override { return FIELD_STD_ITEM; }
  double val_real() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_std_field>(thd, this); }
};
...
class Item_udf_sum : public Item_sum
{
 ...
 public:
  Item_udf_sum(THD *thd, udf_func *udf_arg) : Item_sum(thd), udf(udf_arg) { quick_group = 0; }
  Item_udf_sum(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_sum(thd, list), udf(udf_arg) { quick_group = 0; }
...
{
 public:
  Item_sum_udf_float(THD *thd, udf_func *udf_arg) : Item_udf_sum(thd, udf_arg) {}
  Item_sum_udf_float(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_sum(thd, udf_arg, list) {}
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_udf_float>(thd, this); }
};

class Item_sum_udf_int : public Item_udf_sum
{
 public:
  Item_sum_udf_int(THD *thd, udf_func *udf_arg) : Item_udf_sum(thd, udf_arg) {}
  Item_sum_udf_int(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_sum(thd, udf_arg, list) {}
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_udf_int>(thd, this); }
};

class Item_sum_udf_str : public Item_udf_sum
{
 public:
  Item_sum_udf_str(THD *thd, udf_func *udf_arg) : Item_udf_sum(thd, udf_arg) {}
  Item_sum_udf_str(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_sum(thd, udf_arg, list) {}
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_udf_str>(thd, this); }
};

class Item_sum_udf_decimal : public Item_udf_sum
{
 public:
  Item_sum_udf_decimal(THD *thd, udf_func *udf_arg) : Item_udf_sum(thd, udf_arg) {}
  Item_sum_udf_decimal(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_sum(thd, udf_arg, list) {}
  ...
  Item *copy_or_same(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_udf_decimal>(thd, this); }
};
...
{
 public:
  Item_sum_udf_float(THD *thd, udf_func *udf_arg) : Item_sum_double(thd) {}
  Item_sum_udf_float(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_sum_double(thd) {}
  Item_sum_udf_float(THD *thd, Item_sum_udf_float *item) : Item_sum_double(thd, item) {}
...
{
 public:
  Item_sum_udf_int(THD *thd, udf_func *udf_arg) : Item_sum_double(thd) {}
  Item_sum_udf_int(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_sum_double(thd) {}
  Item_sum_udf_int(THD *thd, Item_sum_udf_int *item) : Item_sum_double(thd, item) {}
  enum Sumfunctype sum_func() const { return UDF_SUM_FUNC; }
  longlong val_int()
  {
    DBUG_ASSERT(fixed());
...
{
 public:
  Item_sum_udf_decimal(THD *thd, udf_func *udf_arg) : Item_sum_double(thd) {}
  Item_sum_udf_decimal(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_sum_double(thd) {}
  Item_sum_udf_decimal(THD *thd, Item_sum_udf_float *item) : Item_sum_double(thd, item) {}
  enum Sumfunctype sum_func() const { return UDF_SUM_FUNC; }
  double val_real()
  {
    DBUG_ASSERT(fixed());
...
{
 public:
  Item_sum_udf_str(THD *thd, udf_func *udf_arg) : Item_sum_double(thd) {}
  Item_sum_udf_str(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_sum_double(thd) {}
  Item_sum_udf_str(THD *thd, Item_sum_udf_str *item) : Item_sum_double(thd, item) {}
...
int group_concat_key_cmp_with_distinct_with_nulls(void *arg, const void *key1, const void *key2);
int group_concat_key_cmp_with_order(void *arg, const void *key1, const void *key2);
int group_concat_key_cmp_with_order_with_nulls(void *arg, const void *key1, const void *key2);
...
class Item_func_group_concat : public Item_sum
{
  ...
  */
  ...
  friend int group_concat_key_cmp_with_distinct_with_nulls(void *arg, const void *key1, const void *key2);
  friend int group_concat_key_cmp_with_order(void *arg, const void *key1, const void *key2);
  friend int group_concat_key_cmp_with_order_with_nulls(void *arg, const void *key1, const void *key2);
  friend int dump_leaf_key(void *key_arg, element_count count __attribute__((unused)), void *item_arg);
  ...
  */
  ...
  virtual String *get_str_from_item(Item *i, String *tmp) { return i->val_str(tmp); }
  virtual String *get_str_from_field(Item *i, Field *f, String *tmp, const uchar *key, size_t offset)
  {
    return f->val_str(tmp, key + offset);
  }
  virtual void cut_max_length(String *result, uint old_length, uint max_length) const;
 ...
 public:
  Item_func_group_concat(THD *thd, Name_resolution_context *context_arg, bool is_distinct, List<Item> *is_select,
                         const SQL_I_List<ORDER> &is_order, String *is_separator, bool limit_clause, Item *row_limit,
                         Item *offset_limit);
  ...
  void clear() override;
  bool add() override { return add(skip_nulls()); }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_group_concat>(thd, this); }
