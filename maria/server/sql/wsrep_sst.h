 ...
 */
int wsrep_sst_donate(const std::string &request, const wsrep::gtid &gtid, bool bypass);

#else
#define wsrep_SE_initialized() \
  do                           \
  {                            \
  } while (0)
#define wsrep_SE_init_grab() \
  do                         \
  {                          \
  } while (0)
#define wsrep_SE_init_done() \
  do                         \
  {                          \
  } while (0)
