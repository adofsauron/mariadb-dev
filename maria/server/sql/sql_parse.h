...
bool parse_sql(THD *thd, Parser_state *parser_state, Object_creation_ctx *creation_ctx, bool do_pfs_digest = false);
...
bool check_identifier_name(LEX_CSTRING *str, uint max_char_length, uint err_code, const char *param_for_err_msg);
...
inline bool check_identifier_name(LEX_CSTRING *str) { return check_identifier_name(str, NAME_CHAR_LEN, 0, ""); }
...
#else
inline bool check_one_table_access(THD *thd, privilege_t privilege, TABLE_LIST *tables) { return false; }
inline bool check_single_table_access(THD *thd, privilege_t privilege, TABLE_LIST *tables, bool no_errors)
{
  return false;
}
inline bool check_routine_access(THD *thd, privilege_t want_access, const LEX_CSTRING *db, const LEX_CSTRING *name,
                                 const Sp_handler *sph, bool no_errors)
{
  return false;
}
...
inline bool check_some_routine_access(THD *thd, const char *db, const char *name, const Sp_handler *sph)
{
  return false;
}
inline bool check_table_access(THD *thd, privilege_t requirements, TABLE_LIST *tables,
                               bool any_combination_of_privileges_will_do, uint number, bool no_errors)
{
  return false;
}
