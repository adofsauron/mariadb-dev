...
class Item_str_func : public Item_func
{
 ...
 public:
  ...
  Item_str_func(THD *thd, Item *a, Item *b) : Item_func(thd, a, b) { decimals = NOT_FIXED_DEC; }
  Item_str_func(THD *thd, Item *a, Item *b, Item *c) : Item_func(thd, a, b, c) { decimals = NOT_FIXED_DEC; }
  Item_str_func(THD *thd, Item *a, Item *b, Item *c, Item *d) : Item_func(thd, a, b, c, d) { decimals = NOT_FIXED_DEC; }
  Item_str_func(THD *thd, Item *a, Item *b, Item *c, Item *d, Item *e) : Item_func(thd, a, b, c, d, e)
  {
    decimals = NOT_FIXED_DEC;
  }
  Item_str_func(THD *thd, List<Item> &list) : Item_func(thd, list) { decimals = NOT_FIXED_DEC; }
...
class Item_str_ascii_func : public Item_str_func
{
 ...
 public:
  ...
  Item_str_ascii_func(THD *thd, Item *a, Item *b, Item *c) : Item_str_func(thd, a, b, c) {}
  String *val_str(String *str) override { return val_str_from_val_str_ascii(str, &ascii_buf); }
...
{
 public:
  Item_str_ascii_checksum_func(THD *thd, Item *a) : Item_str_ascii_func(thd, a) {}
  Item_str_ascii_checksum_func(THD *thd, Item *a, Item *b) : Item_str_ascii_func(thd, a, b) {}
...
{
 public:
  Item_str_binary_checksum_func(THD *thd, Item *a) : Item_str_func(thd, a) {}
  Item_str_binary_checksum_func(THD *thd, Item *a, Item *b) : Item_str_func(thd, a, b) {}
  bool eq(const Item *item, bool binary_cmp) const
  {
    /*
...
class Item_func_md5 : public Item_str_ascii_checksum_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_md5>(thd, this); }
};
...
class Item_func_sha : public Item_str_ascii_checksum_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sha>(thd, this); }
};

class Item_func_sha2 : public Item_str_ascii_checksum_func
{
 public:
  Item_func_sha2(THD *thd, Item *a, Item *b) : Item_str_ascii_checksum_func(thd, a, b) {}
  String *val_str_ascii(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sha2>(thd, this); }
};
...
class Item_func_to_base64 : public Item_str_ascii_checksum_func
{
 ...
 public:
  Item_func_to_base64(THD *thd, Item *a) : Item_str_ascii_checksum_func(thd, a) {}
  String *val_str_ascii(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_to_base64>(thd, this); }
};
...
class Item_func_from_base64 : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_from_base64(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_from_base64>(thd, this); }
};
...
class Item_aes_crypt : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_aes_crypt(THD *thd, Item *a, Item *b) : Item_str_binary_checksum_func(thd, a, b) {}
...
{
 public:
  Item_func_aes_encrypt(THD *thd, Item *a, Item *b) : Item_aes_crypt(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_aes_encrypt>(thd, this); }
};

class Item_func_aes_decrypt : public Item_aes_crypt
{
 public:
  Item_func_aes_decrypt(THD *thd, Item *a, Item *b) : Item_aes_crypt(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_aes_decrypt>(thd, this); }
};

class Item_func_natural_sort_key : public Item_str_func
{
 public:
  Item_func_natural_sort_key(THD *thd, Item *a) : Item_str_func(thd, a){};
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_natural_sort_key>(thd, this); }
...
class Item_func_concat : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_concat>(thd, this); }
};
...
{
 public:
  Item_func_concat_operator_oracle(THD *thd, List<Item> &list) : Item_func_concat(thd, list) {}
  Item_func_concat_operator_oracle(THD *thd, Item *a, Item *b) : Item_func_concat(thd, a, b) {}
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_concat_operator_oracle>(thd, this); }
};

class Item_func_decode_histogram : public Item_str_func
{
 public:
  Item_func_decode_histogram(THD *thd, Item *a, Item *b) : Item_str_func(thd, a, b) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_decode_histogram>(thd, this); }
};
...
class Item_func_concat_ws : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_concat_ws>(thd, this); }
};
...
class Item_func_random_bytes : public Item_str_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_random_bytes>(thd, this); }
...
class Item_func_reverse : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_reverse>(thd, this); }
};
...
class Item_func_replace : public Item_str_func
{
 ...
 public:
  Item_func_replace(THD *thd, Item *org, Item *find, Item *replace) : Item_str_func(thd, org, find, replace) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_replace>(thd, this); }
};
...
class Item_func_replace_oracle : public Item_func_replace
{
 ...
 public:
  Item_func_replace_oracle(THD *thd, Item *org, Item *find, Item *replace) : Item_func_replace(thd, org, find, replace)
  {
  }
  String *val_str(String *to) override { return val_str_internal(to, &tmp_emtpystr); };
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("replace_oracle")};
    return name;
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_replace_oracle>(thd, this); }
};

class Item_func_regexp_replace : public Item_str_func
{
  Regexp_processor_pcre re;
  bool append_replacement(String *str, const LEX_CSTRING *source, const LEX_CSTRING *replace);

 public:
  Item_func_regexp_replace(THD *thd, Item *a, Item *b, Item *c) : Item_str_func(thd, a, b, c) {}
...
class Item_func_regexp_substr : public Item_str_func
{
 ...
 public:
  Item_func_regexp_substr(THD *thd, Item *a, Item *b) : Item_str_func(thd, a, b) {}
  void cleanup() override
  {
...
class Item_func_insert : public Item_str_func
{
 ...
 public:
  Item_func_insert(THD *thd, Item *org, Item *start, Item *length, Item *new_str)
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_insert>(thd, this); }
};
...
class Item_func_lcase : public Item_str_conv
{
 public:
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_lcase>(thd, this); }
};
...
class Item_func_ucase : public Item_str_conv
{
 public:
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ucase>(thd, this); }
};
...
class Item_func_left : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_left>(thd, this); }
};
...
class Item_func_substr : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_substr>(thd, this); }
};
...
class Item_func_sformat : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sformat>(thd, this); }
};
...
class Item_func_substr_oracle : public Item_func_substr
{
 ...
 public:
  Item_func_substr_oracle(THD *thd, Item *a, Item *b) : Item_func_substr(thd, a, b) {}
  Item_func_substr_oracle(THD *thd, Item *a, Item *b, Item *c) : Item_func_substr(thd, a, b, c) {}
  bool fix_length_and_dec(THD *thd) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_substr_oracle>(thd, this); }
};
...
class Item_func_substr_index : public Item_str_func
{
 ...
 public:
  Item_func_substr_index(THD *thd, Item *a, Item *b, Item *c) : Item_str_func(thd, a, b, c) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_substr_index>(thd, this); }
};
...
class Item_func_trim : public Item_str_func
{
 protected:
  ...
  String *non_trimmed_value(String *res) { return trimmed_value(res, 0, res->length()); }
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_trim>(thd, this); }
};
...
class Item_func_trim_oracle : public Item_func_trim
{
 ...
 public:
  Item_func_trim_oracle(THD *thd, Item *a, Item *b) : Item_func_trim(thd, a, b) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_trim_oracle>(thd, this); }
};
...
class Item_func_ltrim : public Item_func_trim
{
 public:
  ...
  Sql_mode_dependency value_depends_on_sql_mode() const override { return Item_func::value_depends_on_sql_mode(); }
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  LEX_CSTRING mode_name() const override { return {STRING_WITH_LEN("leading")}; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ltrim>(thd, this); }
};
...
class Item_func_ltrim_oracle : public Item_func_ltrim
{
 ...
 public:
  Item_func_ltrim_oracle(THD *thd, Item *a, Item *b) : Item_func_ltrim(thd, a, b) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ltrim_oracle>(thd, this); }
};
...
class Item_func_rtrim : public Item_func_trim
{
 public:
  ...
  LEX_CSTRING mode_name() const override { return {STRING_WITH_LEN("trailing")}; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rtrim>(thd, this); }
};
...
class Item_func_rtrim_oracle : public Item_func_rtrim
{
 ...
 public:
  Item_func_rtrim_oracle(THD *thd, Item *a, Item *b) : Item_func_rtrim(thd, a, b) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rtrim_oracle>(thd, this); }
};
...
class Item_func_password : public Item_str_ascii_checksum_func
{
 ...
 public:
  Item_func_password(THD *thd, Item *a) : Item_str_ascii_checksum_func(thd, a), alg(NEW), deflt(1) {}
  Item_func_password(THD *thd, Item *a, PW_Alg al) : Item_str_ascii_checksum_func(thd, a), alg(al), deflt(0) {}
  String *val_str_ascii(String *str) override;
  bool fix_fields(THD *thd, Item **ref) override;
  bool fix_length_and_dec(THD *thd) override
  {
    fix_length_and_charset((alg == 1 ? SCRAMBLED_PASSWORD_CHAR_LENGTH : SCRAMBLED_PASSWORD_CHAR_LENGTH_323),
                           default_charset());
    return FALSE;
  }
  LEX_CSTRING func_name_cstring() const override
  ...
  static char *alloc(THD *thd, const char *password, size_t pass_len, enum PW_Alg al);
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_password>(thd, this); }
};
...
class Item_func_des_encrypt : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_des_encrypt(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) {}
  Item_func_des_encrypt(THD *thd, Item *a, Item *b) : Item_str_binary_checksum_func(thd, a, b) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_des_encrypt>(thd, this); }
};
...
class Item_func_des_decrypt : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_des_decrypt(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) {}
  Item_func_des_decrypt(THD *thd, Item *a, Item *b) : Item_str_binary_checksum_func(thd, a, b) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_des_decrypt>(thd, this); }
};
...
class Item_func_encrypt : public Item_str_binary_checksum_func
{
  ...
  void constructor_helper() { collation.set(&my_charset_bin); }

 public:
  Item_func_encrypt(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) { constructor_helper(); }
  Item_func_encrypt(THD *thd, Item *a, Item *b) : Item_str_binary_checksum_func(thd, a, b) { constructor_helper(); }
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override
  {
    set_maybe_null();
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_encrypt>(thd, this); }
};
...
class Item_func_encode : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_encode(THD *thd, Item *a, Item *seed_arg) : Item_str_binary_checksum_func(thd, a, seed_arg) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_encode>(thd, this); }
...
class Item_func_decode : public Item_func_encode
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_decode>(thd, this); }
...
{
 public:
  Item_func_sysconst(THD *thd) : Item_str_func(thd) { collation.set(system_charset_info, DERIVATION_SYSCONST); }
  ...
  */
  ...
  {
    return mark_unsupported_function(fully_qualified_func_name(), arg, VCOL_SESSION_FUNC);
  }
...
class Item_func_database : public Item_func_sysconst
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_database>(thd, this); }
};
...
class Item_func_sqlerrm : public Item_func_sysconst
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sqlerrm>(thd, this); }
};
...
class Item_func_user : public Item_func_sysconst
{
 ...
 public:
  Item_func_user(THD *thd) : Item_func_sysconst(thd) { str_value.set("", 0, system_charset_info); }
  String *val_str(String *) override
  {
    DBUG_ASSERT(fixed());
  ...
  bool fix_length_and_dec(THD *thd) override
  {
    max_length = (uint32)(username_char_length + HOSTNAME_LENGTH + 1) * SYSTEM_CHARSET_MBMAXLEN;
    return FALSE;
  }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  int save_in_field(Field *field, bool no_conversions) override { return save_str_value_in_field(field, &str_value); }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_user>(thd, this); }
};
...
class Item_func_current_user : public Item_func_user
{
 ...
 public:
  Item_func_current_user(THD *thd, Name_resolution_context *context_arg) : Item_func_user(thd), context(context_arg) {}
  bool fix_fields(THD *thd, Item **ref) override;
  LEX_CSTRING func_name_cstring() const override
  {
...
class Item_func_current_role : public Item_func_sysconst
{
 ...
 public:
  Item_func_current_role(THD *thd, Name_resolution_context *context_arg) : Item_func_sysconst(thd), context(context_arg)
  {
  }
  bool fix_fields(THD *thd, Item **ref) override;
  bool fix_length_and_dec(THD *thd) override
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_current_role>(thd, this); }
};
...
class Item_func_soundex : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_soundex>(thd, this); }
};
...
class Item_func_elt : public Item_str_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_elt>(thd, this); }
};
...
class Item_func_make_set : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_make_set>(thd, this); }
};
...
class Item_func_format : public Item_str_ascii_func
{
 ...
 public:
  Item_func_format(THD *thd, Item *org, Item *dec) : Item_str_ascii_func(thd, org, dec) {}
  Item_func_format(THD *thd, Item *org, Item *dec, Item *lang) : Item_str_ascii_func(thd, org, dec, lang) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_format>(thd, this); }
};

class Item_func_char : public Item_str_func
{
 public:
  Item_func_char(THD *thd, List<Item> &list) : Item_str_func(thd, list) { collation.set(&my_charset_bin); }
  Item_func_char(THD *thd, List<Item> &list, CHARSET_INFO *cs) : Item_str_func(thd, list) { collation.set(cs); }
  Item_func_char(THD *thd, Item *arg1, CHARSET_INFO *cs) : Item_str_func(thd, arg1) { collation.set(cs); }
  String *val_str(String *) override;
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_char>(thd, this); }
};

class Item_func_chr : public Item_func_char
{
 public:
  Item_func_chr(THD *thd, Item *arg1, CHARSET_INFO *cs) : Item_func_char(thd, arg1, cs) {}
  String *val_str(String *) override;
  bool fix_length_and_dec(THD *thd) override
  {
    max_length = 4;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_chr>(thd, this); }
};
...
class Item_func_repeat : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_repeat>(thd, this); }
};
...
class Item_func_space : public Item_str_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_space>(thd, this); }
};
...
class Item_func_binlog_gtid_pos : public Item_str_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_binlog_gtid_pos>(thd, this); }
};
...
class Item_func_pad : public Item_str_func
{
 ...
 public:
  Item_func_pad(THD *thd, Item *arg1, Item *arg2, Item *arg3) : Item_str_func(thd, arg1, arg2, arg3) {}
  Item_func_pad(THD *thd, Item *arg1, Item *arg2) : Item_str_func(thd, arg1, arg2) {}
  bool fix_length_and_dec(THD *thd) override;
};
...
{
 public:
  Item_func_rpad(THD *thd, Item *arg1, Item *arg2, Item *arg3) : Item_func_pad(thd, arg1, arg2, arg3) {}
  Item_func_rpad(THD *thd, Item *arg1, Item *arg2) : Item_func_pad(thd, arg1, arg2) {}
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Sql_mode_dependency value_depends_on_sql_mode() const override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rpad>(thd, this); }
};
...
class Item_func_rpad_oracle : public Item_func_rpad
{
 ...
 public:
  Item_func_rpad_oracle(THD *thd, Item *arg1, Item *arg2, Item *arg3) : Item_func_rpad(thd, arg1, arg2, arg3) {}
  Item_func_rpad_oracle(THD *thd, Item *arg1, Item *arg2) : Item_func_rpad(thd, arg1, arg2) {}
  bool fix_length_and_dec(THD *thd) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rpad_oracle>(thd, this); }
};

class Item_func_lpad : public Item_func_pad
{
 public:
  Item_func_lpad(THD *thd, Item *arg1, Item *arg2, Item *arg3) : Item_func_pad(thd, arg1, arg2, arg3) {}
  Item_func_lpad(THD *thd, Item *arg1, Item *arg2) : Item_func_pad(thd, arg1, arg2) {}
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_lpad>(thd, this); }
};
...
class Item_func_lpad_oracle : public Item_func_lpad
{
 ...
 public:
  Item_func_lpad_oracle(THD *thd, Item *arg1, Item *arg2, Item *arg3) : Item_func_lpad(thd, arg1, arg2, arg3) {}
  Item_func_lpad_oracle(THD *thd, Item *arg1, Item *arg2) : Item_func_lpad(thd, arg1, arg2) {}
  bool fix_length_and_dec(THD *thd) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_lpad_oracle>(thd, this); }
};

class Item_func_conv : public Item_str_func
{
 public:
  Item_func_conv(THD *thd, Item *a, Item *b, Item *c) : Item_str_func(thd, a, b, c) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_conv>(thd, this); }
};
...
class Item_func_hex : public Item_str_ascii_checksum_func
{
 ...
 public:
  Item_func_hex(THD *thd, Item *a) : Item_str_ascii_checksum_func(thd, a), m_arg0_type_handler(NULL) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_hex>(thd, this); }
};
...
class Item_func_unhex : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_unhex>(thd, this); }
};
...
class Item_func_like_range : public Item_str_func
{
 ...
 public:
  Item_func_like_range(THD *thd, Item *a, Item *b, bool is_min_arg) : Item_str_func(thd, a, b), is_min(is_min_arg)
  {
    set_maybe_null();
  }
  String *val_str(String *) override;
...
{
 public:
  Item_func_like_range_min(THD *thd, Item *a, Item *b) : Item_func_like_range(thd, a, b, true) {}
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("like_range_min")};
    return name;
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_like_range_min>(thd, this); }
};

class Item_func_like_range_max : public Item_func_like_range
{
 public:
  Item_func_like_range_max(THD *thd, Item *a, Item *b) : Item_func_like_range(thd, a, b, false) {}
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("like_range_max")};
    return name;
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_like_range_max>(thd, this); }
};
#endif
...
class Item_func_binary : public Item_str_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_binary>(thd, this); }
};
...
class Item_load_file : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_load_file>(thd, this); }
};

class Item_func_export_set : public Item_str_func
{
 public:
  Item_func_export_set(THD *thd, Item *a, Item *b, Item *c) : Item_str_func(thd, a, b, c) {}
  Item_func_export_set(THD *thd, Item *a, Item *b, Item *c, Item *d) : Item_str_func(thd, a, b, c, d) {}
  Item_func_export_set(THD *thd, Item *a, Item *b, Item *c, Item *d, Item *e) : Item_str_func(thd, a, b, c, d, e) {}
  String *val_str(String *str) override;
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_export_set>(thd, this); }
};
...
class Item_func_quote : public Item_str_func
{
 ...
 public:
  ...
  {
    collation.set(args[0]->collation);
    ulonglong max_result_length = (ulonglong)args[0]->max_length * 2 + 2 * collation.collation->mbmaxlen;
    max_length = (uint32)MY_MIN(max_result_length, MAX_BLOB_WIDTH);
    return FALSE;
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_quote>(thd, this); }
};
...
class Item_func_conv_charset : public Item_str_func
{
 ...
 public:
  bool safe;
  Item_func_conv_charset(THD *thd, Item *a, CHARSET_INFO *cs) : Item_str_func(thd, a)
  {
    collation.set(cs, DERIVATION_IMPLICIT);
    use_cached_value = 0;
    safe = 0;
  }
  Item_func_conv_charset(THD *thd, Item *a, CHARSET_INFO *cs, bool cache_if_const) : Item_str_func(thd, a)
  {
    collation.set(cs, DERIVATION_IMPLICIT);
    if (cache_if_const && args[0]->can_eval_in_optimize())
    {
      ...
      if (!str || str_value.copy(str->ptr(), str->length(), str->charset(), cs, &errors))
        null_value = 1;
      use_cached_value = 1;
    ...
    else
    {
      ...
      */
      safe = (args[0]->collation.collation == &my_charset_bin || cs == &my_charset_bin || (cs->state & MY_CS_UNICODE) ||
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_conv_charset>(thd, this); }
...
class Item_func_set_collation : public Item_str_func
{
 ...
 public:
  Item_func_set_collation(THD *thd, Item *a, const Lex_extended_collation_st &set_collation)
  ...
  bool need_parentheses_in_default() override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_set_collation>(thd, this); }
};
...
{
 public:
  Item_func_charset(THD *thd, Item *a) : Item_func_expr_str_metadata(thd, a) {}
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_charset>(thd, this); }
};

class Item_func_collation : public Item_func_expr_str_metadata
{
 public:
  Item_func_collation(THD *thd, Item *a) : Item_func_expr_str_metadata(thd, a) {}
  String *val_str(String *) override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_collation>(thd, this); }
};
...
class Item_func_weight_string : public Item_str_func
{
 ...
 public:
  Item_func_weight_string(THD *thd, Item *a, uint result_length_arg, uint nweights_arg, uint flags_arg)
      : Item_str_func(thd, a)
  {
  ...
  bool eq(const Item *item, bool binary_cmp) const override
  {
    ...
    return this->weigth_flags == that->weigth_flags && this->nweights == that->nweights &&
           this->result_length == that->result_length;
  }
  Item *propagate_equal_fields(THD *thd, const Context &ctx, COND_EQUAL *cond) override { return this; }
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_weight_string>(thd, this); }
};
...
class Item_func_crc32 : public Item_long_func
{
 ...
 public:
  Item_func_crc32(THD *thd, bool Castagnoli, Item *a)
      : Item_long_func(thd, a), crc_func(Castagnoli ? my_crc32c : my_checksum)
  {
    unsigned_flag = 1;
  }
  Item_func_crc32(THD *thd, bool Castagnoli, Item *a, Item *b)
      : Item_long_func(thd, a, b), crc_func(Castagnoli ? my_crc32c : my_checksum)
  {
    unsigned_flag = 1;
  }
  LEX_CSTRING func_name_cstring() const override
  ...
  longlong val_int() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_crc32>(thd, this); }
};
...
class Item_func_uncompressed_length : public Item_long_func_length
{
 ...
 public:
  Item_func_uncompressed_length(THD *thd, Item *a) : Item_long_func_length(thd, a) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  longlong val_int() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_uncompressed_length>(thd, this); }
};
...
class Item_func_compress : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_compress(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) {}
  bool fix_length_and_dec(THD *thd) override
  {
  ...
  String *val_str(String *) override ZLIB_DEPENDED_FUNCTION Item *get_copy(THD *thd) override
  {
...
class Item_func_uncompress : public Item_str_binary_checksum_func
{
 ...
 public:
  Item_func_uncompress(THD *thd, Item *a) : Item_str_binary_checksum_func(thd, a) {}
  bool fix_length_and_dec(THD *thd) override
  {
    set_maybe_null();
    max_length = MAX_BLOB_WIDTH;
...
class Item_func_dyncol_create : public Item_str_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_dyncol_create>(thd, this); }
};
...
class Item_func_dyncol_add : public Item_func_dyncol_create
{
 public:
  ...
  String *val_str(String *) override;
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_dyncol_add>(thd, this); }
};

class Item_func_dyncol_json : public Item_str_func
{
 public:
  Item_func_dyncol_json(THD *thd, Item *str) : Item_str_func(thd, str) { collation.set(DYNCOL_UTF); }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_dyncol_json>(thd, this); }
};
...
class Item_dyncol_get : public Item_str_func
{
 public:
  ...
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override;
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_dyncol_get>(thd, this); }
};

class Item_func_dyncol_list : public Item_str_func
{
 public:
  Item_func_dyncol_list(THD *thd, Item *str) : Item_str_func(thd, str) { collation.set(DYNCOL_UTF); }
  bool fix_length_and_dec(THD *thd) override
  {
    set_maybe_null();
    max_length = MAX_BLOB_WIDTH;
  ...
  String *val_str(String *) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_dyncol_list>(thd, this); }
};
...
class Item_temptable_rowid : public Item_str_func
{
 public:
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_temptable_rowid>(thd, this); }
};
#ifdef WITH_WSREP
...
class Item_func_wsrep_last_written_gtid : public Item_str_ascii_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_wsrep_last_written_gtid>(thd, this); }
};
...
class Item_func_wsrep_last_seen_gtid : public Item_str_ascii_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_wsrep_last_seen_gtid>(thd, this); }
};
...
class Item_func_wsrep_sync_wait_upto : public Item_int_func
{
 ...
 public:
  ...
  longlong val_int() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_wsrep_sync_wait_upto>(thd, this); }
};
#endif /* WITH_WSREP */
