 ...
 public:
  field_str(Item *a, analyse *b)
      : field_info(a, b),
        ...
        max_arg("", 0, default_charset_info),
        sum(0),
        must_be_blob(0),
        was_zero_fill(0),
        ...
        can_be_still_num(1)
  {
    init_tree(&tree, 0, 0, sizeof(String), (qsort_cmp2)sortcmp2, free_string, NULL, MYF(MY_THREAD_SPECIFIC));
  };
  ...
  String *avg(String *s, ha_rows rows)
  {
    if (!(rows - nulls))
      ...
      s->set_real((ulonglong2double(sum) / ulonglong2double(rows - nulls)), DEC_IN_AVG, my_thd_charset);
    return s;
  }
...
class field_decimal : public field_info
{
 ...
 public:
  field_decimal(Item *a, analyse *b) : field_info(a, b)
  {
    ...
    init_tree(&tree, 0, 0, bin_size, (qsort_cmp2)compare_decimal2, 0, (void *)&bin_size, MYF(MY_THREAD_SPECIFIC));
  };
  ...
  String *avg(String *s, ha_rows rows);
  friend int collect_decimal(uchar *element, element_count count, TREE_INFO *info);
...
class field_real : public field_info
{
 ...
 public:
  ...
  {
    init_tree(&tree, 0, 0, sizeof(double), (qsort_cmp2)compare_double2, NULL, NULL, MYF(MY_THREAD_SPECIFIC));
  }
...
class field_longlong : public field_info
{
 ...
 public:
  ...
  {
    init_tree(&tree, 0, 0, sizeof(longlong), (qsort_cmp2)compare_longlong2, NULL, NULL, MYF(MY_THREAD_SPECIFIC));
  }
...
class field_ulonglong : public field_info
{
 ...
 public:
  ...
  {
    init_tree(&tree, 0, 0, sizeof(ulonglong), (qsort_cmp2)compare_ulonglong2, NULL, NULL, MYF(MY_THREAD_SPECIFIC));
  }
  void add();
  void get_opt_type(String *, ha_rows);
  String *get_min_arg(String *s)
