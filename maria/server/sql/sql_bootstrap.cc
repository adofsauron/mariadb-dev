...
static bool is_end_of_query(const char *line, size_t len, const std::string &delimiter)
{
...
extern "C" int read_bootstrap_query(char *query, int *query_length, fgets_input_t input, fgets_fn_t fgets_fn,
