...
extern "C" uchar *get_native_fct_hash_key(const uchar *buff, size_t *length, my_bool /* unused */)
{
...
{
 public:
  virtual Item *create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list);
...
{
 public:
  Item *create_native(THD *thd, const LEX_CSTRING *, List<Item> *item_list) override;
...
class Create_func_lpad : public Create_native_func
{
 public:
  virtual Item *create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
  {
    return thd->variables.sql_mode & MODE_ORACLE ? create_native_oracle(thd, name, item_list)
 ...
 protected:
  ...
  Item *create_native_std(THD *thd, const LEX_CSTRING *name, List<Item> *items);
  Item *create_native_oracle(THD *thd, const LEX_CSTRING *name, List<Item> *items);
};
...
Item *Create_qfunc::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  LEX_CSTRING db;
...
Item *Create_udf_func::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
...
Item *Create_udf_func::create(THD *thd, udf_func *udf, List<Item> *item_list)
{
  ...
  DBUG_ASSERT((udf->type == UDFTYPE_FUNCTION) || (udf->type == UDFTYPE_AGGREGATE));
...
Item *Create_sp_func::create_with_db(THD *thd, const LEX_CSTRING *db, const LEX_CSTRING *name, bool use_explicit_name,
                                     List<Item> *item_list)
{
  int arg_count = 0;
  Item *func = NULL;
  ...
  if (unlikely(sph->sp_resolve_package_routine(thd, thd->lex->sphead, qname, &sph, &pkgname)))
    return NULL;
...
Item *Create_native_func::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  if (unlikely(has_named_parameters(item_list)))
  {
...
Item *Create_func_arg0::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_arg1::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_arg2::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
  ...
  if (unlikely(param_1->is_explicit_name() || param_2->is_explicit_name()))
  {
    my_error(ER_WRONG_PARAMETERS_TO_NATIVE_FCT, MYF(0), name->str);
    return NULL;
  }
...
Item *Create_func_arg3::create_func(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
  ...
  if (unlikely(param_1->is_explicit_name() || param_2->is_explicit_name() || param_3->is_explicit_name()))
  {
    my_error(ER_WRONG_PARAMETERS_TO_NATIVE_FCT, MYF(0), name->str);
    return NULL;
  }
...
Item *Create_func_abs::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_abs(thd, arg1); }

Create_func_acos Create_func_acos::s_singleton;

Item *Create_func_acos::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_acos(thd, arg1); }

Create_func_addtime Create_func_addtime::s_singleton;

Item *Create_func_addtime::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_aes_encrypt::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_aes_decrypt::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_asin::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_asin(thd, arg1); }

Create_func_atan Create_func_atan::s_singleton;

Item *Create_func_atan::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_benchmark::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_bin::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_binlog_gtid_pos::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_bit_count::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_bit_length::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_ceiling::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_chr::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_char_length::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_coercibility::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dyncol_check::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dyncol_exists::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_dyncol_list::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dyncol_json::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_concat::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
  ...
  return thd->variables.sql_mode & MODE_ORACLE ? new (thd->mem_root) Item_func_concat_operator_oracle(thd, *item_list)
                                               : new (thd->mem_root) Item_func_concat(thd, *item_list);
}

Create_func_concat_operator_oracle Create_func_concat_operator_oracle::s_singleton;

Item *Create_func_concat_operator_oracle::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_decode_histogram::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_decode_oracle::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
...
Item *Create_func_concat_ws::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_compress::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_connection_id::create_builder(THD *thd)
{
  thd->lex->safe_to_cache_query = 0;
...
Item *Create_func_nvl2::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_conv::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_convert_tz::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_cos::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_cos(thd, arg1); }

Create_func_cot Create_func_cot::s_singleton;

Item *Create_func_cot::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_cot(thd, arg1); }

Create_func_crc32 Create_func_crc32::s_singleton;

Item *Create_func_crc32::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  ...
  return arg2 ? new (thd->mem_root) Item_func_crc32(thd, false, arg1, arg2)
              : new (thd->mem_root) Item_func_crc32(thd, false, arg1);
}

Create_func_crc32c Create_func_crc32c::s_singleton;

Item *Create_func_crc32c::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int argc = item_list ? item_list->elements : 0;
  ...
  return arg2 ? new (thd->mem_root) Item_func_crc32(thd, true, arg1, arg2)
              : new (thd->mem_root) Item_func_crc32(thd, true, arg1);
}

Create_func_datediff Create_func_datediff::s_singleton;

Item *Create_func_datediff::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_dayname::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dayofmonth::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dayofweek::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_dayofyear::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_degrees::create_1_arg(THD *thd, Item *arg1)
{
  return new (thd->mem_root) Item_func_units(thd, (char *)"degrees", arg1, 180 / M_PI, 0.0);
}

Create_func_des_decrypt Create_func_des_decrypt::s_singleton;

Item *Create_func_des_decrypt::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_des_encrypt::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_elt::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_encode::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_encrypt::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_exp::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_exp(thd, arg1); }

Create_func_export_set Create_func_export_set::s_singleton;

Item *Create_func_export_set::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
  ...
  switch (arg_count)
  {
    ...
    case 4:
    {
      ...
      func = new (thd->mem_root) Item_func_export_set(thd, param_1, param_2, param_3, param_4);
      break;
    }
    case 5:
    {
      ...
      func = new (thd->mem_root) Item_func_export_set(thd, param_1, param_2, param_3, param_4, param_5);
      break;
    }
    default:
    {
...
Item *Create_func_field::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_find_in_set::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_floor::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_floor(thd, arg1); }

Create_func_format Create_func_format::s_singleton;

Item *Create_func_format::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
...
Item *Create_func_from_base64::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_found_rows::create_builder(THD *thd)
{
...
Item *Create_func_from_days::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_from_unixtime::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_get_lock::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_greatest::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_hex::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_hex(thd, arg1); }

Create_func_ifnull Create_func_ifnull::s_singleton;

Item *Create_func_ifnull::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_instr::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_is_free_lock::create_1_arg(THD *thd, Item *arg1)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_is_used_lock::create_1_arg(THD *thd, Item *arg1)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_isnull::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_isnull(thd, arg1); }

Create_func_json_normalize Create_func_json_normalize::s_singleton;

Item *Create_func_json_normalize::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_json_equals::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_exists::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_detailed::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_loose::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
  return new (thd->mem_root) Item_func_json_format(thd, arg1, Item_func_json_format::LOOSE);
}

Create_func_json_compact Create_func_json_compact::s_singleton;

Item *Create_func_json_compact::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
  return new (thd->mem_root) Item_func_json_format(thd, arg1, Item_func_json_format::COMPACT);
}

Create_func_json_valid Create_func_json_valid::s_singleton;

Item *Create_func_json_valid::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_type::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_depth::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_value::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_query::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_quote::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_json_unquote::create_1_arg(THD *thd, Item *arg1)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_last_day::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_json_array::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func;
...
Item *Create_func_json_array_append::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_array_insert::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_insert::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
  ...
  {
    func = new (thd->mem_root) Item_func_json_insert(true, false, thd, *item_list);
  }
...
Item *Create_func_json_set::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
  ...
  {
    func = new (thd->mem_root) Item_func_json_insert(true, true, thd, *item_list);
  }
...
Item *Create_func_json_replace::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
  ...
  {
    func = new (thd->mem_root) Item_func_json_insert(false, true, thd, *item_list);
  }
...
Item *Create_func_json_remove::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_object::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func;
  int arg_count;
...
Item *Create_func_json_length::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func;
  int arg_count;

  if (unlikely(item_list == NULL || (arg_count = item_list->elements) == 0))
  {
    my_error(ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, MYF(0), name->str);
    func = NULL;
  }
...
Item *Create_func_json_merge::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func;
  int arg_count;

  if (unlikely(item_list == NULL || (arg_count = item_list->elements) < 2))  // json, json
  {
    my_error(ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, MYF(0), name->str);
    func = NULL;
  }
...
Item *Create_func_json_merge_patch::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func;
  int arg_count;

  if (item_list == NULL || (arg_count = item_list->elements) < 2)  // json, json
  {
    my_error(ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, MYF(0), name->str);
    func = NULL;
  }
...
Item *Create_func_json_contains::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_keys::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_contains_path::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_extract::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_search::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_json_overlaps::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  status_var_increment(thd->status_var.feature_json);
...
Item *Create_func_last_insert_id::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_lcase::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_lcase(thd, arg1); }

Create_func_least Create_func_least::s_singleton;

Item *Create_func_least::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_length::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_octet_length::create_1_arg(THD *thd, Item *arg1)
{
  return new (thd->mem_root) Item_func_octet_length(thd, arg1);
}
...
Item *Create_func_like_range_min::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_like_range_max::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_ln::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_ln(thd, arg1); }

Create_func_load_file Create_func_load_file::s_singleton;

Item *Create_func_load_file::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_locate::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_log::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_log10::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_log10(thd, arg1); }

Create_func_log2 Create_func_log2::s_singleton;

Item *Create_func_log2::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_log2(thd, arg1); }

Create_func_lpad Create_func_lpad::s_singleton;

Create_func_lpad_oracle Create_func_lpad_oracle::s_singleton;

Item *Create_func_lpad::create_native_std(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = item_list ? item_list->elements : 0;
...
Item *Create_func_lpad::create_native_oracle(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = item_list ? item_list->elements : 0;
  switch (arg_count)
  {
    ...
    case 3:
    {
      ...
      Item *param_2 = item_list->pop();
      Item *param_3 = item_list->pop();
      return new (thd->mem_root) Item_func_lpad_oracle(thd, param_1, param_2, param_3);
    }
    default:
      my_error(ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, MYF(0), name->str);
      break;
...
Item *Create_func_ltrim::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_ltrim_oracle::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_makedate::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_maketime::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_make_set::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_master_pos_wait::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)

{
  ...
  switch (arg_count)
  {
    ...
    case 4:
    {
      Item *param_3 = item_list->pop();
      Item *param_4 = item_list->pop();
      func = new (thd->mem_root) Item_master_pos_wait(thd, param_1, param_2, param_3, param_4);
      break;
    }
  }
...
Item *Create_func_master_gtid_wait::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_md5::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_md5(thd, arg1); }
...
Item *Create_func_monthname::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_name_const::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  ...
  if (arg2->type() == Item::FUNC_ITEM)
  {
    ...
    if (value_func->functype() != Item_func::COLLATE_FUNC && value_func->functype() != Item_func::NEG_FUNC)
      goto err;
...
Item *Create_func_nullif::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_oct::create_1_arg(THD *thd, Item *arg1)
{
  Item *i10 = new (thd->mem_root) Item_int(thd, (int32)10, 2);
...
Item *Create_func_ord::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_ord(thd, arg1); }

Create_func_period_add Create_func_period_add::s_singleton;

Item *Create_func_period_add::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_period_diff::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_pi::create_builder(THD *thd)
{
...
Item *Create_func_pow::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_quote::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_quote(thd, arg1); }

Create_func_regexp_instr Create_func_regexp_instr::s_singleton;

Item *Create_func_regexp_instr::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_regexp_replace::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_regexp_substr::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_radians::create_1_arg(THD *thd, Item *arg1)
{
  return new (thd->mem_root) Item_func_units(thd, (char *)"radians", arg1, M_PI / 180, 0.0);
}

Create_func_rand Create_func_rand::s_singleton;

Item *Create_func_rand::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_release_all_locks::create_builder(THD *thd)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_release_lock::create_1_arg(THD *thd, Item *arg1)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_replace_oracle::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_reverse::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_round::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_rpad::create_native_std(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = item_list ? item_list->elements : 0;
...
Item *Create_func_rpad::create_native_oracle(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = item_list ? item_list->elements : 0;
  switch (arg_count)
  {
    ...
    case 3:
    {
      ...
      Item *param_2 = item_list->pop();
      Item *param_3 = item_list->pop();
      return new (thd->mem_root) Item_func_rpad_oracle(thd, param_1, param_2, param_3);
    }
    default:
      my_error(ER_WRONG_PARAMCOUNT_TO_NATIVE_FCT, MYF(0), name->str);
      break;
...
Item *Create_func_rtrim::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_rtrim_oracle::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_sec_to_time::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_sformat::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  int arg_count = 0;
...
Item *Create_func_sha::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_sha(thd, arg1); }

Create_func_sha2 Create_func_sha2::s_singleton;

Item *Create_func_sha2::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_sign::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_sign(thd, arg1); }

Create_func_sin Create_func_sin::s_singleton;

Item *Create_func_sin::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_sin(thd, arg1); }

Create_func_sleep Create_func_sleep::s_singleton;

Item *Create_func_sleep::create_1_arg(THD *thd, Item *arg1)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  thd->lex->uncacheable(UNCACHEABLE_SIDEEFFECT);
...
Item *Create_func_soundex::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_space::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_space(thd, arg1); }

Create_func_sqrt Create_func_sqrt::s_singleton;

Item *Create_func_sqrt::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_sqrt(thd, arg1); }

Create_func_str_to_date Create_func_str_to_date::s_singleton;

Item *Create_func_str_to_date::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_strcmp::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_substr_index::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_substr_oracle::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = item_list ? item_list->elements : 0;
...
Item *Create_func_subtime::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_tan::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_tan(thd, arg1); }

Create_func_time_format Create_func_time_format::s_singleton;

Item *Create_func_time_format::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_time_to_sec::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_timediff::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_to_base64::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_to_char::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_to_days::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_to_seconds::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_ucase::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_ucase(thd, arg1); }

Create_func_uncompress Create_func_uncompress::s_singleton;

Item *Create_func_uncompress::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_uncompressed_length::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_unhex::create_1_arg(THD *thd, Item *arg1) { return new (thd->mem_root) Item_func_unhex(thd, arg1); }

Create_func_unix_timestamp Create_func_unix_timestamp::s_singleton;

Item *Create_func_unix_timestamp::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_uuid_short::create_builder(THD *thd)
{
...
Item *Create_func_version::create_builder(THD *thd)
{
  thd->lex->set_stmt_unsafe(LEX::BINLOG_STMT_UNSAFE_SYSTEM_FUNCTION);
  static Lex_cstring name(STRING_WITH_LEN("version()"));
  return new (thd->mem_root)
      Item_static_string_func(thd, name, Lex_cstring_strlen(server_version), system_charset_info, DERIVATION_SYSCONST);
}

Create_func_weekday Create_func_weekday::s_singleton;

Item *Create_func_weekday::create_1_arg(THD *thd, Item *arg1)
{
...
Item *Create_func_weekofyear::create_1_arg(THD *thd, Item *arg1)
{
...
#ifdef WITH_WSREP
Create_func_wsrep_last_written_gtid Create_func_wsrep_last_written_gtid::s_singleton;

Item *Create_func_wsrep_last_written_gtid::create_builder(THD *thd)
{
  thd->lex->safe_to_cache_query = 0;
  return new (thd->mem_root) Item_func_wsrep_last_written_gtid(thd);
}

Create_func_wsrep_last_seen_gtid Create_func_wsrep_last_seen_gtid::s_singleton;

Item *Create_func_wsrep_last_seen_gtid::create_builder(THD *thd)
{
  thd->lex->safe_to_cache_query = 0;
  return new (thd->mem_root) Item_func_wsrep_last_seen_gtid(thd);
}

Create_func_wsrep_sync_wait_upto Create_func_wsrep_sync_wait_upto::s_singleton;

Item *Create_func_wsrep_sync_wait_upto::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Item *Create_func_xml_extractvalue::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
...
Item *Create_func_xml_update::create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3)
{
...
Item *Create_func_year_week::create_native(THD *thd, const LEX_CSTRING *name, List<Item> *item_list)
{
  Item *func = NULL;
  int arg_count = 0;
...
Native_func_registry_array native_func_registry_array(func_array, array_elements(func_array));
...
int item_create_init()
{
...
#endif
  if (my_hash_init(key_memory_native_functions, &native_functions_hash, system_charset_info, (ulong)count, 0, 0,
                   (my_hash_get_key)get_native_fct_hash_key, NULL, MYF(0)))
    DBUG_RETURN(1);
  ...
  for (uint i = 0; i < native_functions_hash.records; i++)
  {
    ...
    DBUG_PRINT("info", ("native function: %s  length: %u", func->name.str, (uint)func->name.length));
  }
#endif
...
static Create_func *function_plugin_find_native_function_builder(THD *thd, const LEX_CSTRING &name)
{
  plugin_ref plugin;
  if ((plugin = my_plugin_lock_by_name(thd, &name, MariaDB_FUNCTION_PLUGIN)))
  {
    Create_func *builder = reinterpret_cast<Plugin_function *>(plugin_decl(plugin)->info)->create_func();
...
Create_func *find_native_function_builder(THD *thd, const LEX_CSTRING *name)
{
  ...
  /* Thread safe */
  func = (Native_func_registry *)my_hash_search(&native_functions_hash, (uchar *)name->str, name->length);
...
Create_qfunc *find_qualified_function_builder(THD *thd) { return &Create_sp_func::s_singleton; }

static List<Item> *create_func_dyncol_prepare(THD *thd, DYNCALL_CREATE_DEF **dfs, List<DYNCALL_CREATE_DEF> &list)
{
  DYNCALL_CREATE_DEF *def;
  List_iterator_fast<DYNCALL_CREATE_DEF> li(list);
  List<Item> *args = new (thd->mem_root) List<Item>;

  *dfs = (DYNCALL_CREATE_DEF *)alloc_root(thd->mem_root, sizeof(DYNCALL_CREATE_DEF) * list.elements);
...
Item *create_func_dyncol_delete(THD *thd, Item *str, List<Item> &nums)
{
  ...
  dfs = (DYNCALL_CREATE_DEF *)alloc_root(thd->mem_root, sizeof(DYNCALL_CREATE_DEF) * nums.elements);
  if (!args || !dfs)
    return NULL;
...
Item *create_func_dyncol_get(THD *thd, Item *str, Item *num, const Type_handler *handler,
                             const Lex_length_and_dec_st &length_dec, CHARSET_INFO *cs)
{
  Item *res;

  if (likely(!(res = new (thd->mem_root) Item_dyncol_get(thd, str, num))))
    return res;  // Return NULL
  return handler->create_typecast_item(thd, res, Type_cast_attributes(length_dec, cs));
}
