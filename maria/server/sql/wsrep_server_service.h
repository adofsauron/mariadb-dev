...
{
 public:
  Wsrep_server_service(Wsrep_server_state &server_state) : m_server_state(server_state) {}
  ...
  wsrep::high_priority_service *streaming_applier_service(wsrep::client_service &);

  wsrep::high_priority_service *streaming_applier_service(wsrep::high_priority_service &);
  ...
  void log_dummy_write_set(wsrep::client_state &, const wsrep::ws_meta &) { throw wsrep::not_implemented_error(); }
  ...
  void log_state_change(enum wsrep::server_state::state, enum wsrep::server_state::state);
