...
class Group_bound_tracker
{
  ...
  */
  ...
  ~Group_bound_tracker() { group_fields.delete_elements(); }
...
class Item_sum_row_number : public Item_sum_int
{
 ...
 public:
  Item_sum_row_number(THD *thd) : Item_sum_int(thd), count(0) {}
  ...
  longlong val_int() override { return count; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_row_number>(thd, this); }
};
...
class Item_sum_rank : public Item_sum_int
{
 ...
 public:
  ...
  longlong val_int() override { return cur_rank; }

  void reset_field() override { DBUG_ASSERT(0); }
  void update_field() override {}

  enum Sumfunctype sum_func() const override { return RANK_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_rank>(thd, this); }
};
...
class Item_sum_dense_rank : public Item_sum_int
{
  ...
  */
  ...
  void reset_field() override { DBUG_ASSERT(0); }
  void update_field() override {}
  longlong val_int() override { return dense_rank; }

  Item_sum_dense_rank(THD *thd) : Item_sum_int(thd), dense_rank(0), first_add(true), peer_tracker(NULL) {}
  const Type_handler *type_handler() const override { return &type_handler_slonglong; }
  enum Sumfunctype sum_func() const override { return DENSE_RANK_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_dense_rank>(thd, this); }
};

class Item_sum_hybrid_simple : public Item_sum_hybrid
{
 public:
  Item_sum_hybrid_simple(THD *thd, Item *arg) : Item_sum_hybrid(thd, arg), value(NULL) {}

  Item_sum_hybrid_simple(THD *thd, Item *arg1, Item *arg2) : Item_sum_hybrid(thd, arg1, arg2), value(NULL) {}
...
{
 public:
  Item_sum_first_value(THD *thd, Item *arg_expr) : Item_sum_hybrid_simple(thd, arg_expr) {}

  enum Sumfunctype sum_func() const override { return FIRST_VALUE_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_first_value>(thd, this); }
};
...
{
 public:
  Item_sum_last_value(THD *thd, Item *arg_expr) : Item_sum_hybrid_simple(thd, arg_expr) {}

  enum Sumfunctype sum_func() const override { return LAST_VALUE_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_last_value>(thd, this); }
};

class Item_sum_nth_value : public Item_sum_hybrid_simple
{
 public:
  Item_sum_nth_value(THD *thd, Item *arg_expr, Item *offset_expr) : Item_sum_hybrid_simple(thd, arg_expr, offset_expr)
  {
  }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_nth_value>(thd, this); }
};

class Item_sum_lead : public Item_sum_hybrid_simple
{
 public:
  Item_sum_lead(THD *thd, Item *arg_expr, Item *offset_expr) : Item_sum_hybrid_simple(thd, arg_expr, offset_expr) {}

  enum Sumfunctype sum_func() const override { return LEAD_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_lead>(thd, this); }
};

class Item_sum_lag : public Item_sum_hybrid_simple
{
 public:
  Item_sum_lag(THD *thd, Item *arg_expr, Item *offset_expr) : Item_sum_hybrid_simple(thd, arg_expr, offset_expr) {}

  enum Sumfunctype sum_func() const override { return LAG_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_lag>(thd, this); }
};
...
class Partition_row_count
{
 public:
  ...
  void set_partition_row_count(ulonglong count) { partition_row_count_ = count; }
  double calc_val_real(bool *null_value, ulonglong current_row_count)
  {
...
*/
class Item_sum_percent_rank : public Item_sum_double, public Partition_row_count
{
 public:
  Item_sum_percent_rank(THD *thd) : Item_sum_double(thd), cur_rank(1), peer_tracker(NULL) {}
  ...
  double val_real() override
  {
    ...
    */
    ...
    return partition_rows > 1 ? static_cast<double>(cur_rank - 1) / (partition_rows - 1) : 0;
  }
  ...
  void set_partition_row_count(ulonglong count) override { Partition_row_count::set_partition_row_count(count); }

  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_percent_rank>(thd, this); }
...
class Item_sum_cume_dist : public Item_sum_double, public Partition_row_count, public Current_row_count
{
 public:
  Item_sum_cume_dist(THD *thd) : Item_sum_double(thd) {}
  Item_sum_cume_dist(THD *thd, Item *arg) : Item_sum_double(thd, arg) {}

  double val_real() override { return calc_val_real(&null_value, current_row_count_); }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_cume_dist>(thd, this); }
};

class Item_sum_ntile : public Item_sum_int, public Partition_row_count, public Current_row_count
{
 public:
  Item_sum_ntile(THD *thd, Item *num_quantiles_expr) : Item_sum_int(thd, num_quantiles_expr), n_old_val_(0) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_ntile>(thd, this); }
                                 ...
                                 public Current_row_count
{
 public:
  ...
  enum Sumfunctype sum_func() const override { return PERCENTILE_DISC_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_percentile_disc>(thd, this); }
  void setup_window_func(THD *thd, Window_spec *window_spec) override;
  void setup_hybrid(THD *thd, Item *item);
...
class Item_sum_percentile_cont : public Item_sum_double, public Partition_row_count, public Current_row_count
{
 public:
  Item_sum_percentile_cont(THD *thd, Item *arg)
      : Item_sum_double(thd, arg),
        floor_value(NULL),
        ceil_value(NULL),
        first_call(TRUE),
        prev_value(0),
  ...
  double val_real() override
  {
    ...
    */
    ...
    double ret_val = ((val - floor(val)) * ceil_value->val_real()) + ((ceil(val) - val) * floor_value->val_real());
  ...
  enum Sumfunctype sum_func() const override { return PERCENTILE_CONT_FUNC; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_sum_percentile_cont>(thd, this); }
  void setup_window_func(THD *thd, Window_spec *window_spec) override;
  void setup_hybrid(THD *thd, Item *item);
  bool fix_fields(THD *thd, Item **ref) override;
...
class Item_window_func : public Item_func_or_sum
{
  ...
  */
  ...
  const Type_handler *type_handler() const override { return ((Item_sum *)args[0])->type_handler(); }
