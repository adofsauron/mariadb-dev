...
class Item_func : public Item_func_or_sum
{
 ...
 protected:
  virtual bool check_arguments() const { return check_argument_types_scalar(0, arg_count); }
  ...
  bool check_argument_types_or_binary(const Type_handler *handler, uint start, uint end) const;
 ...
 public:
  ...
  static scalar_comparison_op functype_to_scalar_comparison_op(Functype type)
  {
    switch (type)
    {
      ...
      case EQUAL_FUNC:
        return SCALAR_CMP_EQUAL;
      case LT_FUNC:
        return SCALAR_CMP_LT;
      case LE_FUNC:
        return SCALAR_CMP_LE;
      case GE_FUNC:
        return SCALAR_CMP_GE;
      case GT_FUNC:
        return SCALAR_CMP_GT;
      default:
        break;
    }
    DBUG_ASSERT(0);
  ...
  Item_func(THD *thd, Item *a) : Item_func_or_sum(thd, a) { with_flags = a->with_flags; }
  Item_func(THD *thd, Item *a, Item *b) : Item_func_or_sum(thd, a, b) { with_flags = a->with_flags | b->with_flags; }
  Item_func(THD *thd, Item *a, Item *b, Item *c) : Item_func_or_sum(thd, a, b, c)
  {
  ...
  Item_func(THD *thd, Item *a, Item *b, Item *c, Item *d, Item *e) : Item_func_or_sum(thd, a, b, c, d, e)
  {
    with_flags = (a->with_flags | b->with_flags | c->with_flags | d->with_flags | e->with_flags);
  }
  Item_func(THD *thd, List<Item> &list) : Item_func_or_sum(thd, list) { set_arguments(thd, list); }
  // Constructor used for Item_cond_and/or (see Item comment)
  Item_func(THD *thd, Item_func *item) : Item_func_or_sum(thd, item), not_null_tables_cache(item->not_null_tables_cache)
  {
  }
  ...
  {
    ulonglong max_result_length = max_char_length_arg * collation.collation->mbmaxlen;
  ...
  /**
     ...
     +/-INF or NAN.
  */
  inline double check_float_overflow(double value) { return std::isfinite(value) ? value : raise_float_overflow(); }
  /**
  ...
  */
  inline longlong check_integer_overflow(longlong value, bool val_unsigned)
  {
    if ((unsigned_flag && !val_unsigned && value < 0) ||
        (!unsigned_flag && val_unsigned && (ulonglong)value > (ulonglong)LONGLONG_MAX))
  ...
  */
  inline int check_decimal_overflow(int error) { return (error == E_DEC_OVERFLOW) ? raise_decimal_overflow() : error; }
  ...
  bool has_timestamp_args()
  {
    ...
    {
      if (args[i]->type() == Item::FIELD_ITEM && args[i]->field_type() == MYSQL_TYPE_TIMESTAMP)
        return TRUE;
    }
    return FALSE;
  }
  ...
  bool has_date_args()
  {
    ...
    for (uint i = 0; i < arg_count; i++)
    {
      if (args[i]->type() == Item::FIELD_ITEM &&
          (args[i]->field_type() == MYSQL_TYPE_DATE || args[i]->field_type() == MYSQL_TYPE_DATETIME))
        return TRUE;
    }
    return FALSE;
  }
  ...
  bool has_time_args()
  {
    ...
    {
      if (args[i]->type() == Item::FIELD_ITEM &&
          (args[i]->field_type() == MYSQL_TYPE_TIME || args[i]->field_type() == MYSQL_TYPE_DATETIME))
        return TRUE;
    }
    return FALSE;
  }
  ...
  bool has_datetime_args()
  {
    ...
    for (uint i = 0; i < arg_count; i++)
    {
      if (args[i]->type() == Item::FIELD_ITEM && args[i]->field_type() == MYSQL_TYPE_DATETIME)
        return TRUE;
    }
    return FALSE;
  }
  ...
  bool has_rand_bit() { return used_tables() & RAND_TABLE_BIT; }

  bool excl_dep_on_table(table_map tab_map) override
  {
    if (used_tables() & (OUTER_REF_TABLE_BIT | RAND_TABLE_BIT))
      return false;
    return !(used_tables() & ~tab_map) || Item_args::excl_dep_on_table(tab_map);
  }
  ...
  /*
    ...
    the timezone.
   */
  bool check_valid_arguments_processor(void *bool_arg) override { return has_timestamp_args(); }

  bool find_function_processor(void *arg) override { return functype() == *(Functype *)arg; }
  ...
  */
  ...
  bool is_simplified_cond_processor(void *arg) override { return const_item() && !val_int(); }
};
...
class Item_real_func : public Item_func
{
 public:
  ...
  Item_real_func(THD *thd, Item *a) : Item_func(thd, a) { collation = DTCollation_numeric(); }
  Item_real_func(THD *thd, Item *a, Item *b) : Item_func(thd, a, b) { collation = DTCollation_numeric(); }
  Item_real_func(THD *thd, List<Item> &list) : Item_func(thd, list) { collation = DTCollation_numeric(); }
...
*/
class Item_hybrid_func : public Item_func, public Type_handler_hybrid_field_type
{
 protected:
 ...
 public:
  ...
  Item_hybrid_func(THD *thd, Item *a, Item *b, Item *c) : Item_func(thd, a, b, c) {}
  Item_hybrid_func(THD *thd, List<Item> &list) : Item_func(thd, list) {}
  Item_hybrid_func(THD *thd, Item_hybrid_func *item) : Item_func(thd, item), Type_handler_hybrid_field_type(item) {}
  ...
  void fix_length_and_dec_long_or_longlong(uint char_length, bool unsigned_arg)
  {
    ...
    set_handler(Type_handler::type_handler_long_or_longlong(char_length, unsigned_arg));
  }
...
class Item_handled_func : public Item_func
{
 public:
  class Handler
  {
   public:
    ...
    virtual const Type_handler *return_type_handler(const Item_handled_func *item) const = 0;
    virtual const Type_handler *type_handler_for_create_select(const Item_handled_func *item) const
    {
  ...
  {
   public:
    String *val_str_ascii(Item_handled_func *item, String *str) const { return item->Item::val_str_ascii(str); }
    ...
    my_decimal *val_decimal(Item_handled_func *item, my_decimal *to) const { return item->val_decimal_from_string(to); }
    bool get_date(THD *thd, Item_handled_func *item, MYSQL_TIME *to, date_mode_t fuzzydate) const
    {
  ...
  */
  ...
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *) const { return &type_handler_string; }
    const Type_handler *type_handler_for_create_select(const Item_handled_func *item) const
    {
      return return_type_handler(item)->type_handler_for_tmp_table(item);
    }
    double val_real(Item_handled_func *item) const { return Temporal_hybrid(item).to_double(); }
    longlong val_int(Item_handled_func *item) const { return Temporal_hybrid(item).to_longlong(); }
  ...
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *) const { return &type_handler_newdate; }
    bool fix_length_and_dec(Item_handled_func *item) const
    {
      item->fix_attributes_date();
      return false;
    }
    double val_real(Item_handled_func *item) const { return Date(item).to_double(); }
    longlong val_int(Item_handled_func *item) const { return Date(item).to_longlong(); }
    my_decimal *val_decimal(Item_handled_func *item, my_decimal *to) const { return Date(item).to_decimal(to); }
    String *val_str_ascii(Item_handled_func *item, String *to) const { return Date(item).to_string(to); }
  };

  class Handler_time : public Handler_temporal
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *) const { return &type_handler_time2; }
    double val_real(Item_handled_func *item) const { return Time(item).to_double(); }
    longlong val_int(Item_handled_func *item) const { return Time(item).to_longlong(); }
    my_decimal *val_decimal(Item_handled_func *item, my_decimal *to) const { return Time(item).to_decimal(to); }
    String *val_str_ascii(Item_handled_func *item, String *to) const
    {
  ...
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *) const { return &type_handler_datetime2; }
    double val_real(Item_handled_func *item) const { return Datetime(item).to_double(); }
    longlong val_int(Item_handled_func *item) const { return Datetime(item).to_longlong(); }
    my_decimal *val_decimal(Item_handled_func *item, my_decimal *to) const { return Datetime(item).to_decimal(to); }
    String *val_str_ascii(Item_handled_func *item, String *to) const
    {
  ...
  class Handler_int : public Handler
  {
   public:
    ...
    String *val_str_ascii(Item_handled_func *item, String *to) const { return item->Item::val_str_ascii(to); }
    double val_real(Item_handled_func *item) const
    {
      return item->unsigned_flag ? (double)((ulonglong)val_int(item)) : (double)val_int(item);
    }
    my_decimal *val_decimal(Item_handled_func *item, my_decimal *to) const { return item->val_decimal_from_int(to); }
    bool get_date(THD *thd, Item_handled_func *item, MYSQL_TIME *to, date_mode_t fuzzydate) const
    {
  ...
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *item) const { return &type_handler_slong; }
    bool fix_length_and_dec(Item_handled_func *item) const
    {
  ...
  {
   public:
    const Type_handler *return_type_handler(const Item_handled_func *item) const { return &type_handler_ulonglong; }
    bool fix_length_and_dec(Item_handled_func *item) const
    {
 ...
 public:
  Item_handled_func(THD *thd, Item *a) : Item_func(thd, a), m_func_handler(NULL) {}
  Item_handled_func(THD *thd, Item *a, Item *b) : Item_func(thd, a, b), m_func_handler(NULL) {}
  void set_func_handler(const Handler *handler) { m_func_handler = handler; }
  const Type_handler *type_handler() const override { return m_func_handler->return_type_handler(this); }
  Field *create_field_for_create_select(MEM_ROOT *root, TABLE *table) override
  {
    DBUG_ASSERT(fixed());
  ...
  String *val_str(String *to) override { return m_func_handler->val_str(this, to); }
  String *val_str_ascii(String *to) override { return m_func_handler->val_str_ascii(this, to); }
  double val_real() override { return m_func_handler->val_real(this); }
  longlong val_int() override { return m_func_handler->val_int(this); }
  my_decimal *val_decimal(my_decimal *to) override { return m_func_handler->val_decimal(this, to); }
  bool get_date(THD *thd, MYSQL_TIME *to, date_mode_t fuzzydate) override
  {
    return m_func_handler->get_date(thd, this, to, fuzzydate);
  }
  bool val_native(THD *thd, Native *to) override { return m_func_handler->val_native(thd, this, to); }
};
...
class Item_func_hybrid_field_type : public Item_hybrid_func
{
 ...
 public:
  ...
  String *val_str_from_str_op(String *str) { return str_op_with_null_check(&str_value); }
  longlong val_int_from_int_op() { return int_op(); }
  double val_real_from_real_op() { return real_op(); }
 ...
 public:
  Item_func_hybrid_field_type(THD *thd) : Item_hybrid_func(thd) { collation = DTCollation_numeric(); }
  Item_func_hybrid_field_type(THD *thd, Item *a) : Item_hybrid_func(thd, a) { collation = DTCollation_numeric(); }
  Item_func_hybrid_field_type(THD *thd, Item *a, Item *b) : Item_hybrid_func(thd, a, b)
  {
    collation = DTCollation_numeric();
  }
  Item_func_hybrid_field_type(THD *thd, Item *a, Item *b, Item *c) : Item_hybrid_func(thd, a, b, c)
  {
    collation = DTCollation_numeric();
  }
  Item_func_hybrid_field_type(THD *thd, List<Item> &list) : Item_hybrid_func(thd, list)
  {
    collation = DTCollation_numeric();
  }
  ...
  {
    DBUG_ASSERT(fixed());
    return Item_func_hybrid_field_type::type_handler()->Item_func_hybrid_field_type_val_real(this);
  }
  longlong val_int() override
  {
    DBUG_ASSERT(fixed());
    return Item_func_hybrid_field_type::type_handler()->Item_func_hybrid_field_type_val_int(this);
  }
  my_decimal *val_decimal(my_decimal *dec) override
  {
    DBUG_ASSERT(fixed());
    return Item_func_hybrid_field_type::type_handler()->Item_func_hybrid_field_type_val_decimal(this, dec);
  }
  String *val_str(String *str) override
  {
    DBUG_ASSERT(fixed());
    String *res = Item_func_hybrid_field_type::type_handler()->Item_func_hybrid_field_type_val_str(this, str);
  ...
  {
    DBUG_ASSERT(fixed());
    return Item_func_hybrid_field_type::type_handler()->Item_func_hybrid_field_type_get_date_with_warn(thd, this, to,
                                                                                                       mode);
  }
...
{
 public:
  Item_func_case_expression(THD *thd) : Item_func_hybrid_field_type(thd) {}
  Item_func_case_expression(THD *thd, Item *a) : Item_func_hybrid_field_type(thd, a) {}
  Item_func_case_expression(THD *thd, Item *a, Item *b) : Item_func_hybrid_field_type(thd, a, b) {}
  Item_func_case_expression(THD *thd, Item *a, Item *b, Item *c) : Item_func_hybrid_field_type(thd, a, b, c) {}
  Item_func_case_expression(THD *thd, List<Item> &list) : Item_func_hybrid_field_type(thd, list) {}
...
class Item_func_numhybrid : public Item_func_hybrid_field_type
{
 ...
 public:
  ...
  Item_func_numhybrid(THD *thd, Item *a, Item *b) : Item_func_hybrid_field_type(thd, a, b) {}
  Item_func_numhybrid(THD *thd, Item *a, Item *b, Item *c) : Item_func_hybrid_field_type(thd, a, b, c) {}
  Item_func_numhybrid(THD *thd, List<Item> &list) : Item_func_hybrid_field_type(thd, list) {}
...
class Item_num_op : public Item_func_numhybrid
{
 ...
 public:
  ...
  void print(String *str, enum_query_type query_type) override { print_op(str, query_type); }
...
class Item_int_func : public Item_func
{
  ...
  */
  ...
  Item_int_func(THD *thd, Item_int_func *item) : Item_func(thd, item) { collation = DTCollation_numeric(); }
  double val_real() override;
  String *val_str(String *str) override;
  my_decimal *val_decimal(my_decimal *decimal_value) override { return val_decimal_from_int(decimal_value); }
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
...
class Item_func_hash : public Item_int_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_hash>(thd, this); }
...
class Item_longlong_func : public Item_int_func
{
 public:
  ...
  Item_longlong_func(THD *thd, Item *a, Item *b, Item *c, Item *d) : Item_int_func(thd, a, b, c, d) {}
...
class Cursor_ref
{
 protected:
  ...
  Cursor_ref(const LEX_CSTRING *name, uint offset) : m_cursor_name(*name), m_cursor_offset(offset) {}
  void print_func(String *str, const LEX_CSTRING &func_name);
};

class Item_func_cursor_rowcount : public Item_longlong_func, public Cursor_ref
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_cursor_rowcount>(thd, this); }
};
...
class Item_func_connection_id : public Item_long_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_connection_id>(thd, this); }
};

class Item_func_signed : public Item_int_func
{
 public:
  Item_func_signed(THD *thd, Item *a) : Item_int_func(thd, a) { unsigned_flag = 0; }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  const Type_handler *type_handler() const override
  {
    return Type_handler::type_handler_long_or_longlong(max_char_length(), false);
  }
  longlong val_int() override
  {
  ...
  void fix_length_and_dec_double() { fix_char_length(MAX_BIGINT_WIDTH); }
  void fix_length_and_dec_generic()
  {
    uint32 char_length = MY_MIN(args[0]->max_char_length(), MY_INT64_NUM_DECIMAL_DIGITS);
    /*
  ...
  void fix_length_and_dec_string()
  {
    ...
    */
    uint32 char_length = MY_MIN(args[0]->decimal_int_part(), MY_INT64_NUM_DECIMAL_DIGITS);
    set_if_bigger(char_length, 1U + (unsigned_flag ? 0 : 1));
    fix_char_length(char_length);
  }
  bool fix_length_and_dec(THD *thd) override
  ...
  void print(String *str, enum_query_type query_type) override;
  decimal_digits_t decimal_precision() const override { return args[0]->decimal_precision(); }
  bool need_parentheses_in_default() override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_signed>(thd, this); }
};

class Item_func_unsigned : public Item_func_signed
{
 public:
  Item_func_unsigned(THD *thd, Item *a) : Item_func_signed(thd, a) { unsigned_flag = 1; }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_unsigned>(thd, this); }
};
...
class Item_decimal_typecast : public Item_func
{
 ...
 public:
  Item_decimal_typecast(THD *thd, Item *a, uint len, decimal_digits_t dec) : Item_func(thd, a)
  {
    decimals = dec;
    collation = DTCollation_numeric();
    fix_char_length(my_decimal_precision_to_length_no_truncation(len, dec, unsigned_flag));
  }
  ...
  bool fix_length_and_dec(THD *thd) override
  {
    return args[0]->type_handler()->Item_decimal_typecast_fix_length_and_dec(this);
  }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  void print(String *str, enum_query_type query_type) override;
  bool need_parentheses_in_default() override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_decimal_typecast>(thd, this); }
};
...
class Item_real_typecast : public Item_real_func
{
 ...
 public:
  Item_real_typecast(THD *thd, Item *a, uint len, uint dec) : Item_real_func(thd, a)
  {
    decimals = (uint8)dec;
  ...
  void fix_length_and_dec_generic() { set_maybe_null(); }
};

class Item_float_typecast : public Item_real_typecast
{
 public:
  Item_float_typecast(THD *thd, Item *a) : Item_real_typecast(thd, a, MAX_FLOAT_STR_LENGTH, NOT_FIXED_DEC) {}
  const Type_handler *type_handler() const override { return &type_handler_float; }
  bool fix_length_and_dec(THD *thd) override
  {
    return args[0]->type_handler()->Item_float_typecast_fix_length_and_dec(this);
  }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  double val_real() override { return (double)(float)val_real_with_truncate(FLT_MAX); }
  String *val_str(String *str) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_float_typecast>(thd, this); }
};

class Item_double_typecast : public Item_real_typecast
{
 public:
  Item_double_typecast(THD *thd, Item *a, uint len, uint dec) : Item_real_typecast(thd, a, len, dec) {}
  bool fix_length_and_dec(THD *thd) override
  {
    return args[0]->type_handler()->Item_double_typecast_fix_length_and_dec(this);
  }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_double_typecast>(thd, this); }
};
...
{
 public:
  Item_func_plus(THD *thd, Item *a, Item *b) : Item_func_additive_op(thd, a, b) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_plus>(thd, this); }
};
...
class Item_func_minus : public Item_func_additive_op
{
 ...
 public:
  Item_func_minus(THD *thd, Item *a, Item *b)
      : Item_func_additive_op(thd, a, b), m_depends_on_sql_mode_no_unsigned_subtraction(false)
  {
  }
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_minus>(thd, this); }
};

class Item_func_mul : public Item_num_op
{
 public:
  Item_func_mul(THD *thd, Item *a, Item *b) : Item_num_op(thd, a, b) {}
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("*")};
    return name;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_mul>(thd, this); }
};
...
class Item_func_div : public Item_num_op
{
 public:
  ...
  void fix_length_and_dec_int();
  void result_precision() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_div>(thd, this); }
};
...
class Item_func_int_div : public Item_int_func
{
 public:
  ...
  bool check_vcol_func_processor(void *arg) override { return FALSE; }
  bool need_parentheses_in_default() override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_int_div>(thd, this); }
};
...
class Item_func_mod : public Item_num_op
{
 public:
  ...
  bool check_partition_func_processor(void *int_arg) override { return FALSE; }
  bool check_vcol_func_processor(void *arg) override { return FALSE; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_mod>(thd, this); }
};
...
class Item_func_neg : public Item_func_num1
{
 public:
  ...
  decimal_digits_t decimal_precision() const override { return args[0]->decimal_precision(); }
  bool need_parentheses_in_default() override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_neg>(thd, this); }
};
...
class Item_func_abs : public Item_func_num1
{
 public:
  ...
  void fix_length_and_dec_decimal();
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_abs>(thd, this); }
};
...
{
  bool check_arguments() const override { return check_argument_types_can_return_real(0, arg_count); }
...
class Item_func_exp : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_exp>(thd, this); }
};
...
class Item_func_ln : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ln>(thd, this); }
};
...
class Item_func_log : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_log>(thd, this); }
};
...
class Item_func_log2 : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_log2>(thd, this); }
};
...
class Item_func_log10 : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_log10>(thd, this); }
};
...
class Item_func_sqrt : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sqrt>(thd, this); }
};
...
class Item_func_pow : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_pow>(thd, this); }
};
...
class Item_func_acos : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_acos>(thd, this); }
};
...
class Item_func_asin : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_asin>(thd, this); }
};
...
class Item_func_atan : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_atan>(thd, this); }
};
...
class Item_func_cos : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_cos>(thd, this); }
};
...
class Item_func_sin : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sin>(thd, this); }
};
...
class Item_func_tan : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_tan>(thd, this); }
};
...
class Item_func_cot : public Item_dec_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_cot>(thd, this); }
};
...
class Item_func_ceiling : public Item_func_int_val
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ceiling>(thd, this); }
};
...
class Item_func_floor : public Item_func_int_val
{
 public:
  ...
  bool date_op(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override;
  bool time_op(THD *thd, MYSQL_TIME *ltime) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_floor>(thd, this); }
};
...
class Item_func_round : public Item_func_hybrid_field_type
{
 ...
 public:
  ...
  void fix_arg_int(const Type_handler *preferred, const Type_std_attributes *preferred_attributes,
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_round>(thd, this); }
};
...
class Item_func_rand : public Item_real_func
{
  ...
  bool check_arguments() const override { return check_argument_types_can_return_int(0, arg_count); }
  void seed_random(Item *val);

 public:
  Item_func_rand(THD *thd, Item *a) : Item_real_func(thd, a), rand(0), first_eval(TRUE) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rand>(thd, this); }
};
...
class Item_func_rownum final : public Item_longlong_func
{
 ...
 public:
  ...
  void store_pointer_to_row_counter(ha_rows *row_counter) { accepted_rows = row_counter; }
};
...
{
  bool check_arguments() const override { return args[0]->check_type_can_return_real(func_name_cstring()); }
 ...
 public:
  ...
  longlong val_int() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sign>(thd, this); }
};
...
class Item_func_units : public Item_real_func
{
 ...
 public:
  Item_func_units(THD *thd, char *name_arg, Item *a, double mul_arg, double add_arg)
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_units>(thd, this); }
};
...
class Item_func_min_max : public Item_hybrid_func
{
 ...
 public:
  Item_func_min_max(THD *thd, List<Item> &list, int cmp_sign_arg) : Item_hybrid_func(thd, list), cmp_sign(cmp_sign_arg)
  {
  }
  ...
  {
    DBUG_ASSERT(fixed());
    return Item_func_min_max::type_handler()->Item_func_min_max_val_real(this);
  }
  longlong val_int() override
  {
    DBUG_ASSERT(fixed());
    return Item_func_min_max::type_handler()->Item_func_min_max_val_int(this);
  }
  String *val_str(String *str) override
  {
    DBUG_ASSERT(fixed());
    return Item_func_min_max::type_handler()->Item_func_min_max_val_str(this, str);
  }
  my_decimal *val_decimal(my_decimal *dec) override
  {
    DBUG_ASSERT(fixed());
    return Item_func_min_max::type_handler()->Item_func_min_max_val_decimal(this, dec);
  }
  bool get_date(THD *thd, MYSQL_TIME *res, date_mode_t fuzzydate) override
  {
    DBUG_ASSERT(fixed());
    return Item_func_min_max::type_handler()->Item_func_min_max_get_date(thd, this, res, fuzzydate);
  }
  bool val_native(THD *thd, Native *to) override;
...
class Item_func_min : public Item_func_min_max
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_min>(thd, this); }
};
...
class Item_func_max : public Item_func_min_max
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_max>(thd, this); }
};
...
{
 public:
  Item_func_rollup_const(THD *thd, Item *a) : Item_func(thd, a) { name = a->name; }
  ...
  bool val_native(THD *thd, Native *to) override { return val_native_from_item(thd, args[0], to); }
  my_decimal *val_decimal(my_decimal *dec) override { return val_decimal_from_item(args[0], dec); }
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_rollup_const>(thd, this); }
};

class Item_long_func_length : public Item_long_func
{
  bool check_arguments() const override { return args[0]->check_type_can_return_str(func_name_cstring()); }
...
class Item_func_octet_length : public Item_long_func_length
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_octet_length>(thd, this); }
};
...
class Item_func_bit_length : public Item_longlong_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_length>(thd, this); }
};
...
class Item_func_char_length : public Item_long_func_length
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_char_length>(thd, this); }
};
...
class Item_func_coercibility : public Item_long_func
{
 ...
 public:
  ...
  Item *propagate_equal_fields(THD *thd, const Context &ctx, COND_EQUAL *cond) override { return this; }
  bool const_item() const override { return true; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_coercibility>(thd, this); }
};
...
class Item_func_locate : public Item_long_func
{
 ...
 public:
  Item_func_locate(THD *thd, Item *a, Item *b) : Item_long_func(thd, a, b) {}
  Item_func_locate(THD *thd, Item *a, Item *b, Item *c) : Item_long_func(thd, a, b, c) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_locate>(thd, this); }
};
...
class Item_func_field : public Item_long_func
{
 ...
 public:
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_field>(thd, this); }
};

class Item_func_ascii : public Item_long_func
{
  bool check_arguments() const override { return check_argument_types_can_return_str(0, arg_count); }
  String value;
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ascii>(thd, this); }
};
...
class Item_func_ord : public Item_long_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_ord>(thd, this); }
};

class Item_func_find_in_set : public Item_long_func
{
  bool check_arguments() const override { return check_argument_types_can_return_str(0, 2); }
  String value, value2;
  uint enum_value;
  ulonglong enum_bit;
  DTCollation cmp_collation;
 ...
 public:
  Item_func_find_in_set(THD *thd, Item *a, Item *b) : Item_long_func(thd, a, b), enum_value(0) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_find_in_set>(thd, this); }
};
...
class Item_func_bit_operator : public Item_handled_func
{
 ...
 protected:
  ...
  {
    set_func_handler(args[0]->cmp_type() == INT_RESULT && args[1]->cmp_type() == INT_RESULT ? ha_int : ha_dec);
    return m_func_handler->fix_length_and_dec(this);
  }

 public:
  Item_func_bit_operator(THD *thd, Item *a) : Item_handled_func(thd, a) {}
  Item_func_bit_operator(THD *thd, Item *a, Item *b) : Item_handled_func(thd, a, b) {}
  void print(String *str, enum_query_type query_type) override { print_op(str, query_type); }
  bool need_parentheses_in_default() override { return true; }
};
...
{
 public:
  Item_func_bit_or(THD *thd, Item *a, Item *b) : Item_func_bit_operator(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("|")};
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_or>(thd, this); }
};

class Item_func_bit_and : public Item_func_bit_operator
{
 public:
  Item_func_bit_and(THD *thd, Item *a, Item *b) : Item_func_bit_operator(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("&")};
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_and>(thd, this); }
};

class Item_func_bit_count : public Item_handled_func
{
  bool check_arguments() const override { return args[0]->check_type_can_return_int(func_name_cstring()); }
 ...
 public:
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_count>(thd, this); }
};

class Item_func_shift_left : public Item_func_bit_operator
{
 public:
  Item_func_shift_left(THD *thd, Item *a, Item *b) : Item_func_bit_operator(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("<<")};
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_shift_left>(thd, this); }
};

class Item_func_shift_right : public Item_func_bit_operator
{
 public:
  Item_func_shift_right(THD *thd, Item *a, Item *b) : Item_func_bit_operator(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN(">>")};
  ...
  enum precedence precedence() const override { return SHIFT_PRECEDENCE; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_shift_right>(thd, this); }
};
...
class Item_func_bit_neg : public Item_func_bit_operator
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_neg>(thd, this); }
};
...
class Item_func_last_insert_id : public Item_longlong_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_last_insert_id>(thd, this); }
};
...
class Item_func_benchmark : public Item_long_func
{
  bool check_arguments() const override
  {
    return args[0]->check_type_can_return_int(func_name_cstring()) || args[1]->check_type_scalar(func_name_cstring());
  }

 public:
  Item_func_benchmark(THD *thd, Item *count_expr, Item *expr) : Item_long_func(thd, count_expr, expr) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_benchmark>(thd, this); }
};
...
class Item_func_sleep : public Item_long_func
{
 ...
 public:
  ...
  table_map used_tables() const override { return used_tables_cache | RAND_TABLE_BIT; }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sleep>(thd, this); }
};
...
class Item_udf_func : public Item_func
{
 ...
 public:
  Item_udf_func(THD *thd, udf_func *udf_arg) : Item_func(thd), udf(udf_arg) {}
  Item_udf_func(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_func(thd, list), udf(udf_arg) {}
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  void update_used_tables() override
  {
    /*
      ...
      const.
    */
    if ((used_tables_cache & ~PSEUDO_TABLE_BITS) && !(used_tables_cache & RAND_TABLE_BIT))
    {
...
{
 public:
  Item_func_udf_float(THD *thd, udf_func *udf_arg) : Item_udf_func(thd, udf_arg) {}
  Item_func_udf_float(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_func(thd, udf_arg, list) {}
  longlong val_int() override
  {
    DBUG_ASSERT(fixed());
    return Converter_double_to_longlong(Item_func_udf_float::val_real(), unsigned_flag).result();
  }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_udf_float>(thd, this); }
};

class Item_func_udf_int : public Item_udf_func
{
 public:
  Item_func_udf_int(THD *thd, udf_func *udf_arg) : Item_udf_func(thd, udf_arg) {}
  Item_func_udf_int(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_func(thd, udf_arg, list) {}
  longlong val_int() override;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_udf_int>(thd, this); }
};

class Item_func_udf_decimal : public Item_udf_func
{
 public:
  Item_func_udf_decimal(THD *thd, udf_func *udf_arg) : Item_udf_func(thd, udf_arg) {}
  Item_func_udf_decimal(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_func(thd, udf_arg, list) {}
  longlong val_int() override { return VDec_udf(this, &udf).to_longlong(unsigned_flag); }
  double val_real() override { return VDec_udf(this, &udf).to_double(); }
  my_decimal *val_decimal(my_decimal *) override;
  String *val_str(String *str) override { return VDec_udf(this, &udf).to_string_round(str, decimals); }
  const Type_handler *type_handler() const override { return &type_handler_newdecimal; }
  bool fix_length_and_dec(THD *thd) override
  {
    fix_num_length_and_dec();
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_udf_decimal>(thd, this); }
};

class Item_func_udf_str : public Item_udf_func
{
 public:
  Item_func_udf_str(THD *thd, udf_func *udf_arg) : Item_udf_func(thd, udf_arg) {}
  Item_func_udf_str(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_udf_func(thd, udf_arg, list) {}
  ...
  double val_real() override
  {
    ...
    return res ? res->charset()->strntod((char *)res->ptr(), res->length(), &end_not_used, &err_not_used) : 0.0;
  }
  longlong val_int() override
  {
    int err_not_used;
    String *res;
    res = val_str(&str_value);
    return res ? res->charset()->strntoll(res->ptr(), res->length(), 10, (char **)0, &err_not_used) : (longlong)0;
  }
  my_decimal *val_decimal(my_decimal *dec_buf) override
  {
  ...
  bool fix_length_and_dec(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_udf_str>(thd, this); }
};
...
{
 public:
  Item_func_udf_float(THD *thd, udf_func *udf_arg) : Item_real_func(thd) {}
  Item_func_udf_float(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_real_func(thd, list) {}
  double val_real()
  {
    DBUG_ASSERT(fixed());
    return 0.0;
...
{
 public:
  Item_func_udf_int(THD *thd, udf_func *udf_arg) : Item_int_func(thd) {}
  Item_func_udf_int(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_int_func(thd, list) {}
...
{
 public:
  Item_func_udf_decimal(THD *thd, udf_func *udf_arg) : Item_int_func(thd) {}
  Item_func_udf_decimal(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_int_func(thd, list) {}
  const Type_handler *type_handler() const override { return &type_handler_slonglong; }
...
{
 public:
  Item_func_udf_str(THD *thd, udf_func *udf_arg) : Item_func(thd) {}
  Item_func_udf_str(THD *thd, udf_func *udf_arg, List<Item> &list) : Item_func(thd, list) {}
...
class Item_func_get_lock final : public Item_func_lock
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) final { return get_item_copy<Item_func_get_lock>(thd, this); }
};

class Item_func_release_all_locks final : public Item_func_lock
{
 public:
  Item_func_release_all_locks(THD *thd) : Item_func_lock(thd) { unsigned_flag = 1; }
  longlong val_int() final;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) final { return get_item_copy<Item_func_release_all_locks>(thd, this); }
};

class Item_func_release_lock final : public Item_func_lock
{
  bool check_arguments() const override { return args[0]->check_type_general_purpose_string(func_name_cstring()); }
  String value;
 ...
 public:
  ...
  Item *get_copy(THD *thd) final { return get_item_copy<Item_func_release_lock>(thd, this); }
};
...
class Item_master_pos_wait : public Item_longlong_func
{
 ...
 public:
  Item_master_pos_wait(THD *thd, Item *a, Item *b) : Item_longlong_func(thd, a, b) {}
  Item_master_pos_wait(THD *thd, Item *a, Item *b, Item *c) : Item_longlong_func(thd, a, b, c) {}
  Item_master_pos_wait(THD *thd, Item *a, Item *b, Item *c, Item *d) : Item_longlong_func(thd, a, b, c, d) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_master_pos_wait>(thd, this); }
};
...
class Item_master_gtid_wait : public Item_long_func
{
 ...
 public:
  Item_master_gtid_wait(THD *thd, Item *a) : Item_long_func(thd, a) {}
  Item_master_gtid_wait(THD *thd, Item *a, Item *b) : Item_long_func(thd, a, b) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_master_gtid_wait>(thd, this); }
};
...
class Item_func_user_var : public Item_hybrid_func
{
 ...
 public:
  ...
  Item_func_user_var(THD *thd, const LEX_CSTRING *a) : Item_hybrid_func(thd), m_var_entry(NULL), name(*a) {}
  Item_func_user_var(THD *thd, const LEX_CSTRING *a, Item *b) : Item_hybrid_func(thd, b), m_var_entry(NULL), name(*a) {}
  Item_func_user_var(THD *thd, Item_func_user_var *item)
      : Item_hybrid_func(thd, item), m_var_entry(item->m_var_entry), name(item->name)
  {
  }
  Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param)
  {
    DBUG_ASSERT(fixed());
    return create_tmp_field_ex_from_handler(root, table, src, param, type_handler());
  }
...
class Item_func_set_user_var : public Item_func_user_var
{
 ...
 public:
  Item_func_set_user_var(THD *thd, const LEX_CSTRING *a, Item *b) : Item_func_user_var(thd, a, b), entry_thread_id(0) {}
  ...
  bool update_hash(void *ptr, size_t length, enum Item_result type, CHARSET_INFO *cs, bool unsigned_arg);
  ...
  int save_in_field(Field *field, bool no_conversions, bool can_use_result_field);
  int save_in_field(Field *field, bool no_conversions) override { return save_in_field(field, no_conversions, 1); }
  void save_org_in_field(Field *field, fast_field_copier data __attribute__((__unused__))) override
  {
  ...
  void cleanup() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_set_user_var>(thd, this); }
  bool excl_dep_on_table(table_map tab_map) override { return false; }
};

class Item_func_get_user_var : public Item_func_user_var, private Settable_routine_parameter
{
 public:
  Item_func_get_user_var(THD *thd, const LEX_CSTRING *a) : Item_func_user_var(thd, a) {}
  ...
  */
  ...
  table_map used_tables() const override { return const_item() ? 0 : RAND_TABLE_BIT; }
  bool eq(const Item *item, bool binary_cmp) const override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_get_user_var>(thd, this); }
...
*/
class Item_user_var_as_out_param : public Item_fixed_hybrid, public Load_data_outvar
{
  LEX_CSTRING org_name;
  user_var_entry *entry;

 public:
  Item_user_var_as_out_param(THD *thd, const LEX_CSTRING *a) : Item_fixed_hybrid(thd)
  {
  ...
  bool load_data_add_outvar(THD *thd, Load_data_param *param) const override { return param->add_outvar_user_var(thd); }
  uint load_data_fixed_length() const override { return 0; }
  ...
  const Type_handler *type_handler() const override { return &type_handler_double; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_user_var_as_out_param>(thd, this); }
};
...
class Item_func_get_system_var : public Item_func
{
 ...
 public:
  Item_func_get_system_var(THD *thd, sys_var *var_arg, enum_var_type var_type_arg, LEX_CSTRING *component_arg,
  ...
  longlong val_int() override;
  String *val_str(String *) override;
  my_decimal *val_decimal(my_decimal *dec_buf) override { return val_decimal_from_real(dec_buf); }
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
    return type_handler()->Item_get_date_with_warn(thd, this, ltime, fuzzydate);
  }
  ...
  */
  ...
  void cleanup() override;
  bool check_vcol_func_processor(void *arg) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_get_system_var>(thd, this); }
};
...
class Item_func_match : public Item_real_func
{
 public:
  ...
  Item_func_match(THD *thd, List<Item> &a, uint b)
      : Item_real_func(thd, a), key(0), match_flags(b), join_key(0), ft_handler(0), table(0), master(0), concat_ws(0)
  {
  }
  void cleanup() override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_match>(thd, this); }
...
{
 public:
  Item_func_bit_xor(THD *thd, Item *a, Item *b) : Item_func_bit_operator(thd, a, b) {}
  bool fix_length_and_dec(THD *thd) override;
  LEX_CSTRING func_name_cstring() const override
  {
    static LEX_CSTRING name = {STRING_WITH_LEN("^")};
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_bit_xor>(thd, this); }
};
...
class Item_func_is_free_lock : public Item_long_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_is_free_lock>(thd, this); }
};
...
class Item_func_is_used_lock : public Item_long_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_is_used_lock>(thd, this); }
};
...
struct Lex_cast_type_st : public Lex_length_and_dec_st
{
 ...
 public:
  void set(const Type_handler *handler, Lex_length_and_dec_st length_and_dec, CHARSET_INFO *cs = NULL)
  {
    m_type_handler = handler;
    m_charset = cs;
    Lex_length_and_dec_st::operator=(length_and_dec);
  }
  bool set(const Type_handler *handler, const Lex_length_and_dec_st &length_and_dec,
           const Lex_column_charset_collation_attrs_st &cscl, CHARSET_INFO *defcs)
  {
  ...
  {
    return m_type_handler->create_typecast_item(thd, item, Type_cast_attributes(*this, m_charset));
  }
...
class Item_func_row_count : public Item_longlong_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_row_count>(thd, this); }
};
...
class Item_func_sp : public Item_func, public Item_sp
{
 private:
 ...
 public:
  Item_func_sp(THD *thd, Name_resolution_context *context_arg, sp_name *name, const Sp_handler *sph);

  Item_func_sp(THD *thd, Name_resolution_context *context_arg, sp_name *name, const Sp_handler *sph, List<Item> &list);
  ...
  Field *create_field_for_create_select(MEM_ROOT *root, TABLE *table) override
  {
    return result_type() != STRING_RESULT ? sp_result_field : create_table_field_from_handler(root, table);
  }
  void make_send_field(THD *thd, Send_field *tmp_field) override;
  ...
  void update_null_value() override { execute(); }
  ...
  const sp_name *get_sp_name() const { return m_name; }

  bool check_vcol_func_processor(void *arg) override;
  bool limit_index_condition_pushdown_processor(void *opt_arg) override { return TRUE; }
...
class Item_func_found_rows : public Item_longlong_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_found_rows>(thd, this); }
};
...
class Item_func_oracle_sql_rowcount : public Item_longlong_func
{
 public:
  ...
  void print(String *str, enum_query_type query_type) override { str->append(func_name_cstring()); }
  bool check_vcol_func_processor(void *arg) override
  {
    return mark_unsupported_function(func_name(), "()", arg, VCOL_IMPOSSIBLE);
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_oracle_sql_rowcount>(thd, this); }
};
...
class Item_func_sqlcode : public Item_long_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_sqlcode>(thd, this); }
};
...
class Item_func_uuid_short : public Item_longlong_func
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_uuid_short>(thd, this); }
};
...
class Item_func_last_value : public Item_func
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_last_value>(thd, this); }
};
...
class Item_func_nextval : public Item_longlong_func
{
 ...
 public:
  Item_func_nextval(THD *thd, TABLE_LIST *table_list_arg) : Item_longlong_func(thd), table_list(table_list_arg) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  */
  ...
  bool const_item() const override { return 0; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_nextval>(thd, this); }
  void print(String *str, enum_query_type query_type) override;
  bool check_vcol_func_processor(void *arg) override
  {
    return mark_unsupported_function(func_name(), "()", arg, (VCOL_NON_DETERMINISTIC | VCOL_NOT_VIRTUAL));
  }
};
...
{
 public:
  Item_func_lastval(THD *thd, TABLE_LIST *table_list_arg) : Item_func_nextval(thd, table_list_arg) {}
  longlong val_int() override;
  LEX_CSTRING func_name_cstring() const override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_lastval>(thd, this); }
};
...
class Item_func_setval : public Item_func_nextval
{
 ...
 public:
  Item_func_setval(THD *thd, TABLE_LIST *table_list_arg, longlong nextval_arg, ulonglong round_arg, bool is_used_arg)
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_func_setval>(thd, this); }
};

Item *get_system_var(THD *thd, enum_var_type var_type, const LEX_CSTRING *name, const LEX_CSTRING *component);
...
bool update_hash(user_var_entry *entry, bool set_null, void *ptr, size_t length, Item_result type, CHARSET_INFO *cs,
                 bool unsigned_arg);
