...
#define MAX_KEY_LENGTH (MAX_DATA_LENGTH_FOR_KEY + (MAX_REF_PARTS * (HA_KEY_NULL_LENGTH + HA_KEY_BLOB_LENGTH)))
...
#define ALTER_ADD_COLUMN (ALTER_ADD_VIRTUAL_COLUMN | ALTER_ADD_STORED_BASE_COLUMN | ALTER_ADD_STORED_GENERATED_COLUMN)
#define ALTER_DROP_COLUMN (ALTER_DROP_VIRTUAL_COLUMN | ALTER_DROP_STORED_COLUMN)
...
struct xid_t
{
  ...
  bool eq(struct xid_t *xid) const { return !xid->is_null() && eq(xid->gtrid_length, xid->bqual_length, xid->data); }
  ...
  uint length() { return static_cast<uint>(sizeof(formatID)) + key_length(); }
  uchar *key() const { return (uchar *)&gtrid_length; }
  uint key_length() const
  {
    return static_cast<uint>(sizeof(gtrid_length) + sizeof(bqual_length) + gtrid_length + bqual_length);
  }
};
...
struct xid_recovery_member
{
  ...
  */
  ...
  xid_recovery_member(my_xid xid_arg, uint prepare_arg, bool decided_arg, XID *full_xid_arg,
                      decltype(::server_id) server_id_arg)
      : xid(xid_arg),
        in_engine_prepare(prepare_arg),
...
typedef bool(stat_print_fn)(THD *thd, const char *type, size_t type_len, const char *file, size_t file_len,
...
enum ha_option_type
{
  HA_OPTION_TYPE_ULL,    /* unsigned long long */
...
#define HA_xOPTION_NUMBER(name, struc, field, def, min, max, blk_siz)                                \
  {                                                                                                  \
    HA_OPTION_TYPE_ULL, name, sizeof(name) - 1, offsetof(struc, field), def, min, max, blk_siz, 0, 0 \
  }
#define HA_xOPTION_STRING(name, struc, field)                                               \
  {                                                                                         \
    HA_OPTION_TYPE_STRING, name, sizeof(name) - 1, offsetof(struc, field), 0, 0, 0, 0, 0, 0 \
  }
#define HA_xOPTION_ENUM(name, struc, field, values, def)                                                          \
  {                                                                                                               \
    HA_OPTION_TYPE_ENUM, name, sizeof(name) - 1, offsetof(struc, field), def, 0, sizeof(values) - 1, 0, values, 0 \
  }
#define HA_xOPTION_BOOL(name, struc, field, def)                                            \
  {                                                                                         \
    HA_OPTION_TYPE_BOOL, name, sizeof(name) - 1, offsetof(struc, field), def, 0, 1, 0, 0, 0 \
  }
#define HA_xOPTION_SYSVAR(name, struc, field, sysvar)                                                          \
  {                                                                                                            \
    HA_OPTION_TYPE_SYSVAR, name, sizeof(name) - 1, offsetof(struc, field), 0, 0, 0, 0, 0, MYSQL_SYSVAR(sysvar) \
  }
#define HA_xOPTION_END                            \
  {                                               \
...
#define HA_TOPTION_STRING(name, field) HA_xOPTION_STRING(name, ha_table_option_struct, field)
#define HA_TOPTION_ENUM(name, field, values, def) HA_xOPTION_ENUM(name, ha_table_option_struct, field, values, def)
#define HA_TOPTION_BOOL(name, field, def) HA_xOPTION_BOOL(name, ha_table_option_struct, field, def)
#define HA_TOPTION_SYSVAR(name, field, sysvar) HA_xOPTION_SYSVAR(name, ha_table_option_struct, field, sysvar)
...
#define HA_FOPTION_STRING(name, field) HA_xOPTION_STRING(name, ha_field_option_struct, field)
#define HA_FOPTION_ENUM(name, field, values, def) HA_xOPTION_ENUM(name, ha_field_option_struct, field, values, def)
#define HA_FOPTION_BOOL(name, field, def) HA_xOPTION_BOOL(name, ha_field_option_struct, field, def)
#define HA_FOPTION_SYSVAR(name, field, sysvar) HA_xOPTION_SYSVAR(name, ha_field_option_struct, field, sysvar)
...
#define HA_IOPTION_STRING(name, field) HA_xOPTION_STRING(name, ha_index_option_struct, field)
#define HA_IOPTION_ENUM(name, field, values, def) HA_xOPTION_ENUM(name, ha_index_option_struct, field, values, def)
#define HA_IOPTION_BOOL(name, field, def) HA_xOPTION_BOOL(name, ha_index_option_struct, field, def)
#define HA_IOPTION_SYSVAR(name, field, sysvar) HA_xOPTION_SYSVAR(name, ha_index_option_struct, field, sysvar)
...
struct handlerton
{
  ...
  */
  ...
  void (*binlog_log_query)(handlerton *hton, THD *thd, enum_binlog_command binlog_command, const char *query,
                           uint query_length, const char *db, const char *table_name);

  void (*abort_transaction)(handlerton *hton, THD *bf_thd, THD *victim_thd, my_bool signal);
   ...
   */
  int (*check_version)(handlerton *hton, const char *path, const LEX_CUSTRING *version, ulonglong create_id);
  ...
  */
  int (*discover_table_names)(handlerton *hton, LEX_CSTRING *db, MY_DIR *dir, discovered_list *result);
  ...
  */
  int (*discover_table_existence)(handlerton *hton, const char *db, const char *table_name);
  ...
  */
  int (*discover_table_structure)(handlerton *hton, THD *thd, TABLE_SHARE *share, HA_CREATE_INFO *info);

  /*
    Notify the storage engine that the definition of the table (and the .frm
    file) has changed. Returns 0 if ok.
  */
  int (*notify_tabledef_changed)(handlerton *hton, LEX_CSTRING *db, LEX_CSTRING *table_name, LEX_CUSTRING *frm,
                                 LEX_CUSTRING *org_tabledef_version, handler *file);
  ...
  */
  ...
  /*
    ...
    files
  */
  int (*create_partitioning_metadata)(const char *path, const char *old_path, chf_create_flags action_flag);
};

extern const char *hton_no_exts[];

static inline LEX_CSTRING *hton_name(const handlerton *hton) { return &(hton2plugin[hton->slot]->name); }

static inline handlerton *plugin_hton(plugin_ref plugin) { return plugin_data(plugin, handlerton *); }
...
struct THD_TRANS
{
  ...
  */
  ...
  void mark_modified_non_trans_temp_table() { m_unsafe_rollback_flags |= MODIFIED_NON_TRANS_TABLE; }
  bool has_modified_non_trans_temp_table() const { return (m_unsafe_rollback_flags & MODIFIED_NON_TRANS_TABLE) != 0; }
  ...
  bool trans_executed_admin_cmd() { return (m_unsafe_rollback_flags & EXECUTED_TABLE_ADMIN_CMD) != 0; }
  ...
  {
    return (m_unsafe_rollback_flags & (CREATED_TEMP_TABLE | DROPPED_TEMP_TABLE)) != 0;
  }
  void mark_trans_did_wait() { m_unsafe_rollback_flags |= DID_WAIT; }
  bool trans_did_wait() const { return (m_unsafe_rollback_flags & DID_WAIT) != 0; }
  bool is_trx_read_write() const;
  void mark_trans_did_ddl() { m_unsafe_rollback_flags |= DID_DDL; }
  bool trans_did_ddl() const { return (m_unsafe_rollback_flags & DID_DDL) != 0; }
};
...
{
  Table_period_info() : create_if_not_exists(false), constr(NULL), unique_keys(0) {}
  Table_period_info(const char *name_arg, size_t size)
      : name(name_arg, size), create_if_not_exists(false), constr(NULL), unique_keys(0)
  {
  }
  ...
  {
    start_end_t(){};
    start_end_t(const LEX_CSTRING &_start, const LEX_CSTRING &_end) : start(_start), end(_end) {}
    Lex_ident start;
    Lex_ident end;
  };
  start_end_t period;
...
{
  Vers_parse_info()
      : Table_period_info(STRING_WITH_LEN("SYSTEM_TIME")), versioned_fields(false), unversioned_fields(false)
  {
  }
 ...
 protected:
  ...
  operator bool() const { return as_row.start || as_row.end || period.start || period.end; }
  bool need_check(const Alter_info *alter_info) const;
  bool check_conditions(const Lex_table_name &table_name, const Lex_table_name &db) const;

 public:
  static const Lex_ident default_start;
  static const Lex_ident default_end;

  bool fix_alter_info(THD *thd, Alter_info *alter_info, HA_CREATE_INFO *create_info, TABLE *table);
  bool fix_create_like(Alter_info &alter_info, HA_CREATE_INFO &create_info, TABLE_LIST &src_table, TABLE_LIST &table);
  bool check_sys_fields(const Lex_table_name &table_name, const Lex_table_name &db, Alter_info *alter_info) const;
...
struct Table_scope_and_contents_source_pod_st  // For trivial members
{
  ...
  */
  ...
  {
    db_type = tmp_table() ? ha_default_tmp_handlerton(thd) : ha_default_handlerton(thd);
  }

  bool versioned() const { return options & HA_VERSIONED_TABLE; }
};

struct Table_scope_and_contents_source_st : public Table_scope_and_contents_source_pod_st
{
  ...
  bool fix_create_fields(THD *thd, Alter_info *alter_info, const TABLE_LIST &create_table);
  bool fix_period_fields(THD *thd, Alter_info *alter_info);
  bool check_fields(THD *thd, Alter_info *alter_info, const Lex_table_name &table_name, const Lex_table_name &db,
                    int select_count = 0);
  bool check_period_fields(THD *thd, Alter_info *alter_info);

  bool vers_fix_system_fields(THD *thd, Alter_info *alter_info, const TABLE_LIST &create_table);

  bool vers_check_system_fields(THD *thd, Alter_info *alter_info, const Lex_table_name &table_name,
                                const Lex_table_name &db, int select_count = 0);
};
...
*/
struct HA_CREATE_INFO : public Table_scope_and_contents_source_st, public Schema_specification_st
{
  ...
  bool resolve_to_charset_collation_context(THD *thd, const Lex_table_charset_collation_attrs_st &default_cscl,
...
*/
struct Table_specification_st : public HA_CREATE_INFO, public DDL_options_st
{
  ...
  */
  ...
  bool add_table_option_convert_charset(CHARSET_INFO *cs)
  {
    ...
    return cs ? convert_charset_collation.merge_exact_charset(Lex_exact_charset(cs))
  ...
  bool add_table_option_default_charset(CHARSET_INFO *cs)
  {
    ...
    return cs ? default_charset_collation.merge_exact_charset(Lex_exact_charset(cs))
  ...
  bool resolve_to_charset_collation_context(THD *thd, const Charset_collation_context &ctx)
  {
    return HA_CREATE_INFO::resolve_to_charset_collation_context(thd, default_charset_collation,
                                                                convert_charset_collation, ctx);
  }
};
...
class Alter_inplace_info
{
  ...
  */
  ...
  {
    Rename_key_pair(const KEY *old_key, const KEY *new_key) : old_key(old_key), new_key(new_key) {}
    const KEY *old_key;
    const KEY *new_key;
  };
  /**
  ...
  */
  ...
  Alter_inplace_info(HA_CREATE_INFO *create_info_arg, Alter_info *alter_info_arg, KEY *key_info_arg, uint key_count_arg,
                     partition_info *modified_part_info_arg, bool ignore_arg, bool error_non_empty);

  ~Alter_inplace_info() { delete handler_ctx; }
  ...
  */
  void report_unsupported_error(const char *not_supported, const char *try_instead) const;
  void add_altered_index_ignorability(KEY *old_key, KEY *new_key)
  {
    KEY_PAIR *key_pair = index_altered_ignorability_buffer + index_altered_ignorability_count++;
    key_pair->old_key = old_key;
    key_pair->new_key = new_key;
    DBUG_PRINT("info", ("index had ignorability altered: %i to %i", old_key->is_ignored, new_key->is_ignored));
  }
};
...
class Cost_estimate
{
 public:
  ...
  {
    return IO_COEFF * io_count * avg_io_cost + IO_COEFF * idx_io_count * idx_avg_io_cost +
           CPU_COEFF * (cpu_cost + idx_cpu_cost) + MEM_COEFF * mem_cost + IMPORT_COEFF * import_cost;
  }

  double index_only_cost() { return IO_COEFF * idx_io_count * idx_avg_io_cost + CPU_COEFF * idx_cpu_cost; }
  ...
  */
  bool is_zero() const
  {
    return io_count == 0.0 && idx_io_count == 0.0 && cpu_cost == 0.0 && import_cost == 0.0 && mem_cost == 0.0;
  }
  ...
  void add(const Cost_estimate *cost)
  {
    if (cost->io_count != 0.0)
    {
      ...
      avg_io_cost = (io_count * avg_io_cost + cost->io_count * cost->avg_io_cost) / io_count_sum;
    ...
    if (cost->idx_io_count != 0.0)
    {
      ...
      idx_avg_io_cost =
          (idx_io_count * idx_avg_io_cost + cost->idx_io_count * cost->idx_avg_io_cost) / idx_io_count_sum;
  ...
  void add_io(double add_io_cnt, double add_avg_cost)
  {
    ...
    if (add_io_cnt > 0)
    {
      ...
      avg_io_cost = (io_count * avg_io_cost + add_io_cnt * add_avg_cost) / io_count_sum;
      io_count = io_count_sum;
    }
  }
...
#define HA_MRR_IMPLEMENTATION_FLAGS (512U | 1024U | 2048U | 4096U | 8192U | 16384U)
...
class handler : public Sql_alloc
{
 ...
 public:
  handler(handlerton *ht_arg, TABLE_SHARE *share_arg)
      : table_share(share_arg),
        ...
        ha_share(NULL)
  {
    DBUG_PRINT("info", ("handler created F_UNLCK %d F_RDLCK %d F_WRLCK %d", F_UNLCK, F_RDLCK, F_WRLCK));
    reset_statistics();
  }
  ...
  virtual int prepare_index_key_scan(const uchar *key, uint key_len) { return 0; }
  ...
  */
  ...
  int ha_bulk_update_row(const uchar *old_data, const uchar *new_data, ha_rows *dup_key_found);
  ...
  int ha_create_partitioning_metadata(const char *name, const char *old_name, chf_create_flags action_flag);

  int ha_change_partitions(HA_CREATE_INFO *create_info, const char *path, ulonglong *const copied,
  ...
  */
  virtual bool get_foreign_dup_key(char *child_table_name, uint child_table_name_len, char *child_key_name,
  ...
  {
    return ((ulonglong2double(stats.data_file_length) / stats.block_size + 2) * avg_io_cost());
  }

  virtual double key_scan_time(uint index) { return keyread_time(index, 1, records()); }

  virtual double avg_io_cost() { return 1.0; }
  ...
  */
  bool has_transactions() { return ((ha_table_flags() & (HA_NO_TRANSACTIONS | HA_PERSISTENT_TABLE)) == 0); }
  /*
    ...
    rolled back.
  */
  bool has_transactions_and_rollback() { return has_transactions() && has_rollback(); }
  /*
    True if the underlaying table support transactions and rollback
  */
  bool has_transaction_manager() { return ((ha_table_flags() & HA_NO_TRANSACTIONS) == 0 && has_rollback()); }
  ...
  */
  ...
  bool has_rollback() { return ((ht->flags & HTON_NO_ROLLBACK) == 0); }
  ...
  */
  ...
  {
    if (!error ||
        ((flags & HA_CHECK_DUP_KEY) && (error == HA_ERR_FOUND_DUPP_KEY || error == HA_ERR_FOUND_DUPP_UNIQUE)) ||
        error == HA_ERR_AUTOINC_ERANGE ||
        ((flags & HA_CHECK_FK_ERROR) && (error == HA_ERR_ROW_IS_REFERENCED || error == HA_ERR_NO_REFERENCED_ROW)))
      return FALSE;
    return TRUE;
  }
  ...
  */
  uint get_index(void) const { return inited == INDEX ? active_index : MAX_KEY; }
  int ha_close(void);
  ...
  */
  ...
  virtual int pre_index_read_map(const uchar *key, key_part_map keypart_map, enum ha_rkey_function find_flag,
                                 bool use_parallel)
  {
    return 0;
  }
  virtual int pre_index_first(bool use_parallel) { return 0; }
  virtual int pre_index_last(bool use_parallel) { return 0; }
  ...
  /*
    virtual int pre_read_multi_range_first(KEY_MULTI_RANGE **found_range_p,
                                           ...
                                           bool use_parallel);
  */
  virtual int pre_multi_range_read_next(bool use_parallel) { return 0; }
  virtual int pre_read_range_first(const key_range *start_key, const key_range *end_key, bool eq_range, bool sorted,
                                   bool use_parallel)
  {
    return 0;
  }
  ...
  {
    return (pre_inited == INDEX ? ha_pre_index_end() : pre_inited == RND ? ha_pre_rnd_end() : 0);
  }
  virtual bool vers_can_native(THD *thd) { return ht->flags & HTON_NATIVE_SYS_VERSIONING; }
 ...
 public:
  ...
  int ha_index_read_idx_map(uchar *buf, uint index, const uchar *key, key_part_map keypart_map,
                            enum ha_rkey_function find_flag);
  ...
  /*
    ...
    too?
  */
  virtual ha_rows multi_range_read_info_const(uint keyno, RANGE_SEQ_IF *seq, void *seq_init_param, uint n_ranges,
                                              uint *bufsz, uint *mrr_mode, Cost_estimate *cost);
  virtual ha_rows multi_range_read_info(uint keyno, uint n_ranges, uint keys, uint key_parts, uint *bufsz,
                                        uint *mrr_mode, Cost_estimate *cost);
  virtual int multi_range_read_init(RANGE_SEQ_IF *seq, void *seq_init_param, uint n_ranges, uint mrr_mode,
                                    HANDLER_BUFFER *buf);
  ...
  */
  virtual int multi_range_read_explain_info(uint mrr_mode, char *str, size_t size) { return 0; }
  ...
  */
  virtual int remember_rnd_pos() { return HA_ERR_WRONG_COMMAND; }
  virtual int restart_rnd_next(uchar *buf) { return HA_ERR_WRONG_COMMAND; }

  virtual ha_rows records_in_range(uint inx, const key_range *min_key, const key_range *max_key, page_range *res)
  {
    return (ha_rows)10;
  }
  /*
  ...
  */
  ...
  virtual int change_partitions_to_open(List<String> *partition_names) { return 0; }
  virtual int extra(enum ha_extra_function operation) { return 0; }
  virtual int extra_opt(enum ha_extra_function operation, ulong arg) { return extra(operation); }
  /*
  ...
  */
  ...
  virtual void get_auto_increment(ulonglong offset, ulonglong increment, ulonglong nb_desired_values,
  ...
  virtual void restore_auto_increment(ulonglong prev_insert_id)
  {
    ...
    */
    next_insert_id = (prev_insert_id > 0) ? prev_insert_id : insert_id_for_cur_row;
  }
  ...
  */
  ...
  /**
    ...
    @return The handler error code or zero for success.
  */
  virtual int get_parent_foreign_key_list(THD *thd, List<FOREIGN_KEY_INFO> *f_key_list) { return 0; }
  ...
  virtual int get_default_no_partitions(HA_CREATE_INFO *create_info) { return 1; }
  ...
  uint max_record_length() const { return MY_MIN(HA_MAX_REC_LENGTH, max_supported_record_length()); }
  uint max_keys() const { return MY_MIN(MAX_KEY, max_supported_keys()); }
  uint max_key_parts() const { return MY_MIN(MAX_REF_PARTS, max_supported_key_parts()); }
  uint max_key_length() const { return MY_MIN(MAX_DATA_LENGTH_FOR_KEY, max_supported_key_length()); }
  uint max_key_part_length() const { return MY_MIN(MAX_DATA_LENGTH_FOR_KEY, max_supported_key_part_length()); }
  ...
  */
  ...
  virtual my_bool register_query_cache_table(THD *thd, const char *table_key, uint key_length,
  ...
  */
  ...
  virtual uint count_query_cache_dependant_tables(uint8 *tables_type __attribute__((unused))) { return 0; }
  ...
  */
  ...
  virtual my_bool register_query_cache_dependant_tables(THD *thd __attribute__((unused)),
                                                        Query_cache *cache __attribute__((unused)),
                                                        Query_cache_block_table **block __attribute__((unused)),
  ...
  */
  ...
  virtual int cmp_ref(const uchar *ref1, const uchar *ref2) { return memcmp(ref1, ref2, ref_length); }
  ...
  */
  ...
  {
    DBUG_ASSERT(pushed_rowid_filter != NULL && save_pushed_rowid_filter == NULL);
  ...
  {
    DBUG_ASSERT(save_pushed_rowid_filter != NULL && pushed_rowid_filter == NULL);
  ...
  */
  ...
  /**
     ...
     @note Called without holding thr_lock.c lock.
  */
  virtual enum_alter_inplace_result check_if_supported_inplace_alter(TABLE *altered_table,
  ...
  */
  virtual bool prepare_inplace_alter_table(TABLE *altered_table, Alter_inplace_info *ha_alter_info) { return false; }
  ...
  /**
     ...
     @retval   false             Success
  */
  virtual bool inplace_alter_table(TABLE *altered_table, Alter_inplace_info *ha_alter_info) { return false; }
  ...
  */
  ...
  inline void clear_cached_table_binlog_row_based_flag() { check_table_binlog_row_based_done = 0; }
  ...
  */
  ...
  virtual int write_row(const uchar *buf __attribute__((unused))) { return HA_ERR_WRONG_COMMAND; }
  ...
  */
  virtual int update_row(const uchar *old_data __attribute__((unused)), const uchar *new_data __attribute__((unused)))
  {
    return HA_ERR_WRONG_COMMAND;
  }
  ...
  */
  ...
  virtual int delete_row(const uchar *buf __attribute__((unused))) { return HA_ERR_WRONG_COMMAND; }

  /* Perform initialization for a direct update request */
 public:
  int ha_direct_update_rows(ha_rows *update_rows, ha_rows *found_rows);
  virtual int direct_update_rows_init(List<Item> *update_fields) { return HA_ERR_WRONG_COMMAND; }

 private:
  virtual int pre_direct_update_rows_init(List<Item> *update_fields) { return HA_ERR_WRONG_COMMAND; }
  virtual int direct_update_rows(ha_rows *update_rows __attribute__((unused)),
                                 ha_rows *found_rows __attribute__((unused)))
  {
    return HA_ERR_WRONG_COMMAND;
  }
  virtual int pre_direct_update_rows() { return HA_ERR_WRONG_COMMAND; }

  /* Perform initialization for a direct delete request */
 public:
  int ha_direct_delete_rows(ha_rows *delete_rows);
  virtual int direct_delete_rows_init() { return HA_ERR_WRONG_COMMAND; }

 private:
  virtual int pre_direct_delete_rows_init() { return HA_ERR_WRONG_COMMAND; }
  virtual int direct_delete_rows(ha_rows *delete_rows __attribute__((unused))) { return HA_ERR_WRONG_COMMAND; }
  virtual int pre_direct_delete_rows() { return HA_ERR_WRONG_COMMAND; }
  ...
  */
  virtual int external_lock(THD *thd __attribute__((unused)), int lock_type __attribute__((unused))) { return 0; }
 ...
 public:
  /**
    ...
    @retval  1   Bulk delete not used, normal operation used
  */
  virtual int bulk_update_row(const uchar *old_data, const uchar *new_data, ha_rows *dup_key_found)
  {
    DBUG_ASSERT(FALSE);
    return HA_ERR_WRONG_COMMAND;
  }
  ...
  */
  virtual int reset_auto_increment(ulonglong value) { return 0; }
  ...
  virtual int create_partitioning_metadata(const char *name, const char *old_name, chf_create_flags action_flag)
  {
    return FALSE;
  }

  virtual int change_partitions(HA_CREATE_INFO *create_info, const char *path, ulonglong *const copied,
                                ulonglong *const deleted, const uchar *pack_frm_data, size_t pack_frm_len)
  {
    return HA_ERR_WRONG_COMMAND;
  }
  ...
  virtual bool autoinc_lock_mode_stmt_unsafe() const { return false; }
 ...
 public:
  ...
  virtual handlerton *partition_ht() const { return ht; }
  ...
  /**
    ...
    @retval  0 Found
  */
  virtual int find_unique_row(uchar *record, uint unique_ref) { return -1; /*unsupported */ }

  bool native_versioned() const
  {
    DBUG_ASSERT(ht);
    return partition_ht()->flags & HTON_NATIVE_SYS_VERSIONING;
  }
   ...
   */
  virtual bool can_convert_string(const Field_string *field, const Column_definition &new_type) const { return false; }
  virtual bool can_convert_varstring(const Field_varstring *field, const Column_definition &new_type) const
  {
    return false;
  }
  virtual bool can_convert_blob(const Field_blob *field, const Column_definition &new_type) const { return false; }
  ...
  virtual Compare_keys compare_key_parts(const Field &old_field, const Column_definition &new_field,
...
static inline handlerton *ha_checktype(THD *thd, enum legacy_db_type type, bool no_substitute = 0)
{
...
{
  return (db_type == NULL ? "UNKNOWN" : db_type == view_pseudo_hton ? "VIEW" : hton_name(db_type)->str);
}
...
static inline bool ha_storage_engine_is_enabled(const handlerton *db_type) { return db_type && db_type->create; }
...
int ha_delete_table(THD *thd, handlerton *db_type, const char *path, const LEX_CSTRING *db, const LEX_CSTRING *alias,
...
class Discovered_table_list : public handlerton::discovered_list
{
 ...
 public:
  ...
  Discovered_table_list(THD *thd_arg, Dynamic_array<LEX_CSTRING *> *tables_arg, const LEX_CSTRING *wild_arg);
...
bool ha_table_exists(THD *thd, const LEX_CSTRING *db, const LEX_CSTRING *table_name, LEX_CUSTRING *table_version = 0,
                     LEX_CSTRING *partition_engine_name = 0, handlerton **hton = 0, bool *is_sequence = 0);
...
void trans_register_ha(THD *thd, bool all, handlerton *ht, ulonglong trxid);
    ...
    {                                                                                                           \
      ...
      {                                                                                                         \
        ...
        {                                                                                                       \
          ...
          sub_locker =                                                                                          \
              PSI_TABLE_CALL(start_table_io_wait)(&reentrant_safe_state, m_psi, OP, INDEX, __FILE__, __LINE__); \
          PAYLOAD                                                                                               \
          if (sub_locker != NULL)                                                                               \
        ...
        {                                                                                                       \
          m_psi_locker =                                                                                        \
              PSI_TABLE_CALL(start_table_io_wait)(&m_psi_locker_state, m_psi, OP, INDEX, __FILE__, __LINE__);   \
          PAYLOAD                                                                                               \
          if (!RESULT)                                                                                          \
            m_psi_numrows++;                                                                                    \
