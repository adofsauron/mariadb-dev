  ...
  */
  ...
  class transaction
  {
    ...
    */
    ...
    {
     public:
      table(TABLE *table, bool is_transactional_arg) : m_table(table), m_is_transactional(is_transactional_arg) {}
   ...
   private:
    ...
    {
#ifdef DBUG_TRACE
      static char const *state_name[] = {"START_STATE", "TABLE_STATE", "ROW_STATE", "STATE_COUNT"};
