...
#define WARN_DEPRECATED(Thd, VerHi, VerLo, Old, New)                                               \
  ...
  {                                                                                                \
    ...
    if (((THD *)Thd) != NULL)                                                                      \
      push_warning_printf(((THD *)Thd), Sql_condition::WARN_LEVEL_WARN, ER_WARN_DEPRECATED_SYNTAX, \
                          ER_THD(((THD *)Thd), ER_WARN_DEPRECATED_SYNTAX), (Old), (New));          \
    else                                                                                           \
      sql_print_warning(                                                                           \
...
#define WARN_DEPRECATED_NO_REPLACEMENT(Thd, Old)                                                          \
  ...
  {                                                                                                       \
    THD *thd_ = ((THD *)Thd);                                                                             \
    if (thd_ != NULL)                                                                                     \
      push_warning_printf(thd_, Sql_condition::WARN_LEVEL_WARN, ER_WARN_DEPRECATED_SYNTAX_NO_REPLACEMENT, \
                          ER_THD(thd_, ER_WARN_DEPRECATED_SYNTAX_NO_REPLACEMENT), (Old));                 \
    else                                                                                                  \
      sql_print_warning(                                                                                  \
...
#define OPTIMIZER_SWITCH_DEFAULT                                                                                    \
  (OPTIMIZER_SWITCH_INDEX_MERGE | OPTIMIZER_SWITCH_INDEX_MERGE_UNION | OPTIMIZER_SWITCH_INDEX_MERGE_SORT_UNION |    \
   OPTIMIZER_SWITCH_INDEX_MERGE_INTERSECT | OPTIMIZER_SWITCH_INDEX_COND_PUSHDOWN | OPTIMIZER_SWITCH_DERIVED_MERGE | \
   OPTIMIZER_SWITCH_DERIVED_WITH_KEYS | OPTIMIZER_SWITCH_TABLE_ELIMINATION | OPTIMIZER_SWITCH_EXTENDED_KEYS |       \
   OPTIMIZER_SWITCH_IN_TO_EXISTS | OPTIMIZER_SWITCH_MATERIALIZATION | OPTIMIZER_SWITCH_PARTIAL_MATCH_ROWID_MERGE |  \
   OPTIMIZER_SWITCH_PARTIAL_MATCH_TABLE_SCAN | OPTIMIZER_SWITCH_OUTER_JOIN_WITH_CACHE |                             \
   OPTIMIZER_SWITCH_SEMIJOIN_WITH_CACHE | OPTIMIZER_SWITCH_JOIN_CACHE_INCREMENTAL |                                 \
   OPTIMIZER_SWITCH_JOIN_CACHE_HASHED | OPTIMIZER_SWITCH_JOIN_CACHE_BKA | OPTIMIZER_SWITCH_SUBQUERY_CACHE |         \
   OPTIMIZER_SWITCH_SEMIJOIN | OPTIMIZER_SWITCH_FIRSTMATCH | OPTIMIZER_SWITCH_LOOSE_SCAN |                          \
   OPTIMIZER_SWITCH_EXISTS_TO_IN | OPTIMIZER_SWITCH_ORDERBY_EQ_PROP | OPTIMIZER_SWITCH_COND_PUSHDOWN_FOR_DERIVED |  \
   OPTIMIZER_SWITCH_SPLIT_MATERIALIZED | OPTIMIZER_SWITCH_COND_PUSHDOWN_FOR_SUBQUERY |                              \
   OPTIMIZER_SWITCH_USE_ROWID_FILTER | OPTIMIZER_SWITCH_COND_PUSHDOWN_FROM_HAVING |                                 \
...
#define UNCACHEABLE_DEPENDENT (UNCACHEABLE_DEPENDENT_GENERATED | UNCACHEABLE_DEPENDENT_INJECTED)
