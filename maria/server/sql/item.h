...
class st_value
{
 public:
  st_value() {}
  st_value(char *buffer, size_t buffer_size) : m_string(buffer, buffer_size, &my_charset_bin) {}
...
class Value : public st_value
{
 public:
  ...
  bool is_longlong() const { return m_type == DYN_COL_UINT || m_type == DYN_COL_INT; }
...
class ValueBuffer : public Value
{
 ...
 public:
  ...
  void reset_buffer() { m_string.set_buffer_if_not_allocated(buffer, buffer_size, &my_charset_bin); }
};
...
bool mark_unsupported_function(const char *w1, const char *w2, void *store, uint result);
...
#define MARKER_EXTRACTION_MASK (MARKER_NO_EXTRACTION | MARKER_FULL_EXTRACTION | MARKER_DELETION | MARKER_IMMUTABLE)
...
struct Name_resolution_context : Sql_alloc
{
  ...
  */
  ...
  Name_resolution_context()
      : outer_context(0), table_list(0), select_lex(0), error_processor_data(0), ignored_tables(NULL), security_ctx(0)
  {
  }
  ...
  st_select_lex *outer_select() { return (outer_context ? outer_context->select_lex : NULL); }
};
...
extern MYSQL_PLUGIN_IMPORT Sp_rcontext_handler_package_body sp_rcontext_handler_package_body;
...
class Rewritable_query_parameter
{
  ...
  */
  ...
  Rewritable_query_parameter(uint pos_in_q = 0, uint len_in_q = 0)
      : pos_in_query(pos_in_q), len_in_query(len_in_q), limit_clause_param(false)
  {
  }
...
class Copy_query_with_rewrite
{
 ...
 public:
  Copy_query_with_rewrite(THD *t, const char *s, size_t l, String *d) : thd(t), src(s), src_len(l), from(0), dst(d) {}
...
class String_copier_for_item : public String_copier
{
 ...
 public:
  bool copy_with_warn(CHARSET_INFO *dstcs, String *dst, CHARSET_INFO *srccs, const char *src, uint32 src_length,
                      uint32 nchars);
...
class Tmp_field_src
{
 ...
 public:
  ...
  void set_item_result_field(Item_result_field *item) { m_item_result_field = item; }
};
...
class Tmp_field_param
{
 ...
 public:
  Tmp_field_param(bool group, bool modify_item, bool table_cant_handle_bit_fields, bool make_copy_field)
      : m_group(group),
  ...
  bool table_cant_handle_bit_fields() const { return m_table_cant_handle_bit_fields; }
...
static inline item_base_t operator~(const item_base_t a) { return (item_base_t) ~(item_flags_t)a; }
...
static inline item_with_t operator~(const item_with_t a) { return (item_with_t) ~(item_flags_t)a; }

class Item : public Value_source, public Type_all_attributes
{
  ...
  */
  Field *create_tmp_field_ex_simple(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param)
  {
  ...
  Field *create_tmp_field_int(MEM_ROOT *root, TABLE *table, uint convert_int_length);
  Field *tmp_table_field_from_field_type_maybe_null(MEM_ROOT *root, TABLE *table, Tmp_field_src *src,
  ...
  bool val_native_with_conversion_from_item(THD *thd, Item *item, Native *to, const Type_handler *handler)
  {
    DBUG_ASSERT(fixed());
  ...
  bool get_date_from_item(THD *thd, Item *item, MYSQL_TIME *ltime, date_mode_t fuzzydate)
  {
  ...
  */
  ...
  inline bool maybe_null() const { return (bool)(base_flags & item_base_t::MAYBE_NULL); }
  inline bool in_rollup() const { return (bool)(base_flags & item_base_t::IN_ROLLUP); }
  inline bool fixed() const { return (bool)(base_flags & item_base_t::FIXED); }
  inline bool is_explicit_name() const { return (bool)(base_flags & item_base_t::IS_EXPLICIT_NAME); }
  inline bool is_in_with_cycle() const { return (bool)(base_flags & item_base_t::IS_IN_WITH_CYCLE); }

  inline bool with_sp_var() const { return (bool)(with_flags & item_with_t::SP_VAR); }
  inline bool with_window_func() const { return (bool)(with_flags & item_with_t::WINDOW_FUNC); }
  inline bool with_field() const { return (bool)(with_flags & item_with_t::FIELD); }
  inline bool with_sum_func() const { return (bool)(with_flags & item_with_t::SUM_FUNC); }
  inline bool with_subquery() const { return (bool)(with_flags & item_with_t::SUBQUERY); }
  inline bool with_rownum_func() const { return (bool)(with_flags & item_with_t::ROWNUM_FUNC); }
  inline void copy_flags(const Item *org, item_base_t mask)
  {
    base_flags = (item_base_t)(((item_flags_t)base_flags & ~(item_flags_t)mask) |
                               ((item_flags_t)org->base_flags & (item_flags_t)mask));
  }
  inline void copy_flags(const Item *org, item_with_t mask)
  {
    with_flags = (item_with_t)(((item_flags_t)with_flags & ~(item_flags_t)mask) |
                               ((item_flags_t)org->with_flags & (item_flags_t)mask));
  }
  ...
  */
  ...
  void set_name(THD *thd, String *str) { set_name(thd, str->ptr(), str->length(), str->charset()); }
  void set_name(THD *thd, const LEX_CSTRING &str, CHARSET_INFO *cs = system_charset_info)
  {
    set_name(thd, str.str, str.length, cs);
  }
  void set_name_no_truncate(THD *thd, const char *str, uint length, CHARSET_INFO *cs);
  ...
  bool fix_fields_if_needed(THD *thd, Item **ref) { return fixed() ? false : fix_fields(thd, ref); }
  ...
  */
  bool fix_fields_if_needed_for_scalar(THD *thd, Item **ref) { return fix_fields_if_needed(thd, ref) || check_cols(1); }
  bool fix_fields_if_needed_for_bool(THD *thd, Item **ref) { return fix_fields_if_needed_for_scalar(thd, ref); }
  bool fix_fields_if_needed_for_order_by(THD *thd, Item **ref) { return fix_fields_if_needed_for_scalar(thd, ref); }
  /*
  ...
  */
  ...
  virtual void unfix_fields() { DBUG_ASSERT(0); }

  /*
    Fix after some tables has been pulled out. Basically re-calculate all
    attributes that are dependent on the tables.
  */
  virtual void fix_after_pullout(st_select_lex *new_parent, Item **ref, bool merge){};
  ...
  */
  ...
  bool save_in_value(THD *thd, st_value *value) { return type_handler()->Item_save_in_value(thd, this, value); }

  /* Function returns 1 on overflow and -1 on fatal errors */
  int save_in_field_no_warnings(Field *field, bool no_conversions);
  virtual int save_in_field(Field *field, bool no_conversions);
  virtual bool save_in_param(THD *thd, Item_param *param);
  virtual void save_org_in_field(Field *field, fast_field_copier data __attribute__((__unused__)))
  {
    (void)save_in_field(field, 1);
  }
  virtual fast_field_copier setup_fast_field_copier(Field *field) { return NULL; }
  virtual int save_safe_in_field(Field *field) { return save_in_field(field, 1); }
  virtual bool send(Protocol *protocol, st_value *buffer) { return type_handler()->Item_send(this, protocol, buffer); }
  virtual bool eq(const Item *, bool binary_cmp) const;
  enum_field_types field_type() const { return type_handler()->field_type(); }
  ...
  */
  virtual const Type_handler *fixed_type_handler() const { return NULL; }
  const Type_handler *type_handler_for_comparison() const { return type_handler()->type_handler_for_comparison(); }
  virtual const Type_handler *real_type_handler() const { return type_handler(); }
  const Type_handler *cast_to_int_type_handler() const { return real_type_handler()->cast_to_int_type_handler(); }
  ...
  const Type_handler *string_type_handler() const { return Type_handler::string_type_handler(max_length); }
  /*
  ...
  */
  ...
  inline void set_maybe_null(bool maybe_null_arg)
  {
    base_flags = ((item_base_t)((base_flags & ~item_base_t::MAYBE_NULL)) |
                  (item_base_t)(maybe_null_arg << ITEM_FLAGS_MAYBE_NULL_SHIFT));
  }
  /* This is used a lot, so make it simpler to use */
  void set_maybe_null() { base_flags |= item_base_t::MAYBE_NULL; }
  /* This is used when calling Type_all_attributes::set_type_maybe_null() */
  void set_type_maybe_null(bool maybe_null_arg) override { set_maybe_null(maybe_null_arg); }
  /*
  ...
  */
  virtual void top_level_item() { base_flags |= item_base_t::AT_TOP_LEVEL; }
  /*
    Return TRUE if this item of top WHERE level (AND/OR)
  */
  bool is_top_level_item() const { return (bool)(base_flags & item_base_t::AT_TOP_LEVEL); }
  ...
  bool is_of_type(Type t, Item_result cmp) const { return type() == t && cmp_type() == cmp; }
  /*
  ...
  */
  virtual enum_monotonicity_info get_monotonicity_info() const { return NON_MONOTONIC; }
  ...
  */
  ...
  Longlong_hybrid_null to_longlong_hybrid_null() { return Longlong_hybrid_null(to_longlong_null(), unsigned_flag); }
  /**
  ...
  */
  ...
  bool val_native_with_conversion_result(THD *thd, Native *to, const Type_handler *th)
  {
  ...
  virtual bool val_native_result(THD *thd, Native *to) { return val_native(thd, to); }
  ...
  */
  ...
  bool can_eval_in_optimize() { return const_item() && !is_expensive(); }
  ...
  */
  ...
  virtual Sql_mode_dependency value_depends_on_sql_mode() const { return Sql_mode_dependency(); }
  ...
  const char *field_name_or_null() { return real_item()->type() == Item::FIELD_ITEM ? name.str : NULL; }
  ...
  */
  ...
  decimal_digits_t decimal_precision() const override { return type_handler()->Item_decimal_precision(this); }
  ...
  */
  decimal_digits_t decimal_scale() const { return type_handler()->Item_decimal_scale(this); }
  /*
  ...
  */
  uint divisor_precision_increment() const { return type_handler()->Item_divisor_precision_increment(this); }
  /**
    TIME or DATETIME precision of the item: 0..6
  */
  uint time_precision(THD *thd)
  {
    return const_item() ? type_handler()->Item_time_precision(thd, this) : MY_MIN(decimals, TIME_SECOND_PART_DIGITS);
  }
  ...
  virtual longlong val_int_min() const { return LONGLONG_MIN; }
  /*
  ...
  */
  ...
  enum precedence higher_precedence() const { return (enum precedence)(precedence() + 1); }
  void print_parenthesised(String *str, enum_query_type query_type, enum precedence parent_prec);
  /**
  ...
  */
  void print_for_table_def(String *str)
  {
    print_parenthesised(str,
                        (enum_query_type)(QT_ITEM_ORIGINAL_FUNC_NULLIF | QT_ITEM_IDENT_SKIP_DB_NAMES |
                                          QT_ITEM_IDENT_SKIP_TABLE_NAMES | QT_NO_DATA_EXPANSION | QT_TO_SYSTEM_CHARSET),
                        LOWEST_PRECEDENCE);
  }
  ...
  virtual COND *build_equal_items(THD *thd, COND_EQUAL *inheited, bool link_item_fields, COND_EQUAL **cond_equal_ref)
  {
    update_used_tables();
    DBUG_ASSERT(!cond_equal_ref || !cond_equal_ref[0]);
    return this;
  }
  virtual COND *remove_eq_conds(THD *thd, Item::cond_result *cond_value, bool top_level);
  virtual void add_key_fields(JOIN *join, KEY_FIELD **key_fields, uint *and_level, table_map usable_tables,
  ...
  */
  virtual bool check_equality(THD *thd, COND_EQUAL *cond, List<Item> *eq_list) { return false; }
  virtual void split_sum_func(THD *thd, Ref_ptr_array ref_pointer_array, List<Item> &fields, uint flags) {}
  /* Called for items that really have to be split */
  void split_sum_func2(THD *thd, Ref_ptr_array ref_pointer_array, List<Item> &fields, Item **ref, uint flags);
  ...
  virtual longlong val_datetime_packed(THD *thd) { return Datetime(thd, this, Datetime::Options_cmp(thd)).to_packed(); }
  ...
  */
  virtual Item_in_subselect *get_IN_subquery() { return NULL; /* in is not IN/ALL/ANY */ }
  /*
  ...
  */
  virtual bool set_format_by_check_constraint(Send_field_extended_metadata *) const { return false; }
  /*
  ...
  */
  ...
  virtual Item *make_odbc_literal(THD *thd, const LEX_CSTRING *typestr) { return this; }

  static CHARSET_INFO *default_charset();

  CHARSET_INFO *charset_for_protocol(void) const { return type_handler()->charset_for_protocol(this); };

  virtual bool walk(Item_processor processor, bool walk_subquery, void *arg) { return (this->*processor)(arg); }
  ...
  /*
    ...
    bottom-up.
  */
  virtual Item *compile(THD *thd, Item_analyzer analyzer, uchar **arg_p, Item_transformer transformer, uchar *arg_t)
  {
  ...
  */
  ...
  /*
    ...
    Not to be used for AND/OR formulas.
  */
  virtual bool excl_dep_on_in_subq_left_part(Item_in_subselect *subq_pred) { return false; }
  ...
  */
  struct vcol_func_processor_result
  {
    ...
    vcol_func_processor_result() : errors(0), name(NULL), alter_info(NULL) {}
  };
  ...
  */
  ...
  virtual Item *propagate_equal_fields(THD *, const Context &, COND_EQUAL *) { return this; };

  Item *propagate_equal_fields_and_change_item_tree(THD *thd, const Context &ctx, COND_EQUAL *cond, Item **place);
  ...
  */
  ...
  bool check_type_or_binary(const LEX_CSTRING &opname, const Type_handler *handler) const;
  ...
  {
    return Type_handler::type_handler_long_or_longlong(max_char_length(), unsigned_flag);
  }
  ...
  */
  virtual Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src,
                                     const Tmp_field_param *param) = 0;
  virtual Item_field *field_for_view_update() { return 0; }

  virtual Item *neg_transformer(THD *thd) { return NULL; }
  virtual Item *update_value_transformer(THD *thd, uchar *select_arg) { return this; }
  virtual Item *expr_cache_insert_transformer(THD *thd, uchar *unused) { return this; }
  virtual Item *derived_field_transformer_for_having(THD *thd, uchar *arg) { return this; }
  virtual Item *derived_field_transformer_for_where(THD *thd, uchar *arg) { return this; }
  virtual Item *grouping_field_transformer_for_where(THD *thd, uchar *arg) { return this; }
  /* Now is not used. */
  virtual Item *in_subq_field_transformer_for_where(THD *thd, uchar *arg) { return this; }
  virtual Item *in_subq_field_transformer_for_having(THD *thd, uchar *arg) { return this; }
  virtual Item *in_predicate_to_in_subs_transformer(THD *thd, uchar *arg) { return this; }
  virtual Item *field_transformer_for_having_pushdown(THD *thd, uchar *arg) { return this; }
  virtual Item *multiple_equality_transformer(THD *thd, uchar *arg) { return this; }
  ...
  bool needs_charset_converter(uint32 length, CHARSET_INFO *tocs) const
  {
    ...
    */
    if (!String::needs_conversion_on_storage(length, collation.collation, tocs))
      return false;
    /*
    ...
    */
    if (collation.derivation == DERIVATION_NUMERIC && collation.repertoire == MY_REPERTOIRE_ASCII &&
        !(collation.collation->state & MY_CS_NONASCII) && !(tocs->state & MY_CS_NONASCII))
      return false;
    return true;
  }
  ...
  Item *const_charset_converter(THD *thd, CHARSET_INFO *tocs, bool lossless, const char *func_name);
  ...
  */
  ...
  bool too_big_for_varchar() const { return max_char_length() > CONVERT_IF_BIGGER_TO_BLOB; }
  ...
  */
  virtual void under_not(Item_func_not *upper __attribute__((unused))){};
  /*
  ...
  */
  ...
  bool depends_only_on(table_map view_map) { return marker & MARKER_FULL_EXTRACTION; }
  int get_extraction_flag() const { return marker & MARKER_EXTRACTION_MASK; }
  void set_extraction_flag(int16 flags)
  {
    marker &= ~MARKER_EXTRACTION_MASK;
    marker |= flags;
  }
  void clear_extraction_flag() { marker &= ~MARKER_EXTRACTION_MASK; }
  void check_pushable_cond(Pushdown_checker excl_dep_func, uchar *arg);
  bool pushable_cond_checker_for_derived(uchar *arg) { return excl_dep_on_table(*((table_map *)arg)); }
  ...
  Item *build_pushable_cond(THD *thd, Pushdown_checker checker, uchar *arg);
  /*
    Checks if this item depends only on the arg table
  */
  bool pushable_equality_checker_for_derived(uchar *arg) { return (used_tables() == *((table_map *)arg)); }
  /*
...
class Item_args
{
 ...
 public:
  ...
  Item_args(Item *a) : args(tmp_arg), arg_count(1) { args[0] = a; }
  Item_args(Item *a, Item *b) : args(tmp_arg), arg_count(2)
  {
    args[0] = a;
    args[1] = b;
  }
  ...
  Item_args(THD *thd, List<Item> &list) { set_arguments(thd, list); }
  Item_args(THD *thd, const Item_args *other);
  bool alloc_arguments(THD *thd, uint count);
  void add_argument(Item *item) { args[arg_count++] = item; }
  /**
...
{
 public:
  Item_fixed_hybrid(THD *thd) : Item(thd) { base_flags &= ~item_base_t::FIXED; }
  Item_fixed_hybrid(THD *thd, Item_fixed_hybrid *item) : Item(thd, item)
  {
  ...
  void quick_fix_field() override { base_flags |= item_base_t::FIXED; }
  void unfix_fields() override { base_flags &= ~item_base_t::FIXED; }
};

/**
  A common class for Item_basic_constant and Item_param
*/
class Item_basic_value : public Item, public Item_const
{
 protected:
  ...
  {
   public:
    Metadata(const String *str) { my_string_metadata_get(this, str->charset(), str->ptr(), str->length()); }
    ...
    my_repertoire_t repertoire() const { return MY_STRING_METADATA::repertoire; }
    size_t char_length() const { return MY_STRING_METADATA::char_length; }
  };
  void fix_charset_and_length(CHARSET_INFO *cs, Derivation dv, Metadata metadata)
  {
    /*
  ...
  Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param) override
  {
    /*
      ...
      - In CURSORS:
          ...
          OPEN c;
    */
    return tmp_table_field_from_field_type_maybe_null(root, table, src, param, type() == Item::NULL_ITEM);
  }
  bool eq(const Item *item, bool binary_cmp) const override;
  const Type_all_attributes *get_type_all_attributes_from_const() const override { return this; }
};
...
class Item_basic_constant : public Item_basic_value
{
 public:
  ...
  virtual Item_basic_constant *make_string_literal_concat(THD *thd, const LEX_CSTRING *)
  {
    DBUG_ASSERT(0);
    return this;
  }
...
inline bool Item_sp_variable::send(Protocol *protocol, st_value *buffer) { return this_item()->send(protocol, buffer); }
                     ...
                     public Type_handler_hybrid_field_type
{
 ...
 public:
  Item_splocal(THD *thd, const Sp_rcontext_handler *rh, const LEX_CSTRING *sp_var_name, uint sp_var_idx,
               const Type_handler *handler, uint pos_in_q = 0, uint len_in_q = 0);
 ...
 public:
  ...
  const Type_handler *type_handler() const override { return Type_handler_hybrid_field_type::type_handler(); }
 ...
 public:
  ...
  Rewritable_query_parameter *get_rewritable_query_parameter() override { return this; }

  Settable_routine_parameter *get_settable_routine_parameter() override { return this; }
...
{
 public:
  Item_splocal_with_delayed_data_type(THD *thd, const Sp_rcontext_handler *rh, const LEX_CSTRING *sp_var_name,
                                      uint sp_var_idx, uint pos_in_q, uint len_in_q)
      : Item_splocal(thd, rh, sp_var_name, sp_var_idx, &type_handler_null, pos_in_q, len_in_q)
  {
  }
};
...
class Item_splocal_row_field : public Item_splocal
{
 ...
 public:
  Item_splocal_row_field(THD *thd, const Sp_rcontext_handler *rh, const LEX_CSTRING *sp_var_name,
                         const LEX_CSTRING *sp_field_name, uint sp_var_idx, uint sp_field_idx,
                         const Type_handler *handler, uint pos_in_q = 0, uint len_in_q = 0)
...
class Item_splocal_row_field_by_name : public Item_splocal_row_field
{
 ...
 public:
  Item_splocal_row_field_by_name(THD *thd, const Sp_rcontext_handler *rh, const LEX_CSTRING *sp_var_name,
                                 const LEX_CSTRING *sp_field_name, uint sp_var_idx, const Type_handler *handler,
                                 uint pos_in_q = 0, uint len_in_q = 0)
      : Item_splocal_row_field(thd, rh, sp_var_name, sp_field_name, sp_var_idx, 0 /* field index will be set later */,
...
inline const LEX_CSTRING *Item_splocal::my_name() const { return &m_name; }

inline uint Item_splocal::get_var_idx() const { return m_var_idx; }
...
class Item_case_expr : public Item_sp_variable
{
 ...
 public:
  ...
  const Type_handler *type_handler() const override { return this_item()->type_handler(); }
...
inline enum Item::Type Item_case_expr::type() const { return this_item()->type(); }
...
class Item_name_const : public Item_fixed_hybrid
{
 ...
 public:
  ...
  const Type_handler *type_handler() const override { return value_item->type_handler(); }
  ...
  bool send(Protocol *protocol, st_value *buffer) override { return value_item->send(protocol, buffer); }
  bool check_vcol_func_processor(void *arg) override
  {
    return mark_unsupported_function("name_const()", arg, VCOL_IMPOSSIBLE);
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_name_const>(thd, this); }
};
...
{
 protected:
  Field *create_tmp_field_ex_from_handler(MEM_ROOT *root, TABLE *table, Tmp_field_src *src,
 ...
 public:
  ...
  Item_result_field(THD *thd, Item_result_field *item) : Item_fixed_hybrid(thd, item), result_field(item->result_field)
  {
  }
  ...
  */
  ...
  void save_in_result_field(bool no_conversions) override { save_in_field(result_field, no_conversions); }
  void cleanup() override;
...
class Item_ident : public Item_result_field
{
  ...
  */
  ...
  Item_ident(THD *thd, Name_resolution_context *context_arg, const LEX_CSTRING &db_name_arg,
  ...
  */
  ...
  friend bool insert_fields(THD *thd, Name_resolution_context *context, const char *db_name, const char *table_name,
                            List_iterator<Item> *it, bool any_privileges, bool returning_field);
};

class Item_field : public Item_ident, public Load_data_outvar
{
 protected:
 ...
 public:
  Item_field(THD *thd, Name_resolution_context *context_arg, const LEX_CSTRING &db_arg,
             const LEX_CSTRING &table_name_arg, const LEX_CSTRING &field_name_arg);
  Item_field(THD *thd, Name_resolution_context *context_arg, const LEX_CSTRING &field_name_arg)
  ...
  */
  ...
  bool load_data_set_null(THD *thd, const Load_data_param *param) override { return field->load_data_set_null(thd); }
  bool load_data_set_value(THD *thd, const char *pos, uint length, const Load_data_param *param) override
  {
  ...
  uint load_data_fixed_length() const override { return field->field_length; }
  ...
  int save_in_field(Field *field, bool no_conversions) override;
  void save_org_in_field(Field *field, fast_field_copier optimizer_data) override;
  ...
  Field *create_tmp_field_from_item_field(MEM_ROOT *root, TABLE *new_table, Item_ref *orig_item,
                                          const Tmp_field_param *param);
  Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param) override;
  const TYPELIB *get_typelib() const override { return field->get_typelib(); }
  enum_monotonicity_info get_monotonicity_info() const override { return MONOTONIC_STRICT_INCREASING; }
  ...
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override;
  bool get_date_result(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override;
  ...
  void update_used_tables() override { update_table_bitmaps(); }
  COND *build_equal_items(THD *thd, COND_EQUAL *inherited, bool link_item_fields, COND_EQUAL **cond_equal_ref) override
  {
    /*
    ...
    */
    ...
    return Item_ident::build_equal_items(thd, inherited, link_item_fields, cond_equal_ref);
  }
  ...
  bool check_table_name_processor(void *arg) override
  {
    ...
    if (!field && p.table_name.length && table_name.length)
    {
      ...
      if ((db_name.length && my_strcasecmp(table_alias_charset, p.db.str, db_name.str)) ||
          my_strcasecmp(table_alias_charset, p.table_name.str, table_name.str))
      {
        print(&p.field, (enum_query_type)(QT_ITEM_ORIGINAL_FUNC_NULLIF | QT_NO_DATA_EXPANSION | QT_TO_SYSTEM_CHARSET));
        return true;
      }
    }
    return false;
  ...
  uint32 max_display_length() const override { return field->max_display_length(); }
  ...
  bool cleanup_excluding_fields_processor(void *arg) override { return field ? 0 : cleanup_processor(arg); }
  bool cleanup_excluding_const_fields_processor(void *arg) override
  {
    return field && const_item() ? 0 : cleanup_processor(arg);
  }

  Item *get_copy(THD *thd) override { return get_item_copy<Item_field>(thd, this); }
...
*/
class Item_field_row : public Item_field, public Item_args
{
 public:
  Item_field_row(THD *thd, Field *field) : Item_field(thd, field), Item_args() {}
  Item *get_copy(THD *thd) override { return get_item_copy<Item_field_row>(thd, this); }
...
{
 public:
  Item_null(THD *thd, const char *name_par = 0, CHARSET_INFO *cs = &my_charset_bin) : Item_basic_constant(thd)
  {
    set_maybe_null();
    null_value = TRUE;
    max_length = 0;
  ...
  void print(String *str, enum_query_type) override { str->append(NULL_clex_str); }

  Item *safe_charset_converter(THD *thd, CHARSET_INFO *tocs) override;
  bool check_partition_func_processor(void *) override { return false; }
  Item_basic_constant *make_string_literal_concat(THD *thd, const LEX_CSTRING *) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_null>(thd, this); }
};
...
class Item_null_result : public Item_null
{
 public:
  ...
  Field *create_tmp_field_ex(MEM_ROOT *, TABLE *, Tmp_field_src *, const Tmp_field_param *) override
  {
    DBUG_ASSERT(0);
    return NULL;
  }
                   ...
                   private Type_handler_hybrid_field_type
{
  ...
  */
  ...
  struct CONVERSION_INFO
  {
   ...
   private:
    bool needs_conversion() const { return final_character_set_of_str_value != character_set_of_placeholder; }
  ...
  class PValue_simple
  {
   public:
    ...
    void swap(PValue_simple &other) { swap_variables(PValue_simple, *this, other); }
  };

  class PValue : public Type_handler_hybrid_field_type, public PValue_simple, public Value_source
  {
   public:
  ...
  */
  ...
  Item_param(THD *thd, const LEX_CSTRING *name_arg, uint pos_in_query_arg, uint len_in_query_arg);
  ...
  {
    return state == SHORT_DATA_VALUE && type_handler()->is_order_clause_position_type();
  }
  ...
  {
    return can_return_value() && value.type_handler()->cmp_type() == type && type_handler()->cmp_type() == type;
  }
  const longlong *const_ptr_longlong() const override
  {
    return can_return_const_value(INT_RESULT) ? &value.integer : NULL;
  }
  const double *const_ptr_double() const override { return can_return_const_value(REAL_RESULT) ? &value.real : NULL; }
  ...
  double val_real() override { return can_return_value() ? value.val_real(this) : 0e0; }
  longlong val_int() override { return can_return_value() ? value.val_int(this) : 0; }
  my_decimal *val_decimal(my_decimal *dec) override { return can_return_value() ? value.val_decimal(dec, this) : NULL; }
  ...
  bool set_str(const char *str, ulong length, CHARSET_INFO *fromcs, CHARSET_INFO *tocs);
  ...
  */
  ...
  bool set_value(THD *thd, const Type_all_attributes *attr, const st_value *val, const Type_handler *h)
  {
  ...
  */
  bool const_item() const override { return state != NO_VALUE; }
  table_map used_tables() const override { return state != NO_VALUE ? (table_map)0 : PARAM_TABLE_BIT; }
  void print(String *str, enum_query_type query_type) override;
  bool is_null() override
  {
  ...
  bool has_no_value() const { return state == NO_VALUE; }
  bool has_long_data_value() const { return state == LONG_DATA_VALUE; }
...
class Item_int : public Item_num
{
 public:
  longlong value;
  Item_int(THD *thd, int32 i, size_t length = MY_INT32_NUM_DECIMAL_DIGITS) : Item_num(thd), value((longlong)i)
  {
    max_length = (uint32)length;
  }
  Item_int(THD *thd, longlong i, size_t length = MY_INT64_NUM_DECIMAL_DIGITS) : Item_num(thd), value(i)
  {
    max_length = (uint32)length;
  }
  Item_int(THD *thd, ulonglong i, size_t length = MY_INT64_NUM_DECIMAL_DIGITS) : Item_num(thd), value((longlong)i)
  {
    max_length = (uint32)length;
    unsigned_flag = 1;
  }
  Item_int(THD *thd, const char *str_arg, longlong i, size_t length) : Item_num(thd), value(i)
  {
    max_length = (uint32)length;
    name.str = str_arg;
    name.length = safe_strlen(name.str);
  }
  Item_int(THD *thd, const char *str_arg, longlong i, size_t length, bool flag) : Item_num(thd), value(i)
  {
    max_length = (uint32)length;
    name.str = str_arg;
    name.length = safe_strlen(name.str);
  ...
  Item_int(const char *str_arg, longlong i, size_t length) : Item_num(), value(i)
  {
    max_length = (uint32)length;
    name.str = str_arg;
    name.length = safe_strlen(name.str);
  ...
  const Type_handler *type_handler() const override { return type_handler_long_or_longlong(); }
  Field *create_field_for_create_select(MEM_ROOT *root, TABLE *table) override
  {
    return tmp_table_field_from_field_type(root, table);
  }
  ...
  decimal_digits_t decimal_precision() const override { return (decimal_digits_t)(max_length - MY_TEST(value < 0)); }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_int>(thd, this); }
};
...
{
 public:
  Item_bool(THD *thd, const char *str_arg, longlong i) : Item_int(thd, str_arg, i, 1) {}
  Item_bool(THD *thd, bool i) : Item_int(thd, (longlong)i, 1) {}
  Item_bool(const char *str_arg, longlong i) : Item_int(str_arg, i, 1) {}
...
{
 public:
  Item_bool_static(const char *str_arg, longlong i) : Item_bool(str_arg, i){};

  /* Don't mark static items as top level item */
  virtual void top_level_item() override {}
  void set_join_tab_idx(uint8 join_tab_idx_arg) override { DBUG_ASSERT(0); }
...
class Item_uint : public Item_int
{
 public:
  ...
  Item *clone_item(THD *thd) override;
  Item *neg(THD *thd) override;
  decimal_digits_t decimal_precision() const override { return decimal_digits_t(max_length); }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_uint>(thd, this); }
};
...
class Item_decimal : public Item_num
{
 ...
 public:
  Item_decimal(THD *thd, const char *str_arg, size_t length, CHARSET_INFO *charset);
  Item_decimal(THD *thd, const char *str, const my_decimal *val_arg, uint decimal_par, uint length);
  ...
  longlong val_int() override { return decimal_value.to_longlong(unsigned_flag); }
  ...
  const my_decimal *const_ptr_my_decimal() const override { return &decimal_value; }
  int save_in_field(Field *field, bool no_conversions) override;
  Item *clone_item(THD *thd) override;
  void print(String *str, enum_query_type query_type) override
  {
  ...
  Item *neg(THD *thd) override;
  decimal_digits_t decimal_precision() const override { return decimal_value.precision(); }
  void set_decimal_value(my_decimal *value_par);
  Item *get_copy(THD *thd) override { return get_item_copy<Item_decimal>(thd, this); }
};
...
class Item_float : public Item_num
{
 ...
 public:
  ...
  Item_float(THD *thd, const char *str, double val_arg, uint decimal_par, uint length) : Item_num(thd), value(val_arg)
  {
  ...
  Item_float(THD *thd, double value_par, uint decimal_par) : Item_num(thd), presentation(0), value(value_par)
  {
    decimals = (uint8)decimal_par;
  }
  int save_in_field(Field *field, bool no_conversions) override;
  ...
  Item *neg(THD *thd) override;
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_float>(thd, this); }
};
...
class Item_static_float_func : public Item_float
{
 ...
 public:
  Item_static_float_func(THD *thd, const char *str, double val_arg, uint decimal_par, uint length)
      : Item_float(thd, NullS, val_arg, decimal_par, length), func_name(str)
  {
  }
  void print(String *str, enum_query_type) override { str->append(func_name, strlen(func_name)); }
  Item *safe_charset_converter(THD *thd, CHARSET_INFO *tocs) override
  {
...
class Item_string : public Item_literal
{
 protected:
  ...
  void fix_and_set_name_from_value(THD *thd, Derivation dv, const Metadata metadata)
  {
 ...
 protected:
  ...
  Item_string(THD *thd, CHARSET_INFO *cs, Derivation dv = DERIVATION_COERCIBLE) : Item_literal(thd)
  {
    collation.set(cs, dv);
    max_length = 0;
 ...
 public:
  Item_string(THD *thd, CHARSET_INFO *csi, const char *str_arg, uint length_arg) : Item_literal(thd)
  {
  ...
  Item_string(THD *thd, const char *str, uint length, CHARSET_INFO *cs, Derivation dv, my_repertoire_t repertoire)
      : Item_literal(thd)
  {
    str_value.set_or_copy_aligned(str, length, cs);
    fix_and_set_name_from_value(thd, dv, Metadata(&str_value, repertoire));
  }
  Item_string(THD *thd, const char *str, size_t length, CHARSET_INFO *cs, Derivation dv = DERIVATION_COERCIBLE)
      : Item_literal(thd)
  {
    str_value.set_or_copy_aligned(str, length, cs);
    fix_and_set_name_from_value(thd, dv, Metadata(&str_value));
  }
  Item_string(THD *thd, const String *str, CHARSET_INFO *tocs, uint *conv_errors, Derivation dv,
  ...
  Item_string(THD *thd, const LEX_CSTRING &name_par, const LEX_CSTRING &str, CHARSET_INFO *cs,
  ...
  Item_string(THD *thd, const LEX_CSTRING &name_par, const LEX_CSTRING &str, CHARSET_INFO *cs, Derivation dv,
              my_repertoire_t repertoire)
      : Item_literal(thd)
  {
    str_value.set_or_copy_aligned(str.str, str.length, cs);
  ...
  void print_value(String *to) const { str_value.print(to); }
  double val_real() override;
  longlong val_int() override;
  const String *const_ptr_string() const override { return &str_value; }
  String *val_str(String *) override { return (String *)&str_value; }
  my_decimal *val_decimal(my_decimal *) override;
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
  ...
  */
  virtual bool is_cs_specified() const { return false; }

  String *check_well_formed_result(bool send_error) { return Item::check_well_formed_result(&str_value, send_error); }

  Item_basic_constant *make_string_literal_concat(THD *thd, const LEX_CSTRING *) override;
  Item *make_odbc_literal(THD *thd, const LEX_CSTRING *typestr) override;

  Item *get_copy(THD *thd) override { return get_item_copy<Item_string>(thd, this); }
};

class Item_string_with_introducer : public Item_string
{
 public:
  Item_string_with_introducer(THD *thd, const LEX_CSTRING &str, CHARSET_INFO *cs)
      : Item_string(thd, str.str, str.length, cs)
  {
  }
  Item_string_with_introducer(THD *thd, const LEX_CSTRING &name_arg, const LEX_CSTRING &str, CHARSET_INFO *tocs)
      : Item_string(thd, name_arg, str, tocs)
  {
  }
  virtual bool is_cs_specified() const { return true; }
};

class Item_string_sys : public Item_string
{
 public:
  Item_string_sys(THD *thd, const char *str, uint length) : Item_string(thd, str, length, system_charset_info) {}
  Item_string_sys(THD *thd, const char *str) : Item_string(thd, str, (uint)strlen(str), system_charset_info) {}
};
...
class Item_string_ascii : public Item_string
{
 public:
  Item_string_ascii(THD *thd, const char *str, uint length)
      : Item_string(thd, str, length, &my_charset_latin1, DERIVATION_COERCIBLE, MY_REPERTOIRE_ASCII)
  {
  }
  Item_string_ascii(THD *thd, const char *str)
      : Item_string(thd, str, (uint)strlen(str), &my_charset_latin1, DERIVATION_COERCIBLE, MY_REPERTOIRE_ASCII)
  {
  }
};
...
class Item_static_string_func : public Item_string
{
 ...
 public:
  Item_static_string_func(THD *thd, const LEX_CSTRING &name_par, const LEX_CSTRING &str, CHARSET_INFO *cs,
                          Derivation dv = DERIVATION_COERCIBLE)
      : Item_string(thd, LEX_CSTRING({NullS, 0}), str, cs, dv), func_name(name_par)
  {
  }
  Item_static_string_func(THD *thd, const LEX_CSTRING &name_par, const String *str, CHARSET_INFO *tocs,
                          uint *conv_errors, Derivation dv, my_repertoire_t repertoire)
      : Item_string(thd, str, tocs, conv_errors, dv, repertoire), func_name(name_par)
  {
  }
  Item *safe_charset_converter(THD *thd, CHARSET_INFO *tocs) override
  {
...
{
 public:
  Item_partition_func_safe_string(THD *thd, const LEX_CSTRING &name_arg, uint length, CHARSET_INFO *cs)
      : Item_string(thd, name_arg, LEX_CSTRING({0, 0}), cs)
  {
    max_length = length;
  }
  bool check_vcol_func_processor(void *arg) { return mark_unsupported_function("safe_string", arg, VCOL_IMPOSSIBLE); }
};
...
{
 public:
  Item_empty_string(THD *thd, const LEX_CSTRING &header, uint length, CHARSET_INFO *cs = &my_charset_utf8mb3_general_ci)
      : Item_partition_func_safe_string(thd, header, length * cs->mbmaxlen, cs)
  {
  }
  Item_empty_string(THD *thd, const char *header, uint length, CHARSET_INFO *cs = &my_charset_utf8mb3_general_ci)
      : Item_partition_func_safe_string(thd, LEX_CSTRING({header, strlen(header)}), length * cs->mbmaxlen, cs)
  {
  }
...
class Item_return_int : public Item_int
{
 ...
 public:
  Item_return_int(THD *thd, const char *name_arg, uint length, enum_field_types field_type_arg, longlong value_arg = 0)
  ...
  const Type_handler *type_handler() const override
  {
    const Type_handler *h = Type_handler::get_handler_by_field_type(int_field_type);
...
class Item_hex_constant : public Item_literal
{
 ...
 public:
  ...
  Item_hex_constant(THD *thd, const char *str, size_t str_length) : Item_literal(thd)
  {
...
class Item_hex_hybrid : public Item_hex_constant
{
 public:
  ...
  Item_hex_hybrid(THD *thd, const char *str, size_t str_length) : Item_hex_constant(thd, str, str_length) {}
  const Type_handler *type_handler() const override { return &type_handler_hex_hybrid; }
  decimal_digits_t decimal_precision() const override;
  double val_real() override { return (double)(ulonglong)Item_hex_hybrid::val_int(); }
  longlong val_int() override { return longlong_from_hex_hybrid(str_value.ptr(), str_value.length()); }
  my_decimal *val_decimal(my_decimal *decimal_value) override
  {
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_hex_hybrid>(thd, this); }
};
...
class Item_hex_string : public Item_hex_constant
{
 public:
  ...
  Item_hex_string(THD *thd, const char *str, size_t str_length) : Item_hex_constant(thd, str, str_length) {}
  longlong val_int() override { return longlong_from_string_with_check(&str_value); }
  double val_real() override { return double_from_string_with_check(&str_value); }
  my_decimal *val_decimal(my_decimal *decimal_value) override { return val_decimal_from_string(decimal_value); }
  int save_in_field(Field *field, bool) override
  {
    field->set_notnull();
  ...
  void print(String *str, enum_query_type query_type) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_hex_string>(thd, this); }
};
...
class Item_timestamp_literal : public Item_literal
{
 ...
 public:
  ...
  longlong val_int() override { return m_value.to_datetime(current_thd).to_longlong(); }
  double val_real() override { return m_value.to_datetime(current_thd).to_double(); }
  String *val_str(String *to) override { return m_value.to_datetime(current_thd).to_string(to, decimals); }
  my_decimal *val_decimal(my_decimal *to) override { return m_value.to_datetime(current_thd).to_decimal(to); }
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
  ...
  bool val_native(THD *thd, Native *to) override { return m_value.to_native(to, decimals); }
  void set_value(const Timestamp_or_zero_datetime &value) { m_value = value; }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_timestamp_literal>(thd, this); }
};

class Item_temporal_literal : public Item_literal
{
 public:
  Item_temporal_literal(THD *thd) : Item_literal(thd)
  {
    collation = DTCollation_numeric();
    decimals = 0;
  }
  Item_temporal_literal(THD *thd, decimal_digits_t dec_arg) : Item_literal(thd)
  {
    collation = DTCollation_numeric();
    decimals = dec_arg;
  }

  int save_in_field(Field *field, bool no_conversions) override { return save_date_in_field(field, no_conversions); }
};
...
class Item_date_literal : public Item_temporal_literal
{
 protected:
  Date cached_time;
  bool update_null() { return (maybe_null() && (null_value = cached_time.check_date_with_warn(current_thd))); }

 public:
  Item_date_literal(THD *thd, const Date *ltime) : Item_temporal_literal(thd), cached_time(*ltime)
  {
    ...
    */
    set_maybe_null(cached_time.check_date(TIME_NO_ZERO_DATE | TIME_NO_ZERO_IN_DATE));
  }
  const Type_handler *type_handler() const override { return &type_handler_newdate; }
  void print(String *str, enum_query_type query_type) override;
  const MYSQL_TIME *const_ptr_mysql_time() const override { return cached_time.get_mysql_time(); }
  Item *clone_item(THD *thd) override;
  longlong val_int() override { return update_null() ? 0 : cached_time.to_longlong(); }
  double val_real() override { return update_null() ? 0 : cached_time.to_double(); }
  String *val_str(String *to) override { return update_null() ? 0 : cached_time.to_string(to); }
  my_decimal *val_decimal(my_decimal *to) override { return update_null() ? 0 : cached_time.to_decimal(to); }
  longlong val_datetime_packed(THD *thd) override { return update_null() ? 0 : cached_time.valid_date_to_packed(); }
  bool get_date(THD *thd, MYSQL_TIME *res, date_mode_t fuzzydate) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_date_literal>(thd, this); }
};
...
class Item_time_literal final : public Item_temporal_literal
{
 ...
 public:
  Item_time_literal(THD *thd, const Time *ltime, decimal_digits_t dec_arg)
      : Item_temporal_literal(thd, dec_arg), cached_time(*ltime)
  {
  ...
  String *val_str(String *to) override { return cached_time.to_string(to, decimals); }
  my_decimal *val_decimal(my_decimal *to) override { return cached_time.to_decimal(to); }
  longlong val_time_packed(THD *thd) override { return cached_time.valid_time_to_packed(); }
  bool get_date(THD *thd, MYSQL_TIME *res, date_mode_t fuzzydate) override;
  bool val_native(THD *thd, Native *to) override { return Time(thd, this).to_native(to, decimals); }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_time_literal>(thd, this); }
};
...
class Item_datetime_literal : public Item_temporal_literal
{
 ...
 public:
  Item_datetime_literal(THD *thd, const Datetime *ltime, decimal_digits_t dec_arg)
      : Item_temporal_literal(thd, dec_arg), cached_time(*ltime)
  {
  ...
  longlong val_int() override { return update_null() ? 0 : cached_time.to_longlong(); }
  double val_real() override { return update_null() ? 0 : cached_time.to_double(); }
  String *val_str(String *to) override { return update_null() ? NULL : cached_time.to_string(to, decimals); }
  my_decimal *val_decimal(my_decimal *to) override { return update_null() ? NULL : cached_time.to_decimal(to); }
  longlong val_datetime_packed(THD *thd) override { return update_null() ? 0 : cached_time.valid_datetime_to_packed(); }
  bool get_date(THD *thd, MYSQL_TIME *res, date_mode_t fuzzydate) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_datetime_literal>(thd, this); }
};
...
class Item_date_literal_for_invalid_dates : public Item_date_literal
{
  ...
  */
 public:
  Item_date_literal_for_invalid_dates(THD *thd, const Date *ltime) : Item_date_literal(thd, ltime)
  {
...
{
 public:
  Item_datetime_literal_for_invalid_dates(THD *thd, const Datetime *ltime, decimal_digits_t dec_arg)
...
class Used_tables_and_const_cache
{
  ...
  */
  ...
  Used_tables_and_const_cache() : used_tables_cache(0), const_item_cache(true) {}
  Used_tables_and_const_cache(const Used_tables_and_const_cache *other)
      : used_tables_cache(other->used_tables_cache), const_item_cache(other->const_item_cache)
  {
  }
  ...
  */
  ...
  {
    for (uint i = 0; i < argc; i++) used_tables_and_const_cache_update_and_join(argv[i]);
  }
  /*
  ...
  */
  void used_tables_and_const_cache_update_and_join(List<Item> &list)
  {
    ...
    Item *item;
    while ((item = li++)) used_tables_and_const_cache_update_and_join(item);
  }
};
...
*/
class Item_func_or_sum : public Item_result_field, public Item_args, public Used_tables_and_const_cache
{
 protected:
  bool agg_arg_charsets(DTCollation &c, Item **items, uint nitems, uint flags, int item_sep)
  {
    return Type_std_attributes::agg_arg_charsets(c, func_name_cstring(), items, nitems, flags, item_sep);
  }
  bool agg_arg_charsets_for_string_result(DTCollation &c, Item **items, uint nitems, int item_sep = 1)
  {
    return Type_std_attributes::agg_arg_charsets_for_string_result(c, func_name_cstring(), items, nitems, item_sep);
  }
  bool agg_arg_charsets_for_string_result_with_comparison(DTCollation &c, Item **items, uint nitems, int item_sep = 1)
  {
    return Type_std_attributes::agg_arg_charsets_for_string_result_with_comparison(c, func_name_cstring(), items,
                                                                                   nitems, item_sep);
  }
  ...
  */
  ...
  {
    return Type_std_attributes::agg_arg_charsets_for_comparison(c, func_name_cstring(), items, nitems, item_sep);
  }
 ...
 public:
  ...
  {
    DTCollation tmp;
    if (tmp.set((*a)->collation, (*b)->collation, MY_COLL_CMP_CONV) || tmp.derivation == DERIVATION_NONE)
    {
      my_error(ER_CANT_AGGREGATE_2COLLATIONS, MYF(0), (*a)->collation.collation->coll_name.str,
               (*a)->collation.derivation_name(), (*b)->collation.collation->coll_name.str,
               (*b)->collation.derivation_name(), func_name());
      return true;
    }
    if (agg_item_set_converter(tmp, func_name_cstring(), a, 1, MY_COLL_CMP_CONV, 1) ||
        agg_item_set_converter(tmp, func_name_cstring(), b, 1, MY_COLL_CMP_CONV, 1))
      return true;
    *cs = tmp.collation;
    return false;
  }
 ...
 public:
  ...
  Item_func_or_sum(THD *thd, Item *a, Item *b) : Item_result_field(thd), Item_args(a, b) {}
  Item_func_or_sum(THD *thd, Item *a, Item *b, Item *c) : Item_result_field(thd), Item_args(thd, a, b, c) {}
  Item_func_or_sum(THD *thd, Item *a, Item *b, Item *c, Item *d) : Item_result_field(thd), Item_args(thd, a, b, c, d) {}
  ...
  Item_func_or_sum(THD *thd, Item_func_or_sum *item)
      : Item_result_field(thd, item), Item_args(thd, item), Used_tables_and_const_cache(item)
  {
  }
  Item_func_or_sum(THD *thd, List<Item> &list) : Item_result_field(thd), Item_args(thd, list) {}
  ...
  */
  inline const char *func_name() const { return (char *)func_name_cstring().str; }
...
class Item_sp
{
  ...
  */
  ...
  bool init_result_field(THD *thd, uint max_length, uint maybe_null, bool *null_value, LEX_CSTRING *name);
...
class Item_ref : public Item_ident
{
 ...
 public:
  ...
  Item_ref(THD *thd, Name_resolution_context *context_arg, const LEX_CSTRING &db_arg, const LEX_CSTRING &table_name_arg,
           const LEX_CSTRING &field_name_arg)
      : Item_ident(thd, context_arg, db_arg, table_name_arg, field_name_arg),
        set_properties_only(0),
        ref(0),
        reference_trough_name(1)
  {
  }
  Item_ref(THD *thd, Name_resolution_context *context_arg, const LEX_CSTRING &field_name_arg)
  ...
  */
  Item_ref(THD *thd, Name_resolution_context *context_arg, Item **item, const LEX_CSTRING &table_name_arg,
           const LEX_CSTRING &field_name_arg, bool alias_name_used_arg = FALSE);
  Item_ref(THD *thd, TABLE_LIST *view_arg, Item **item, const LEX_CSTRING &field_name_arg,
           bool alias_name_used_arg = FALSE);

  /* Constructor need to process subselect with temporary tables (see Item) */
  Item_ref(THD *thd, Item_ref *item) : Item_ident(thd, item), set_properties_only(0), ref(item->ref) {}
  enum Type type() const override { return REF_ITEM; }
  enum Type real_type() const override { return ref ? (*ref)->type() : REF_ITEM; }
  bool eq(const Item *item, bool binary_cmp) const override
  {
  ...
  int save_in_field(Field *field, bool no_conversions) override;
  void save_org_in_field(Field *field, fast_field_copier optimizer_data) override;
  fast_field_copier setup_fast_field_copier(Field *field) override { return (*ref)->setup_fast_field_copier(field); }
  const Type_handler *type_handler() const override { return (*ref)->type_handler(); }
  const Type_handler *real_type_handler() const override { return (*ref)->real_type_handler(); }
  Field *get_tmp_table_field() override { return result_field ? result_field : (*ref)->get_tmp_table_field(); }
  Item *get_tmp_table_item(THD *thd) override;
  Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param) override;
  Item *propagate_equal_fields(THD *, const Context &, COND_EQUAL *) override;
  table_map used_tables() const override;
  ...
  table_map not_null_tables() const override { return depended_from ? 0 : (*ref)->not_null_tables(); }
  bool find_not_null_fields(table_map allowed) override
  {
    return depended_from ? false : (*ref)->find_not_null_fields(allowed);
  }
  void save_in_result_field(bool no_conversions) override { (*ref)->save_in_field(result_field, no_conversions); }
  Item *real_item() override { return ref ? (*ref)->real_item() : this; }
  const TYPELIB *get_typelib() const override { return ref ? (*ref)->get_typelib() : NULL; }

  bool walk(Item_processor processor, bool walk_subquery, void *arg) override
  {
    if (ref && *ref)
      return (*ref)->walk(processor, walk_subquery, arg) || (this->*processor)(arg);
    else
      return FALSE;
  }
  Item *transform(THD *thd, Item_transformer, uchar *arg) override;
  Item *compile(THD *thd, Item_analyzer analyzer, uchar **arg_p, Item_transformer transformer, uchar *arg_t) override;
  bool enumerate_field_refs_processor(void *arg) override { return (*ref)->enumerate_field_refs_processor(arg); }
  void no_rows_in_result() override { (*ref)->no_rows_in_result(); }
  void restore_to_before_no_rows_in_result() override { (*ref)->restore_to_before_no_rows_in_result(); }
  void print(String *str, enum_query_type query_type) override;
  enum precedence precedence() const override { return ref ? (*ref)->precedence() : DEFAULT_PRECEDENCE; }
  void cleanup() override;
  Item_field *field_for_view_update() override { return (*ref)->field_for_view_update(); }
  Load_data_outvar *get_load_data_outvar() override { return (*ref)->get_load_data_outvar(); }
  virtual Ref_Type ref_type() { return REF; }

  // Row emulation: forwarding of ROW-related calls to ref
  uint cols() const override { return ref && result_type() == ROW_RESULT ? (*ref)->cols() : 1; }
  Item *element_index(uint i) override { return ref && result_type() == ROW_RESULT ? (*ref)->element_index(i) : this; }
  Item **addr(uint i) override { return ref && result_type() == ROW_RESULT ? (*ref)->addr(i) : 0; }
  bool check_cols(uint c) override
  {
    return ref && result_type() == ROW_RESULT ? (*ref)->check_cols(c) : Item::check_cols(c);
  }
  bool null_inside() override { return ref && result_type() == ROW_RESULT ? (*ref)->null_inside() : 0; }
  void bring_value() override
  {
    if (ref && result_type() == ROW_RESULT)
      (*ref)->bring_value();
  }
  bool check_vcol_func_processor(void *arg) override { return mark_unsupported_function("ref", arg, VCOL_IMPOSSIBLE); }
  bool basic_const_item() const override { return ref && (*ref)->basic_const_item(); }
  bool is_outer_field() const override
  {
    DBUG_ASSERT(fixed());
    DBUG_ASSERT(ref);
  ...
  */
  Item *get_copy(THD *thd) override { return get_item_copy<Item_ref>(thd, this); }
  bool excl_dep_on_table(table_map tab_map) override
  {
  ...
  bool excl_dep_on_grouping_fields(st_select_lex *sel) override { return (*ref)->excl_dep_on_grouping_fields(sel); }
  bool excl_dep_on_in_subq_left_part(Item_in_subselect *subq_pred) override
  {
  ...
  {
    Item *item = real_item();
    if (item && item->type() == FIELD_ITEM && ((Item_field *)item)->field)
      return 0;
  ...
  {
    Item *item = real_item();
    if (item && item->type() == FIELD_ITEM && ((Item_field *)item)->field && item->const_item())
      return 0;
    return cleanup_processor(arg);
  }
...
{
 public:
  Item_direct_ref(THD *thd, Name_resolution_context *context_arg, Item **item, const LEX_CSTRING &table_name_arg,
                  const LEX_CSTRING &field_name_arg, bool alias_name_used_arg = FALSE)
      : Item_ref(thd, context_arg, item, table_name_arg, field_name_arg, alias_name_used_arg)
  {
  }
  /* Constructor need to process subselect with temporary tables (see Item) */
  Item_direct_ref(THD *thd, Item_direct_ref *item) : Item_ref(thd, item) {}
  Item_direct_ref(THD *thd, TABLE_LIST *view_arg, Item **item, const LEX_CSTRING &field_name_arg,
                  bool alias_name_used_arg = FALSE)
      : Item_ref(thd, view_arg, item, field_name_arg, alias_name_used_arg)
  {
  }
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_direct_ref>(thd, this); }
  Item *remove_item_direct_ref() override { return (*ref)->remove_item_direct_ref(); }

  /* Should be called if ref is changed */
  inline void ref_changed() { set_properties(); }
};
...
class Item_direct_ref_to_ident : public Item_direct_ref
{
 ...
 public:
  Item_direct_ref_to_ident(THD *thd, Item_ident *item)
      : Item_direct_ref(thd, item->context, (Item **)&item, item->table_name, item->field_name, FALSE)
  {
    ident = item;
    ref = (Item **)&ident;
  }
  ...
  void print(String *str, enum_query_type query_type) override { ident->print(str, query_type); }
};
...
class Item_cache_wrapper : public Item_result_field
{
 ...
 public:
  ...
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override;
  bool send(Protocol *protocol, st_value *buffer) override;
  void save_org_in_field(Field *field, fast_field_copier) override { save_val(field); }
  ...
  void print(String *str, enum_query_type query_type) override;
  LEX_CSTRING full_name_cstring() const override { return orig_item->full_name_cstring(); }
  void make_send_field(THD *thd, Send_field *field) override { orig_item->make_send_field(thd, field); }
  bool eq(const Item *item, bool binary_cmp) const override
  {
  ...
  const Type_handler *type_handler() const override { return orig_item->type_handler(); }
  ...
  table_map not_null_tables() const override { return orig_item->not_null_tables(); }
  bool walk(Item_processor processor, bool walk_subquery, void *arg) override
  {
    return orig_item->walk(processor, walk_subquery, arg) || (this->*processor)(arg);
  }
  bool enumerate_field_refs_processor(void *arg) override { return orig_item->enumerate_field_refs_processor(arg); }
  Item_field *field_for_view_update() override { return orig_item->field_for_view_update(); }

  /* Row emulation: forwarding of ROW-related calls to orig_item */
  uint cols() const override { return result_type() == ROW_RESULT ? orig_item->cols() : 1; }
  Item *element_index(uint i) override { return result_type() == ROW_RESULT ? orig_item->element_index(i) : this; }
  Item **addr(uint i) override { return result_type() == ROW_RESULT ? orig_item->addr(i) : 0; }
  bool check_cols(uint c) override
  {
    return (result_type() == ROW_RESULT ? orig_item->check_cols(c) : Item::check_cols(c));
  }
  bool null_inside() override { return result_type() == ROW_RESULT ? orig_item->null_inside() : 0; }
  void bring_value() override
  {
  ...
  bool is_expensive_processor(void *arg) override { return orig_item->is_expensive_processor(arg); }
  bool check_vcol_func_processor(void *arg) override
  {
    return mark_unsupported_function("cache", arg, VCOL_IMPOSSIBLE);
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_wrapper>(thd, this); }
...
#define NO_NULL_TABLE (reinterpret_cast<TABLE *>(0x1))
  ...
  {
    if (!view->is_inner_table_of_outer_join() || !(null_ref_table = view->get_real_join_table()))
 ...
 public:
  Item_direct_view_ref(THD *thd, Name_resolution_context *context_arg, Item **item, LEX_CSTRING &table_name_arg,
                       LEX_CSTRING &field_name_arg, TABLE_LIST *view_arg)
  ...
  bool const_item() const override { return (*ref)->const_item() && (null_ref_table == NO_NULL_TABLE); }
  ...
  */
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_direct_view_ref>(thd, this); }
  Item *field_transformer_for_having_pushdown(THD *, uchar *) override { return this; }
...
class Item_outer_ref : public Item_direct_ref
{
  ...
  */
  ...
  Item_outer_ref(THD *thd, Name_resolution_context *context_arg, Item_field *outer_field_arg)
      : Item_direct_ref(thd, context_arg, 0, outer_field_arg->table_name, outer_field_arg->field_name),
        outer_ref(outer_field_arg),
        in_sum_func(0),
  ...
  Item_outer_ref(THD *thd, Name_resolution_context *context_arg, Item **item, const LEX_CSTRING &table_name_arg,
                 LEX_CSTRING &field_name_arg, bool alias_name_used_arg)
      : Item_direct_ref(thd, context_arg, item, table_name_arg, field_name_arg, alias_name_used_arg),
        outer_ref(0),
        in_sum_func(0),
  ...
  void save_in_result_field(bool no_conversions) override { outer_ref->save_org_in_field(result_field, NULL); }
  bool fix_fields(THD *, Item **) override;
  void fix_after_pullout(st_select_lex *new_parent, Item **ref, bool merge) override;
  table_map used_tables() const override { return (*ref)->const_item() ? 0 : OUTER_REF_TABLE_BIT; }
...
class Item_ref_null_helper : public Item_ref
{
 ...
 public:
  Item_ref_null_helper(THD *thd, Name_resolution_context *context_arg, Item_in_subselect *master, Item **item,
                       const LEX_CSTRING &table_name_arg, const LEX_CSTRING &field_name_arg)
      : Item_ref(thd, context_arg, item, table_name_arg, field_name_arg), owner(master)
  {
  }
  void save_val(Field *to) override;
  double val_real() override;
  ...
  void print(String *str, enum_query_type query_type) override;
  table_map used_tables() const override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_ref_null_helper>(thd, this); }
};
...
class Item_int_with_ref : public Item_int
{
 ...
 public:
  ...
  int save_in_field(Field *field, bool no_conversions) override { return ref->save_in_field(field, no_conversions); }
  Item *clone_item(THD *thd) override;
...
class Item_copy : public Item, public Type_handler_hybrid_field_type
{
 protected:
  /**
  ...
  */
  ...
  void make_send_field(THD *thd, Send_field *field) override { item->make_send_field(thd, field); }
  table_map used_tables() const override { return (table_map)1L; }
  bool const_item() const override { return false; }
  bool is_null() override { return null_value; }
  bool check_vcol_func_processor(void *arg) override { return mark_unsupported_function("copy", arg, VCOL_IMPOSSIBLE); }
  ...
  */
  ...
  {
    return (item->walk(processor, walk_subquery, args)) || (this->*processor)(args);
  }
};
...
class Item_copy_string : public Item_copy
{
 public:
  ...
  void copy() override;
  int save_in_field(Field *field, bool no_conversions) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_copy_string>(thd, this); }
};
...
class Item_copy_timestamp : public Item_copy
{
 ...
 public:
  ...
  void copy() override
  {
    ...
    m_value = tmp.is_null() ? Timestamp_or_zero_datetime() : Timestamp_or_zero_datetime(tmp);
  }
  int save_in_field(Field *field, bool) override
  {
    DBUG_ASSERT(sane());
  ...
  {
    DBUG_ASSERT(sane());
    return null_value ? 0 : m_value.to_datetime(current_thd).to_longlong();
  }
  double val_real() override
  {
    DBUG_ASSERT(sane());
    return null_value ? 0e0 : m_value.to_datetime(current_thd).to_double();
  }
  String *val_str(String *to) override
  {
    DBUG_ASSERT(sane());
    return null_value ? NULL : m_value.to_datetime(current_thd).to_string(to, decimals);
  }
  my_decimal *val_decimal(my_decimal *to) override
  {
    DBUG_ASSERT(sane());
    return null_value ? NULL : m_value.to_datetime(current_thd).to_decimal(to);
  }
  bool get_date(THD *thd, MYSQL_TIME *ltime, date_mode_t fuzzydate) override
  {
    DBUG_ASSERT(sane());
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_copy_timestamp>(thd, this); }
};
...
class Item_default_value : public Item_field
{
 ...
 public:
  Item *arg = nullptr;
  Item_default_value(THD *thd, Name_resolution_context *context_arg, Item *a, bool vcol_assignment_arg)
      : Item_field(thd, context_arg), vcol_assignment_ok(vcol_assignment_arg), arg(a)
  {
  }
  ...
  bool val_native(THD *thd, Native *to) override;
  bool val_native_result(THD *thd, Native *to) override;
  longlong val_datetime_packed(THD *thd) override { return Item::val_datetime_packed(thd); }
  longlong val_time_packed(THD *thd) override { return Item::val_time_packed(thd); }
  ...
  bool vcol_assignment_allowed_value() const override { return vcol_assignment_ok; }
  ...
  bool walk(Item_processor processor, bool walk_subquery, void *args) override
  {
    return (arg && arg->walk(processor, walk_subquery, args)) || (this->*processor)(args);
  }
...
*/
class Item_default_specification : public Item_contextually_typed_value_specification
{
 public:
  Item_default_specification(THD *thd) : Item_contextually_typed_value_specification(thd) {}
  void print(String *str, enum_query_type) override { str->append(STRING_WITH_LEN("default")); }
  bool check_assignability_to(const Field *to, bool ignore) const override { return false; }
  int save_in_field(Field *field_arg, bool) override { return field_arg->save_in_field_default_value(false); }
  bool save_in_param(THD *, Item_param *param) override
  {
    param->set_default();
    return false;
  }
  Item *get_copy(THD *thd) override { return get_item_copy<Item_default_specification>(thd, this); }
};
...
class Item_ignore_specification : public Item_contextually_typed_value_specification
{
 public:
  Item_ignore_specification(THD *thd) : Item_contextually_typed_value_specification(thd) {}
  void print(String *str, enum_query_type) override { str->append(STRING_WITH_LEN("ignore")); }
  bool check_assignability_to(const Field *to, bool ignore) const override { return false; }
  int save_in_field(Field *field_arg, bool) override { return field_arg->save_in_field_ignore_value(false); }
  bool save_in_param(THD *, Item_param *param) override
  {
    param->set_ignore();
    return false;
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_ignore_specification>(thd, this); }
};
...
class Item_insert_value : public Item_field
{
 public:
  Item *arg;
  Item_insert_value(THD *thd, Name_resolution_context *context_arg, Item *a) : Item_field(thd, context_arg), arg(a) {}
  bool eq(const Item *item, bool binary_cmp) const override;
  bool fix_fields(THD *, Item **) override;
  void print(String *str, enum_query_type query_type) override;
  int save_in_field(Field *field_arg, bool no_conversions) override
...
/*
  ...
  Note: For this item main part of actual binding to Field object happens
        ...
        field.
*/
class Item_trigger_field : public Item_field, private Settable_routine_parameter
{
 private:
 ...
 public:
  ...
  enum __attribute__((packed)) row_version_type
  {
    OLD_ROW,
    NEW_ROW
  };
 ...
 public:
  Item_trigger_field(THD *thd, Name_resolution_context *context_arg, row_version_type row_ver_arg,
                     const LEX_CSTRING &field_name_arg, privilege_t priv, const bool ro)
      : Item_field(thd, context_arg, field_name_arg),
        table_grants(NULL),
        next_trg_field(NULL),
        triggers(NULL),
        row_version(row_ver_arg),
        field_idx(NO_CACHED_FIELD_INDEX),
        read_only(ro),
 ...
 public:
  Settable_routine_parameter *get_settable_routine_parameter() override { return read_only ? nullptr : this; }

  bool set_value(THD *thd, Item **it) { return set_value(thd, NULL, it); }
...
class Item_cache : public Item_fixed_hybrid, public Type_handler_hybrid_field_type
{
 protected:
  Item *example;
  /**
 ...
 public:
  ...
  void print(String *str, enum_query_type query_type) override;
  bool eq_def(const Field *field) { return cached_field ? cached_field->eq_def(field) : FALSE; }
  bool eq(const Item *item, bool binary_cmp) const override { return this == item; }
  bool check_vcol_func_processor(void *arg) override
  {
    if (example)
    {
   ...
   */
  bool has_value() { return (value_cached || cache_value()) && !null_value; }

  virtual void store(Item *item);
  virtual Item *get_item() { return example; }
  virtual bool cache_value() = 0;
  bool basic_const_item() const override { return example && example->basic_const_item(); }
  virtual void clear()
  {
    null_value = TRUE;
    value_cached = FALSE;
  ...
  Item *safe_charset_converter(THD *thd, CHARSET_INFO *tocs) override;
  void split_sum_func2_example(THD *thd, Ref_ptr_array ref_pointer_array, List<Item> &fields, uint flags)
  {
  ...
  Item *derived_field_transformer_for_having(THD *thd, uchar *) override { return convert_to_basic_const_item(thd); }
  Item *derived_field_transformer_for_where(THD *thd, uchar *) override { return convert_to_basic_const_item(thd); }
  Item *grouping_field_transformer_for_where(THD *thd, uchar *) override { return convert_to_basic_const_item(thd); }
  Item *in_subq_field_transformer_for_where(THD *thd, uchar *) override { return convert_to_basic_const_item(thd); }
  Item *in_subq_field_transformer_for_having(THD *thd, uchar *) override { return convert_to_basic_const_item(thd); }
};
...
class Item_cache_int : public Item_cache
{
 ...
 public:
  Item_cache_int(THD *thd, const Type_handler *handler) : Item_cache(thd, handler), value(0) {}
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_int>(thd, this); }
};
...
class Item_cache_time : public Item_cache_temporal
{
 public:
  ...
  bool cache_value() override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_time>(thd, this); }
  ...
  longlong val_time_packed(THD *) override { return has_value() ? value : 0; }
  longlong val_int() override { return has_value() ? Time(this).to_longlong() : 0; }
  double val_real() override { return has_value() ? Time(this).to_double() : 0; }
  String *val_str(String *to) override { return has_value() ? Time(this).to_string(to, decimals) : NULL; }
  my_decimal *val_decimal(my_decimal *to) override { return has_value() ? Time(this).to_decimal(to) : NULL; }
  bool val_native(THD *thd, Native *to) override
  {
...
class Item_cache_datetime : public Item_cache_temporal
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_datetime>(thd, this); }
  Item *make_literal(THD *) override;
  longlong val_datetime_packed(THD *) override { return has_value() ? value : 0; }
  longlong val_time_packed(THD *thd) override { return Time(thd, this, Time::Options_cmp(thd)).to_packed(); }
  longlong val_int() override { return has_value() ? Datetime(this).to_longlong() : 0; }
  double val_real() override { return has_value() ? Datetime(this).to_double() : 0; }
  String *val_str(String *to) override { return has_value() ? Datetime(this).to_string(to, decimals) : NULL; }
  my_decimal *val_decimal(my_decimal *to) override { return has_value() ? Datetime(this).to_decimal(to) : NULL; }
};
...
class Item_cache_date : public Item_cache_temporal
{
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_date>(thd, this); }
  Item *make_literal(THD *) override;
  longlong val_datetime_packed(THD *) override { return has_value() ? value : 0; }
  longlong val_time_packed(THD *thd) override { return Time(thd, this, Time::Options_cmp(thd)).to_packed(); }
  longlong val_int() override { return has_value() ? Date(this).to_longlong() : 0; }
  double val_real() override { return has_value() ? Date(this).to_double() : 0; }
  String *val_str(String *to) override { return has_value() ? Date(this).to_string(to) : NULL; }
  my_decimal *val_decimal(my_decimal *to) override { return has_value() ? Date(this).to_decimal(to) : NULL; }
};
...
class Item_cache_timestamp : public Item_cache
{
 ...
 public:
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_timestamp>(thd, this); }
  bool cache_value() override;
  String *val_str(String *to) override { return to_datetime(current_thd).to_string(to, decimals); }
  my_decimal *val_decimal(my_decimal *to) override { return to_datetime(current_thd).to_decimal(to); }
  longlong val_int() override { return to_datetime(current_thd).to_longlong(); }
  double val_real() override { return to_datetime(current_thd).to_double(); }
  longlong val_datetime_packed(THD *thd) override { return to_datetime(thd).to_packed(); }
  longlong val_time_packed(THD *) override
  {
    DBUG_ASSERT(0);
    return 0;
...
{
 public:
  Item_cache_double(THD *thd) : Item_cache_real(thd, &type_handler_double) {}
  String *val_str(String *str) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_double>(thd, this); }
};

class Item_cache_float : public Item_cache_real
{
 public:
  Item_cache_float(THD *thd) : Item_cache_real(thd, &type_handler_float) {}
  String *val_str(String *str) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_float>(thd, this); }
};
...
class Item_cache_decimal : public Item_cache
{
 ...
 public:
  ...
  {
    return decimal_to_datetime_with_warn(thd, VDec(this).ptr(), to, mode, NULL, NULL);
  }
  bool cache_value() override;
  Item *convert_to_basic_const_item(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_decimal>(thd, this); }
};
...
class Item_cache_str : public Item_cache
{
 ...
 public:
  Item_cache_str(THD *thd, const Item *item)
      : Item_cache(thd, item->type_handler()),
        value(0),
        is_varbinary(item->type() == FIELD_ITEM && Item_cache_str::field_type() == MYSQL_TYPE_VARCHAR &&
  ...
  bool cache_value() override;
  Item *convert_to_basic_const_item(THD *thd) override;
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_str>(thd, this); }
};

class Item_cache_str_for_nullif : public Item_cache_str
{
 public:
  Item_cache_str_for_nullif(THD *thd, const Item *item) : Item_cache_str(thd, item) {}
  Item *safe_charset_converter(THD *thd, CHARSET_INFO *tocs) override
  {
    /**
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_str_for_nullif>(thd, this); }
};
...
class Item_cache_row : public Item_cache
{
 ...
 public:
  Item_cache_row(THD *thd) : Item_cache(thd), values(0), item_count(2), save_array(0) {}
  ...
  */
  ...
  void make_send_field(THD *, Send_field *) override { illegal_method_call("make_send_field"); };
  double val_real() override
  {
  ...
  Item *get_copy(THD *thd) override { return get_item_copy<Item_cache_row>(thd, this); }
};
...
class Item_type_holder : public Item, public Type_handler_hybrid_field_type
{
 ...
 public:
  Item_type_holder(THD *thd, Item *item, const Type_handler *handler, const Type_all_attributes *attr,
                   bool maybe_null_arg)
      : Item(thd), Type_handler_hybrid_field_type(handler), enum_set_typelib(attr->get_typelib())
  {
    name = item->name;
    Type_std_attributes::set(*attr);
    set_maybe_null(maybe_null_arg);
    copy_flags(item, item_base_t::IS_EXPLICIT_NAME | item_base_t::IS_IN_WITH_CYCLE);
  }

  const Type_handler *type_handler() const override
  {
    return Type_handler_hybrid_field_type::type_handler()->type_handler_for_item_field();
  }
  const Type_handler *real_type_handler() const override { return Type_handler_hybrid_field_type::type_handler(); }
  ...
  */
  ...
  Field *create_tmp_field_ex(MEM_ROOT *root, TABLE *table, Tmp_field_src *src, const Tmp_field_param *param) override
  {
    return Item_type_holder::real_type_handler()->make_and_init_table_field(root, &name, Record_addr(maybe_null()),
                                                                            *this, table);
  }
  Item *get_copy(THD *) override { return nullptr; }
};
...
extern Cached_item *new_Cached_item(THD *thd, Item *item, bool pass_through_ref);
...
class Item_iterator_list : public Item_iterator
{
 ...
 public:
  Item_iterator_list(List_iterator<Item> &arg_list) : list(arg_list) {}
  void open() { list.rewind(); }
  Item *next() { return (list++); }
  void close() {}
};
...
*/
bool fix_escape_item(THD *thd, Item *escape_item, String *tmp_str, bool escape_used_in_parsing, CHARSET_INFO *cmp_cs,
                     int *escape);

inline bool Virtual_column_info::is_equal(const Virtual_column_info *vcol) const
{
  return type_handler() == vcol->type_handler() && stored_in_db == vcol->is_stored() && expr->eq(vcol->expr, true);
}
...
inline void TABLE::use_all_stored_columns()
{
  ...
  if (Field **vf = vfield)
    for (; *vf; vf++) bitmap_clear_bit(read_set, (*vf)->field_index);
}
