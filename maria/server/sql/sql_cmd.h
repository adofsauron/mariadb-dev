...
enum enum_sql_command
{
  ...
  SQLCOM_SLAVE_ALL_START,
  SQLCOM_SLAVE_ALL_STOP,
  SQLCOM_SHOW_EXPLAIN,
  SQLCOM_SHOW_ANALYZE,
  SQLCOM_SHUTDOWN,
  SQLCOM_CREATE_ROLE,
...
class Storage_engine_name
{
 ...
 public:
  ...
  Storage_engine_name(const LEX_CSTRING &name) : m_storage_engine_name(name) {}
  Storage_engine_name(const LEX_STRING &name)
  {
    m_storage_engine_name.str = name.str;
    m_storage_engine_name.length = name.length;
  }
  bool resolve_storage_engine_with_error(THD *thd, handlerton **ha, bool tmp_table);
...
class Sql_cmd : public Sql_alloc
{
  ...
  */
  ...
  virtual Storage_engine_name *option_storage_engine_name() { return NULL; }
...
class Sql_cmd_show_slave_status : public Sql_cmd
{
 ...
 public:
  Sql_cmd_show_slave_status() : show_all_slaves_status(false) {}

  Sql_cmd_show_slave_status(bool status_all) : show_all_slaves_status(status_all) {}
...
class Sql_cmd_create_table_like : public Sql_cmd, public Storage_engine_name
{
 public:
...
class Sql_cmd_call : public Sql_cmd
{
 public:
  ...
  Sql_cmd_call(class sp_name *name, const class Sp_handler *handler) : m_name(name), m_handler(handler) {}
